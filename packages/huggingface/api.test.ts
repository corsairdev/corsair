...
const FIXTURES: Record<string, unknown> = {
	...
	listNotifications: {},
	deleteNotifications: {},
	updateNotificationSettings: { notifications: { announcements: true } },
	updateWatchSettings: {},
	getMcpSettings: {},
	getBillingUsageV2: {},
	getJobsUsage: {},
	...
	modelsCheckUploadMethod: {
		repoId: 'huggingface/transformers',
		files: [{ path: 'file.bin', size: 100, sample: 'AAAA' }],
	},
	...
	collectionsCreate: { title: 'My collection', namespace: 'huggingface' },
