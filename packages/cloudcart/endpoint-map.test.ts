...
const cases: Case[] = [
	...
	['products', 'getProductWithRelations', ID, 'GET', 'products/1'],
	[
		'products',
		'listProducts',
	...
	[
		...
		ID_DATA,
		'POST',
		'products/1/relationships/linked-products',
	],
	[
		'products',
	...
	[
		...
		ID,
		'GET',
		'categories/1/relationships/properties',
	],
	[
		'categories',
	...
	['properties', 'getPropertyOption', ID, 'GET', 'property-options/1'],
	['properties', 'listPropertyOptions', {}, 'GET', 'property-options'],
	[
		'properties',
	...
	['properties', 'deletePropertyOption', ID, 'DELETE', 'property-options/1'],
	[
		'properties',
		'createProductsPropertyOptions',
		ID_DATA,
		'POST',
		'products/1/relationships/property-options',
	],
	[
		'properties',
