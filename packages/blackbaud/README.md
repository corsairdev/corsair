...
| `membership.listMemberships` | `blackbaud.api.membership.listMemberships` | `read` | List memberships for a constituent; junction lookups scan 500-record pages and throw past 10,000 rather than report absence |
