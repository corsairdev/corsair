...
export const IdleScreen: React.FC<IdleScreenProps> = ({ context }) => {
	...
	return (
		...
		>
			...
			<Text> </Text>
			<Text>
				Status: <Text color="green">Idle</Text>
			</Text>
			<Text>
				Watching: <Text dimColor>{watchPaths}</Text>
			</Text>

			{unfinished.length > 0 && (
				<>
					<Text> </Text>
					<Text dimColor>━━━ Unfinished Operations ━━━</Text>
					...
					<Text dimColor>Press number to resume</Text>
				</>
			)}
