...
export const betterAuthInstaller: Installer = ({ projectDir, packages }) => {
  ...
  const authIndexDest = path.join(projectDir, 'src/server/better-auth/index.ts')
