...
export const listTeams: SlackEndpoints['adminTeamsList'] = async (ctx, input) => {
...
export const conversationsSearch: SlackEndpoints['adminConversationsSearch'] = async (
    ctx,
    input,
) => {
    const response = await makeSlackRequest<
...
export const conversationsGetTeams: SlackEndpoints['adminConversationsGetTeams'] = async (
    ctx,
    input,
) => {
    const response = await makeSlackRequest<
...
export const conversationsSetTeams: SlackEndpoints['adminConversationsSetTeams'] = async (
    ctx,
    input,
) => {
    const response = await makeSlackRequest<
