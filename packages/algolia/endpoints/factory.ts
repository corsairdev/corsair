import type { CorsairEndpoint } from 'corsair/core';
	...
	id: ['id'],
        ...
        function resolvePathParam(input: AlgoliaEndpointInput, pathKey: string): unknown {
        ...
        export async function requestAlgoliaOperation(
        	...
        	return makeAlgoliaRequest(resolvePath(route.path, input, route), applicationId, apiKey, {
        		method: route.method,
