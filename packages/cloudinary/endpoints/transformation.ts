...
export const createTransformation: CloudinaryEndpoint = createCloudinaryEndpoint(op('createTransformation'));

export const getTransformation: CloudinaryEndpoint = createCloudinaryEndpoint(op('getTransformation'));
