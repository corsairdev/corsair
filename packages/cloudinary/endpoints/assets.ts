...
export const searchAssets: CloudinaryEndpoint = createCloudinaryEndpoint(
	op('searchAssets'),
);

export const searchVisualAssets: CloudinaryEndpoint = createCloudinaryEndpoint(
	op('searchVisualAssets'),
);
