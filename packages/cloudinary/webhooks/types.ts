...
export const ExampleEventSchema = CloudinaryWebhookPayloadSchema.extend({
...
export function createCloudinaryMatch(eventType: string): CorsairWebhookMatcher {
...
export function verifyCloudinaryWebhookSignature(
	request: WebhookRequest<CloudinaryWebhookPayload>,
	secret: string,
