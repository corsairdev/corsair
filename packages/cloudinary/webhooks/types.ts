...
export const CloudinaryResourceTagsChangedSchema = NotificationBaseSchema.extend({
...
export const CloudinaryResourceContextChangedSchema = NotificationBaseSchema.extend({
...
export const CloudinaryResourceMetadataChangedSchema = NotificationBaseSchema.extend({
...
export const CloudinaryCreateFolderNotificationSchema = NotificationBaseSchema.extend({
...
export const CloudinaryDeleteFolderNotificationSchema = NotificationBaseSchema.extend({
...
export const CloudinaryExplodeNotificationSchema = NotificationBaseSchema.extend({
	notification_type: z.literal('explode'),
	public_id: z.string().optional(),
	asset_id: z.string().optional(),
}).passthrough();

export const CloudinaryAccessControlChangedSchema = NotificationBaseSchema.extend({
	notification_type: z.literal('access_control_changed'),
	public_id: z.string().optional(),
	asset_id: z.string().optional(),
}).passthrough();

export const CloudinaryRelatedAssetsNotificationSchema = NotificationBaseSchema.extend({
...
export type CloudinaryUploadNotification = z.infer<typeof CloudinaryUploadNotificationSchema>;
export type CloudinaryEagerNotification = z.infer<typeof CloudinaryEagerNotificationSchema>;
export type CloudinaryDeleteNotification = z.infer<typeof CloudinaryDeleteNotificationSchema>;
export type CloudinaryRenameNotification = z.infer<typeof CloudinaryRenameNotificationSchema>;
...
export type CloudinaryWebhookOutputs = {
	...
	resourceContextChanged: z.infer<typeof CloudinaryResourceContextChangedSchema>;
	resourceMetadataChanged: z.infer<typeof CloudinaryResourceMetadataChangedSchema>;
...
export function createCloudinaryMatch(
	...
	return (request: RawWebhookRequest) => {
		...
		return (
			parsedBody !== null &&
			parsedBody.notification_type === notificationType
		);
	};
}
...
export function verifyCloudinaryWebhookSignature(
	...
	const signature =
		headers['x-cld-signature'] ?? headers['X-Cld-Signature'];
	const timestamp =
		headers['x-cld-timestamp'] ?? headers['X-Cld-Timestamp'];
