...
export const createIntegration: AnchorBrowserEndpoint = async (ctx, input = {}) => {
...
export const deleteIntegration: AnchorBrowserEndpoint = async (ctx, input = {}) => {
...
export const listIntegrations: AnchorBrowserEndpoint = async (ctx, input = {}) => {
