...
export const getWebpageContent: AnchorBrowserEndpoint = async (ctx, input = {}) => {
	return executeAnchorBrowserOperation(ctx, input, getWebpageContentRoute);
};

const performWebTaskRoute = getRoute('performWebTask');
export const performWebTask: AnchorBrowserEndpoint = async (ctx, input = {}) => {
...
export const screenshotWebpage: AnchorBrowserEndpoint = async (ctx, input = {}) => {
