...
export const listSessionRecordings: AnchorBrowserEndpoint = async (ctx, input = {}) => {
...
export const pauseSessionRecording: AnchorBrowserEndpoint = async (ctx, input = {}) => {
...
export const resumeSessionRecording: AnchorBrowserEndpoint = async (ctx, input = {}) => {
