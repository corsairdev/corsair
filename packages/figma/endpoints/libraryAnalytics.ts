...
export const componentActions: FigmaEndpoints['libraryAnalyticsComponentActions'] = async (
	ctx,
	input,
) => {
...
export const componentUsages: FigmaEndpoints['libraryAnalyticsComponentUsages'] = async (
	ctx,
	input,
) => {
	const { file_key, ...queryParams } = input;
...
export const styleActions: FigmaEndpoints['libraryAnalyticsStyleActions'] = async (
	ctx,
	input,
) => {
	const { file_key, ...queryParams } = input;
...
export const variableActions: FigmaEndpoints['libraryAnalyticsVariableActions'] = async (
	ctx,
	input,
) => {
	const { file_key, ...queryParams } = input;
...
export const variableUsages: FigmaEndpoints['libraryAnalyticsVariableUsages'] = async (
	ctx,
	input,
) => {
	const { file_key, ...queryParams } = input;
