...
export const getAListOfAssignGroups: AgencyZoomEndpoint = async (ctx, input = {}) => {
...
export const getAListOfCarriers: AgencyZoomEndpoint = async (ctx, input = {}) => {
...
export const getAListOfCustomFields: AgencyZoomEndpoint = async (ctx, input = {}) => {
...
export const getAListOfEmployees: AgencyZoomEndpoint = async (ctx, input = {}) => {
	return executeAgencyZoomOperation(ctx, input, getAListOfEmployeesRoute);
};

const getAListOfLeadSourceCategoriesRoute = getRoute('getAListOfLeadSourceCategories');
export const getAListOfLeadSourceCategories: AgencyZoomEndpoint = async (ctx, input = {}) => {
	return executeAgencyZoomOperation(ctx, input, getAListOfLeadSourceCategoriesRoute);
};

const getAListOfLeadSourcesRoute = getRoute('getAListOfLeadSources');
export const getAListOfLeadSources: AgencyZoomEndpoint = async (ctx, input = {}) => {
	return executeAgencyZoomOperation(ctx, input, getAListOfLeadSourcesRoute);
};

const getAListOfLifeProfessionalsRoute = getRoute('getAListOfLifeProfessionals');
export const getAListOfLifeProfessionals: AgencyZoomEndpoint = async (ctx, input = {}) => {
	return executeAgencyZoomOperation(ctx, input, getAListOfLifeProfessionalsRoute);
};

const getAListOfLocationsRoute = getRoute('getAListOfLocations');
export const getAListOfLocations: AgencyZoomEndpoint = async (ctx, input = {}) => {
...
export const getAListOfLossReasons: AgencyZoomEndpoint = async (ctx, input = {}) => {
...
export const getAListOfPipelines: AgencyZoomEndpoint = async (ctx, input = {}) => {
	return executeAgencyZoomOperation(ctx, input, getAListOfPipelinesRoute);
};

const getAListOfProductLinesPolicyTypesRoute = getRoute('getAListOfProductLinesPolicyTypes');
export const getAListOfProductLinesPolicyTypes: AgencyZoomEndpoint = async (ctx, input = {}) => {
	return executeAgencyZoomOperation(ctx, input, getAListOfProductLinesPolicyTypesRoute);
};

const getAListOfRecycleEventsRoute = getRoute('getAListOfRecycleEvents');
export const getAListOfRecycleEvents: AgencyZoomEndpoint = async (ctx, input = {}) => {
...
export const getDepartmentsGroups: AgencyZoomEndpoint = async (ctx, input = {}) => {
...
export const getListOfEndStages: AgencyZoomEndpoint = async (ctx, input = {}) => {
...
export const listProductCategories: AgencyZoomEndpoint = async (ctx, input = {}) => {
	return executeAgencyZoomOperation(ctx, input, listProductCategoriesRoute);
};

const searchBusinessClassificationsRoute = getRoute('searchBusinessClassifications');
export const searchBusinessClassifications: AgencyZoomEndpoint = async (ctx, input = {}) => {
	return executeAgencyZoomOperation(ctx, input, searchBusinessClassificationsRoute);
};
