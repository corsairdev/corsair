...
const createADriverForAnOpportunityRoute = getRoute('createADriverForAnOpportunity');
export const createADriverForAnOpportunity: AgencyZoomEndpoint = async (ctx, input = {}) => {
	return executeAgencyZoomOperation(ctx, input, createADriverForAnOpportunityRoute);
};

const createAnOpportunityRoute = getRoute('createAnOpportunity');
export const createAnOpportunity: AgencyZoomEndpoint = async (ctx, input = {}) => {
	return executeAgencyZoomOperation(ctx, input, createAnOpportunityRoute);
};

const createAVehicleForAnOpportunityRoute = getRoute('createAVehicleForAnOpportunity');
export const createAVehicleForAnOpportunity: AgencyZoomEndpoint = async (ctx, input = {}) => {
	return executeAgencyZoomOperation(ctx, input, createAVehicleForAnOpportunityRoute);
};
...
export const deleteAnOpportunity: AgencyZoomEndpoint = async (ctx, input = {}) => {
...
const getAListOfDriversForAnOpportunityRoute = getRoute('getAListOfDriversForAnOpportunity');
export const getAListOfDriversForAnOpportunity: AgencyZoomEndpoint = async (ctx, input = {}) => {
	return executeAgencyZoomOperation(ctx, input, getAListOfDriversForAnOpportunityRoute);
};

const getAListOfVehiclesForAnOpportunityRoute = getRoute('getAListOfVehiclesForAnOpportunity');
export const getAListOfVehiclesForAnOpportunity: AgencyZoomEndpoint = async (ctx, input = {}) => {
	return executeAgencyZoomOperation(ctx, input, getAListOfVehiclesForAnOpportunityRoute);
};

const getTheDriverDetailsRoute = getRoute('getTheDriverDetails');
export const getTheDriverDetails: AgencyZoomEndpoint = async (ctx, input = {}) => {
...
export const getTheOpportunityDetails: AgencyZoomEndpoint = async (ctx, input = {}) => {
...
export const getTheVehicleDetails: AgencyZoomEndpoint = async (ctx, input = {}) => {
...
export const linkADriverToOpportunity: AgencyZoomEndpoint = async (ctx, input = {}) => {
...
export const linkAVehicleToOpportunity: AgencyZoomEndpoint = async (ctx, input = {}) => {
	return executeAgencyZoomOperation(ctx, input, linkAVehicleToOpportunityRoute);
};

const unlinkADriverFromOpportunityRoute = getRoute('unlinkADriverFromOpportunity');
export const unlinkADriverFromOpportunity: AgencyZoomEndpoint = async (ctx, input = {}) => {
	return executeAgencyZoomOperation(ctx, input, unlinkADriverFromOpportunityRoute);
};

const unlinkAVehicleFromOpportunityRoute = getRoute('unlinkAVehicleFromOpportunity');
export const unlinkAVehicleFromOpportunity: AgencyZoomEndpoint = async (ctx, input = {}) => {
	return executeAgencyZoomOperation(ctx, input, unlinkAVehicleFromOpportunityRoute);
};

const updateADriverSDetailsRoute = getRoute('updateADriverSDetails');
export const updateADriverSDetails: AgencyZoomEndpoint = async (ctx, input = {}) => {
...
export const updateAnOpportunity: AgencyZoomEndpoint = async (ctx, input = {}) => {
...
export const updateAVehicleSDetails: AgencyZoomEndpoint = async (ctx, input = {}) => {
