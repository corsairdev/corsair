...
export const authenticateForJwtviaV4Sso: AgencyZoomEndpoint = async (ctx, input = {}) => {
	return executeAgencyZoomOperation(ctx, input, authenticateForJwtviaV4SsoRoute);
};

const getAuthUrlForV4SsoRoute = getRoute('getAuthUrlForV4Sso');
export const getAuthUrlForV4Sso: AgencyZoomEndpoint = async (ctx, input = {}) => {
