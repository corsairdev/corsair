...
export const AbyssaleWebhookPayloadSchema = z.object({
	type: z.string(),
	created_at: z.string(),
...
export const ExampleEventSchema = AbyssaleWebhookPayloadSchema.extend({
...
export function verifyAbyssaleWebhookSignature(
	request: WebhookRequest<AbyssaleWebhookPayload>,
	secret: string,
