...
function get(model, params, config) {
    ...
    const requestParams = rambda.pick(['limit', 'offset'], params);
    // Handle filtering
    if (params.filters) {
    ...
    return axios__default['default'].get(path, {
...
function create(model, payload, config, upsert = false) {
    ...
    return axios__default['default'].post(path, payload, {
        headers: requestHeaders
    })
        .then(res => {
        return {
...
function update(model, filters, payload, config) {
    ...
    return axios__default['default'].patch(path, payload, {
        params: requestParams,
...
function remove(model, filters, config) {
    ...
    return axios__default['default'].delete(path, {
        params: requestParams,
        headers: generatePostgrestRequestHeaders(config)
    })
        .then(res => {
...
exports.removeByColumn = removeByColumn;
exports.removeById = removeById;
exports.rpc = rpc;
exports.update = update;
exports.updateByColumn = updateByColumn;
