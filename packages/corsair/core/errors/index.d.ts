...
export type RetryStrategies = 'linear_1s' | 'linear_2s' | 'linear_3s' | 'linear_4s' | 'exponential_backoff' | 'exponential_backoff_jitter';
...
export type ErrorHandler = (error: Error, context: ErrorContext) => Promise<RetryStrategy>;
