 ...
 * ```
 */
export type KeyBuilderContext<Options extends Record<string, unknown>, AuthConfig extends PluginAuthConfig | undefined = undefined> = ExtractAllAuthTypes<Options> extends infer A ? A extends AuthTypes ? {
 ...
 * @template AuthConfig - Optional plugin auth config for extension fields
 */
export type CorsairKeyBuilder<Options extends Record<string, unknown>, AuthConfig extends PluginAuthConfig | undefined = undefined> = (ctx: KeyBuilderContext<Options, AuthConfig>, source: 'endpoint' | 'webhook') => string | Promise<string>;
/**
 ...
 */
export type CorsairKeyBuilderBase = (ctx: any, source: 'endpoint' | 'webhook') => string | Promise<string>;
/**
 ...
 */
export type CorsairPlugin<Id extends AllProviders = AllProviders, Schema extends CorsairPluginSchema<Record<string, ZodTypeAny>> = CorsairPluginSchema<Record<string, ZodTypeAny>>, Endpoints extends EndpointTree = EndpointTree, Webhooks extends WebhookTree = WebhookTree, Options extends Record<string, unknown> = Record<string, unknown>, DefaultAuthType extends AuthTypes | undefined = AuthTypes | undefined, AuthConfig extends PluginAuthConfig | undefined = PluginAuthConfig | undefined> = {
