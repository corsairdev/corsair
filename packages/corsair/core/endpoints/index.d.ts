 ...
 */
export type BoundEndpointFn<Args = unknown, Res = unknown> = (args: Args) => Promise<Res>;
/**
 ...
 * @template Res - The response type the endpoint returns
 */
export type CorsairEndpoint<Ctx extends CorsairContext = CorsairContext, Args = unknown, Res = unknown> = Bivariant<[ctx: Ctx, args: Args], Promise<Res>>;
/**
