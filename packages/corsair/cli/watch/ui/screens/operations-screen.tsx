...
import type { StateContext, OperationDefinition } from '../../types/state.js';
...
export const OperationsScreen: React.FC<OperationsScreenProps> = ({ context }) => {
  ...
  const paginatedOperations = filteredOperations.slice(startIndex, startIndex + 5);
