...
export const linearEndpointSchemas = {
  'issues.list': { input: LinearEndpointInputSchemas.issuesList, output: LinearEndpointOutputSchemas.issuesList },
  'issues.get': { input: LinearEndpointInputSchemas.issuesGet, output: LinearEndpointOutputSchemas.issuesGet },
  'issues.create': { input: LinearEndpointInputSchemas.issuesCreate, output: LinearEndpointOutputSchemas.issuesCreate },
  'issues.update': { input: LinearEndpointInputSchemas.issuesUpdate, output: LinearEndpointOutputSchemas.issuesUpdate },
  'issues.delete': { input: LinearEndpointInputSchemas.issuesDelete, output: LinearEndpointOutputSchemas.issuesDelete },
  'comments.list': { input: LinearEndpointInputSchemas.commentsList, output: LinearEndpointOutputSchemas.commentsList },
  'comments.create': { input: LinearEndpointInputSchemas.commentsCreate, output: LinearEndpointOutputSchemas.commentsCreate },
  'comments.update': { input: LinearEndpointInputSchemas.commentsUpdate, output: LinearEndpointOutputSchemas.commentsUpdate },
  'comments.delete': { input: LinearEndpointInputSchemas.commentsDelete, output: LinearEndpointOutputSchemas.commentsDelete },
  'projects.list': { input: LinearEndpointInputSchemas.projectsList, output: LinearEndpointOutputSchemas.projectsList },
  'projects.get': { input: LinearEndpointInputSchemas.projectsGet, output: LinearEndpointOutputSchemas.projectsGet },
  'projects.create': { input: LinearEndpointInputSchemas.projectsCreate, output: LinearEndpointOutputSchemas.projectsCreate },
  'projects.update': { input: LinearEndpointInputSchemas.projectsUpdate, output: LinearEndpointOutputSchemas.projectsUpdate },
  'projects.delete': { input: LinearEndpointInputSchemas.projectsDelete, output: LinearEndpointOutputSchemas.projectsDelete },
  'teams.list': { input: LinearEndpointInputSchemas.teamsList, output: LinearEndpointOutputSchemas.teamsList },
  'teams.get': { input: LinearEndpointInputSchemas.teamsGet, output: LinearEndpointOutputSchemas.teamsGet },
  'users.list': { input: LinearEndpointInputSchemas.usersList, output: LinearEndpointOutputSchemas.usersList },
  'users.get': { input: LinearEndpointInputSchemas.usersGet, output: LinearEndpointOutputSchemas.usersGet },
} as const;
