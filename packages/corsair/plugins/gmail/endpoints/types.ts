...
export const gmailEndpointSchemas = {
  'messages.list': { input: GmailEndpointInputSchemas.messagesList, output: GmailEndpointOutputSchemas.messagesList },
  'messages.get': { input: GmailEndpointInputSchemas.messagesGet, output: GmailEndpointOutputSchemas.messagesGet },
  'messages.send': { input: GmailEndpointInputSchemas.messagesSend, output: GmailEndpointOutputSchemas.messagesSend },
  'messages.delete': { input: GmailEndpointInputSchemas.messagesDelete, output: GmailEndpointOutputSchemas.messagesDelete },
  'messages.modify': { input: GmailEndpointInputSchemas.messagesModify, output: GmailEndpointOutputSchemas.messagesModify },
  'messages.batchModify': { input: GmailEndpointInputSchemas.messagesBatchModify, output: GmailEndpointOutputSchemas.messagesBatchModify },
  'messages.trash': { input: GmailEndpointInputSchemas.messagesTrash, output: GmailEndpointOutputSchemas.messagesTrash },
  'messages.untrash': { input: GmailEndpointInputSchemas.messagesUntrash, output: GmailEndpointOutputSchemas.messagesUntrash },
  'labels.list': { input: GmailEndpointInputSchemas.labelsList, output: GmailEndpointOutputSchemas.labelsList },
  'labels.get': { input: GmailEndpointInputSchemas.labelsGet, output: GmailEndpointOutputSchemas.labelsGet },
  'labels.create': { input: GmailEndpointInputSchemas.labelsCreate, output: GmailEndpointOutputSchemas.labelsCreate },
  'labels.update': { input: GmailEndpointInputSchemas.labelsUpdate, output: GmailEndpointOutputSchemas.labelsUpdate },
  'labels.delete': { input: GmailEndpointInputSchemas.labelsDelete, output: GmailEndpointOutputSchemas.labelsDelete },
  'drafts.list': { input: GmailEndpointInputSchemas.draftsList, output: GmailEndpointOutputSchemas.draftsList },
  'drafts.get': { input: GmailEndpointInputSchemas.draftsGet, output: GmailEndpointOutputSchemas.draftsGet },
  'drafts.create': { input: GmailEndpointInputSchemas.draftsCreate, output: GmailEndpointOutputSchemas.draftsCreate },
  'drafts.update': { input: GmailEndpointInputSchemas.draftsUpdate, output: GmailEndpointOutputSchemas.draftsUpdate },
  'drafts.delete': { input: GmailEndpointInputSchemas.draftsDelete, output: GmailEndpointOutputSchemas.draftsDelete },
  'drafts.send': { input: GmailEndpointInputSchemas.draftsSend, output: GmailEndpointOutputSchemas.draftsSend },
  'threads.list': { input: GmailEndpointInputSchemas.threadsList, output: GmailEndpointOutputSchemas.threadsList },
  'threads.get': { input: GmailEndpointInputSchemas.threadsGet, output: GmailEndpointOutputSchemas.threadsGet },
  'threads.modify': { input: GmailEndpointInputSchemas.threadsModify, output: GmailEndpointOutputSchemas.threadsModify },
  'threads.delete': { input: GmailEndpointInputSchemas.threadsDelete, output: GmailEndpointOutputSchemas.threadsDelete },
  'threads.trash': { input: GmailEndpointInputSchemas.threadsTrash, output: GmailEndpointOutputSchemas.threadsTrash },
  'threads.untrash': { input: GmailEndpointInputSchemas.threadsUntrash, output: GmailEndpointOutputSchemas.threadsUntrash },
  'users.getProfile': { input: GmailEndpointInputSchemas.usersGetProfile, output: GmailEndpointOutputSchemas.usersGetProfile },
} as const;
