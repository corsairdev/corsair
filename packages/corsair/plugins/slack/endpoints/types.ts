...
export const slackEndpointSchemas = {
  'channels.random': { input: SlackEndpointInputSchemas.channelsRandom, output: SlackEndpointOutputSchemas.channelsRandom },
  'channels.archive': { input: SlackEndpointInputSchemas.channelsArchive, output: SlackEndpointOutputSchemas.channelsArchive },
  'channels.close': { input: SlackEndpointInputSchemas.channelsClose, output: SlackEndpointOutputSchemas.channelsClose },
  'channels.create': { input: SlackEndpointInputSchemas.channelsCreate, output: SlackEndpointOutputSchemas.channelsCreate },
  'channels.get': { input: SlackEndpointInputSchemas.channelsGet, output: SlackEndpointOutputSchemas.channelsGet },
  'channels.list': { input: SlackEndpointInputSchemas.channelsList, output: SlackEndpointOutputSchemas.channelsList },
  'channels.getHistory': { input: SlackEndpointInputSchemas.channelsGetHistory, output: SlackEndpointOutputSchemas.channelsGetHistory },
  'channels.invite': { input: SlackEndpointInputSchemas.channelsInvite, output: SlackEndpointOutputSchemas.channelsInvite },
  'channels.join': { input: SlackEndpointInputSchemas.channelsJoin, output: SlackEndpointOutputSchemas.channelsJoin },
  'channels.kick': { input: SlackEndpointInputSchemas.channelsKick, output: SlackEndpointOutputSchemas.channelsKick },
  'channels.leave': { input: SlackEndpointInputSchemas.channelsLeave, output: SlackEndpointOutputSchemas.channelsLeave },
  'channels.getMembers': { input: SlackEndpointInputSchemas.channelsGetMembers, output: SlackEndpointOutputSchemas.channelsGetMembers },
  'channels.open': { input: SlackEndpointInputSchemas.channelsOpen, output: SlackEndpointOutputSchemas.channelsOpen },
  'channels.rename': { input: SlackEndpointInputSchemas.channelsRename, output: SlackEndpointOutputSchemas.channelsRename },
  'channels.getReplies': { input: SlackEndpointInputSchemas.channelsGetReplies, output: SlackEndpointOutputSchemas.channelsGetReplies },
  'channels.setPurpose': { input: SlackEndpointInputSchemas.channelsSetPurpose, output: SlackEndpointOutputSchemas.channelsSetPurpose },
  'channels.setTopic': { input: SlackEndpointInputSchemas.channelsSetTopic, output: SlackEndpointOutputSchemas.channelsSetTopic },
  'channels.unarchive': { input: SlackEndpointInputSchemas.channelsUnarchive, output: SlackEndpointOutputSchemas.channelsUnarchive },
  'users.get': { input: SlackEndpointInputSchemas.usersGet, output: SlackEndpointOutputSchemas.usersGet },
  'users.list': { input: SlackEndpointInputSchemas.usersList, output: SlackEndpointOutputSchemas.usersList },
  'users.getProfile': { input: SlackEndpointInputSchemas.usersGetProfile, output: SlackEndpointOutputSchemas.usersGetProfile },
  'users.getPresence': { input: SlackEndpointInputSchemas.usersGetPresence, output: SlackEndpointOutputSchemas.usersGetPresence },
  'users.updateProfile': { input: SlackEndpointInputSchemas.usersUpdateProfile, output: SlackEndpointOutputSchemas.usersUpdateProfile },
  'userGroups.create': { input: SlackEndpointInputSchemas.userGroupsCreate, output: SlackEndpointOutputSchemas.userGroupsCreate },
  'userGroups.disable': { input: SlackEndpointInputSchemas.userGroupsDisable, output: SlackEndpointOutputSchemas.userGroupsDisable },
  'userGroups.enable': { input: SlackEndpointInputSchemas.userGroupsEnable, output: SlackEndpointOutputSchemas.userGroupsEnable },
  'userGroups.list': { input: SlackEndpointInputSchemas.userGroupsList, output: SlackEndpointOutputSchemas.userGroupsList },
  'userGroups.update': { input: SlackEndpointInputSchemas.userGroupsUpdate, output: SlackEndpointOutputSchemas.userGroupsUpdate },
  'files.get': { input: SlackEndpointInputSchemas.filesGet, output: SlackEndpointOutputSchemas.filesGet },
  'files.list': { input: SlackEndpointInputSchemas.filesList, output: SlackEndpointOutputSchemas.filesList },
  'files.upload': { input: SlackEndpointInputSchemas.filesUpload, output: SlackEndpointOutputSchemas.filesUpload },
  'messages.delete': { input: SlackEndpointInputSchemas.messagesDelete, output: SlackEndpointOutputSchemas.messagesDelete },
  'messages.getPermalink': { input: SlackEndpointInputSchemas.messagesGetPermalink, output: SlackEndpointOutputSchemas.messagesGetPermalink },
  'messages.search': { input: SlackEndpointInputSchemas.messagesSearch, output: SlackEndpointOutputSchemas.messagesSearch },
  'messages.post': { input: SlackEndpointInputSchemas.postMessage, output: SlackEndpointOutputSchemas.postMessage },
  'messages.update': { input: SlackEndpointInputSchemas.messagesUpdate, output: SlackEndpointOutputSchemas.messagesUpdate },
  'reactions.add': { input: SlackEndpointInputSchemas.reactionsAdd, output: SlackEndpointOutputSchemas.reactionsAdd },
  'reactions.get': { input: SlackEndpointInputSchemas.reactionsGet, output: SlackEndpointOutputSchemas.reactionsGet },
  'reactions.remove': { input: SlackEndpointInputSchemas.reactionsRemove, output: SlackEndpointOutputSchemas.reactionsRemove },
  'stars.add': { input: SlackEndpointInputSchemas.starsAdd, output: SlackEndpointOutputSchemas.starsAdd },
  'stars.remove': { input: SlackEndpointInputSchemas.starsRemove, output: SlackEndpointOutputSchemas.starsRemove },
  'stars.list': { input: SlackEndpointInputSchemas.starsList, output: SlackEndpointOutputSchemas.starsList },
} as const;
