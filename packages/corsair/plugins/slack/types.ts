...
export type ConversationsListResponse = SlackResponse & { channels?: Channel[] };
...
export type ConversationsMembersResponse = SlackResponse & { members?: string[] };
...
export type UsergroupsCreateResponse = SlackResponse & { usergroup?: Usergroup };
export type UsergroupsDisableResponse = SlackResponse & { usergroup?: Usergroup };
export type UsergroupsEnableResponse = SlackResponse & { usergroup?: Usergroup };
export type UsergroupsListResponse = SlackResponse & {
	userGroups?: Usergroup[];
};
export type UsergroupsUpdateResponse = SlackResponse & { usergroup?: Usergroup };
...
export type ChatDeleteResponse = SlackResponse & { channel?: string; ts?: string };
