...
export const hubspotEndpointSchemas = {
  'contacts.get': { input: HubSpotEndpointInputSchemas.contactsGet, output: HubSpotEndpointOutputSchemas.contactsGet },
  'contacts.getMany': { input: HubSpotEndpointInputSchemas.contactsGetMany, output: HubSpotEndpointOutputSchemas.contactsGetMany },
  'contacts.createOrUpdate': { input: HubSpotEndpointInputSchemas.contactsCreateOrUpdate, output: HubSpotEndpointOutputSchemas.contactsCreateOrUpdate },
  'contacts.delete': { input: HubSpotEndpointInputSchemas.contactsDelete, output: HubSpotEndpointOutputSchemas.contactsDelete },
  'contacts.getRecentlyCreated': { input: HubSpotEndpointInputSchemas.contactsGetRecentlyCreated, output: HubSpotEndpointOutputSchemas.contactsGetRecentlyCreated },
  'contacts.getRecentlyUpdated': { input: HubSpotEndpointInputSchemas.contactsGetRecentlyUpdated, output: HubSpotEndpointOutputSchemas.contactsGetRecentlyUpdated },
  'contacts.search': { input: HubSpotEndpointInputSchemas.contactsSearch, output: HubSpotEndpointOutputSchemas.contactsSearch },
  'companies.get': { input: HubSpotEndpointInputSchemas.companiesGet, output: HubSpotEndpointOutputSchemas.companiesGet },
  'companies.getMany': { input: HubSpotEndpointInputSchemas.companiesGetMany, output: HubSpotEndpointOutputSchemas.companiesGetMany },
  'companies.create': { input: HubSpotEndpointInputSchemas.companiesCreate, output: HubSpotEndpointOutputSchemas.companiesCreate },
  'companies.update': { input: HubSpotEndpointInputSchemas.companiesUpdate, output: HubSpotEndpointOutputSchemas.companiesUpdate },
  'companies.delete': { input: HubSpotEndpointInputSchemas.companiesDelete, output: HubSpotEndpointOutputSchemas.companiesDelete },
  'companies.getRecentlyCreated': { input: HubSpotEndpointInputSchemas.companiesGetRecentlyCreated, output: HubSpotEndpointOutputSchemas.companiesGetRecentlyCreated },
  'companies.getRecentlyUpdated': { input: HubSpotEndpointInputSchemas.companiesGetRecentlyUpdated, output: HubSpotEndpointOutputSchemas.companiesGetRecentlyUpdated },
  'companies.searchByDomain': { input: HubSpotEndpointInputSchemas.companiesSearchByDomain, output: HubSpotEndpointOutputSchemas.companiesSearchByDomain },
  'deals.get': { input: HubSpotEndpointInputSchemas.dealsGet, output: HubSpotEndpointOutputSchemas.dealsGet },
  'deals.getMany': { input: HubSpotEndpointInputSchemas.dealsGetMany, output: HubSpotEndpointOutputSchemas.dealsGetMany },
  'deals.create': { input: HubSpotEndpointInputSchemas.dealsCreate, output: HubSpotEndpointOutputSchemas.dealsCreate },
  'deals.update': { input: HubSpotEndpointInputSchemas.dealsUpdate, output: HubSpotEndpointOutputSchemas.dealsUpdate },
  'deals.delete': { input: HubSpotEndpointInputSchemas.dealsDelete, output: HubSpotEndpointOutputSchemas.dealsDelete },
  'deals.getRecentlyCreated': { input: HubSpotEndpointInputSchemas.dealsGetRecentlyCreated, output: HubSpotEndpointOutputSchemas.dealsGetRecentlyCreated },
  'deals.getRecentlyUpdated': { input: HubSpotEndpointInputSchemas.dealsGetRecentlyUpdated, output: HubSpotEndpointOutputSchemas.dealsGetRecentlyUpdated },
  'deals.search': { input: HubSpotEndpointInputSchemas.dealsSearch, output: HubSpotEndpointOutputSchemas.dealsSearch },
  'tickets.get': { input: HubSpotEndpointInputSchemas.ticketsGet, output: HubSpotEndpointOutputSchemas.ticketsGet },
  'tickets.getMany': { input: HubSpotEndpointInputSchemas.ticketsGetMany, output: HubSpotEndpointOutputSchemas.ticketsGetMany },
  'tickets.create': { input: HubSpotEndpointInputSchemas.ticketsCreate, output: HubSpotEndpointOutputSchemas.ticketsCreate },
  'tickets.update': { input: HubSpotEndpointInputSchemas.ticketsUpdate, output: HubSpotEndpointOutputSchemas.ticketsUpdate },
  'tickets.delete': { input: HubSpotEndpointInputSchemas.ticketsDelete, output: HubSpotEndpointOutputSchemas.ticketsDelete },
  'engagements.get': { input: HubSpotEndpointInputSchemas.engagementsGet, output: HubSpotEndpointOutputSchemas.engagementsGet },
  'engagements.getMany': { input: HubSpotEndpointInputSchemas.engagementsGetMany, output: HubSpotEndpointOutputSchemas.engagementsGetMany },
  'engagements.create': { input: HubSpotEndpointInputSchemas.engagementsCreate, output: HubSpotEndpointOutputSchemas.engagementsCreate },
  'engagements.delete': { input: HubSpotEndpointInputSchemas.engagementsDelete, output: HubSpotEndpointOutputSchemas.engagementsDelete },
  'contactLists.addContact': { input: HubSpotEndpointInputSchemas.contactListsAddContact, output: HubSpotEndpointOutputSchemas.contactListsAddContact },
  'contactLists.removeContact': { input: HubSpotEndpointInputSchemas.contactListsRemoveContact, output: HubSpotEndpointOutputSchemas.contactListsRemoveContact },
} as const;
