...
export const getByIds: TwitterApiIOEndpoints['tweetsGetByIds'] = async (ctx, input) => {
	...
	await logEventFromContext(ctx, 'twitterapiio.tweets.getByIds', { ...input }, 'completed');
	return response;
};

export const search: TwitterApiIOEndpoints['tweetsSearch'] = async (ctx, input) => {
	...
	await logEventFromContext(ctx, 'twitterapiio.tweets.search', { ...input }, 'completed');
	return response;
};

export const getUserTimeline: TwitterApiIOEndpoints['tweetsGetUserTimeline'] = async (
	ctx,
	input,
) => {
	const response = await makeTwitterApiIORequest<
...
export const getUserLastTweets: TwitterApiIOEndpoints['tweetsGetUserLastTweets'] = async (
	ctx,
	input,
) => {
	const response = await makeTwitterApiIORequest<
...
export const getUserMentions: TwitterApiIOEndpoints['tweetsGetUserMentions'] = async (
	ctx,
	input,
) => {
	const response = await makeTwitterApiIORequest<
...
export const getReplies: TwitterApiIOEndpoints['tweetsGetReplies'] = async (ctx, input) => {
	...
	await logEventFromContext(ctx, 'twitterapiio.tweets.getReplies', { ...input }, 'completed');
	return response;
};

export const getQuotations: TwitterApiIOEndpoints['tweetsGetQuotations'] = async (
	ctx,
	input,
) => {
	const response = await makeTwitterApiIORequest<
...
export const getRetweeters: TwitterApiIOEndpoints['tweetsGetRetweeters'] = async (
	ctx,
	input,
) => {
	const response = await makeTwitterApiIORequest<
...
export const getThreadContext: TwitterApiIOEndpoints['tweetsGetThreadContext'] = async (
	ctx,
	input,
) => {
	const response = await makeTwitterApiIORequest<
...
export const create: TwitterApiIOEndpoints['tweetsCreate'] = async (ctx, input) => {
...
export const deleteTweet: TwitterApiIOEndpoints['tweetsDelete'] = async (ctx, input) => {
	const response = await makeTwitterApiIORequest<
	...
	await logEventFromContext(ctx, 'twitterapiio.tweets.delete', { tweetId: input.tweetId }, 'completed');
	return response;
};
...
export const like: TwitterApiIOEndpoints['tweetsLike'] = async (ctx, input) => {
	...
	await logEventFromContext(ctx, 'twitterapiio.tweets.like', { tweetId: input.tweetId }, 'completed');
	return response;
};

export const unlike: TwitterApiIOEndpoints['tweetsUnlike'] = async (ctx, input) => {
	const response = await makeTwitterApiIORequest<
	...
	await logEventFromContext(ctx, 'twitterapiio.tweets.unlike', { tweetId: input.tweetId }, 'completed');
	return response;
};

export const retweet: TwitterApiIOEndpoints['tweetsRetweet'] = async (ctx, input) => {
	const response = await makeTwitterApiIORequest<
	...
	await logEventFromContext(ctx, 'twitterapiio.tweets.retweet', { tweetId: input.tweetId }, 'completed');
	return response;
};
