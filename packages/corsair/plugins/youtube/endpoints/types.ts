...
const PlaylistsListInputSchema = z.object({
	part: z.string().optional().describe('Comma-separated list of resource parts (snippet,status,contentDetails)'),
	pageToken: z.string().optional().describe('Token for the next page of results'),
	maxResults: z.number().int().optional().describe('Maximum number of results to return (1-50)'),
});
...
const PlaylistsCreateInputSchema = z.object({
	...
	privacyStatus: z.enum(['public', 'private', 'unlisted']).optional().describe('Privacy status of the playlist'),
});

const PlaylistsCreateResponseSchema = z.object({
	id: z.string().optional(),
	etag: z.string().optional(),
	kind: z.string().optional(),
	snippet: PlaylistSnippetSchema.optional(),
...
const PlaylistsUpdateInputSchema = z.object({
	...
	part: z.string().optional().describe('Comma-separated list of parts to update'),
	status: z.object({ privacyStatus: z.string().optional() }).optional(),
...
const PlaylistsDeleteInputSchema = z.object({
	...
	confirmDelete: z.boolean().describe('Confirm that you want to delete the playlist'),
	onBehalfOfContentOwner: z.string().optional(),
});
...
const PlaylistItemsAddInputSchema = z.object({
	...
	position: z.number().int().optional().describe('Zero-based position to insert the video'),
});
...
const VideosGetInputSchema = z.object({
	...
	part: z.string().optional().describe('Comma-separated list of resource parts'),
});

const VideosGetResponseSchema = z.object({
	etag: z.string().optional(),
	kind: z.string().optional(),
...
const VideosGetBatchInputSchema = z.object({
	id: z.array(z.string()).describe('Array of YouTube video IDs to retrieve (max 50)'),
...
const VideosGetBatchResponseSchema = z.object({
	etag: z.string().optional(),
	kind: z.string().optional(),
	items: z.array(VideoResourceSchema).optional(),
	pageInfo: PageInfoSchema.optional(),
...
const VideosListInputSchema = z.object({
	mine: z.boolean().optional().describe('List videos for the authenticated user'),
...
const VideosUpdateInputSchema = z.object({
	...
	privacy_status: z.string().optional().describe('Updated privacy status (public, private, unlisted)'),
	composio_execution_message: z.string().optional(),
});

const VideosUpdateResponseSchema = z.object({
	id: z.string().optional(),
	etag: z.string().optional(),
	kind: z.string().optional(),
	snippet: VideoSnippetSchema.optional(),
	status: z.object({ privacyStatus: z.string().optional(), uploadStatus: z.string().optional() }).optional(),
	statistics: z.object({ viewCount: z.string().optional(), likeCount: z.string().optional() }).optional(),
}).passthrough();
...
const VideosUploadInputSchema = z.object({
	...
	privacyStatus: z.enum(['public', 'private', 'unlisted']).describe('Privacy status'),
...
const VideosUploadMultipartResponseSchema = z.object({
...
const VideosDeleteInputSchema = z.object({
	...
	confirmDelete: z.boolean().describe('Confirm that you want to delete the video'),
	onBehalfOfContentOwner: z.string().optional(),
});
...
const ChannelsGetStatisticsInputSchema = z.object({
	...
	mine: z.boolean().optional().describe('Get statistics for the authenticated user\'s channel'),
	part: z.string().optional(),
	forHandle: z.string().optional().describe('Channel handle (e.g. @channelname)'),
	forUsername: z.string().optional(),
});

const ChannelsGetStatisticsResponseSchema = z.object({
	etag: z.string().optional(),
	kind: z.string().optional(),
...
const ChannelsGetIdByHandleInputSchema = z.object({
	channel_handle: z.string().describe('YouTube channel handle (e.g. @channelname)'),
});
...
const ChannelsGetActivitiesInputSchema = z.object({
	...
	pageToken: z.string().optional(),
	maxResults: z.number().int().optional(),
	publishedAfter: z.string().optional().describe('RFC 3339 datetime - only return activities after this time'),
	publishedBefore: z.string().optional().describe('RFC 3339 datetime - only return activities before this time'),
});

const ChannelsGetActivitiesResponseSchema = z.object({
	etag: z.string().optional(),
	kind: z.string().optional(),
...
const ChannelsUpdateResponseSchema = z.object({
	id: z.string().optional(),
	etag: z.string().optional(),
	kind: z.string().optional(),
	snippet: ChannelSnippetSchema.optional(),
...
const ChannelSectionsListInputSchema = z.object({
	part: z.string().describe('Comma-separated list of parts (snippet,contentDetails)'),
...
const ChannelSectionSchema = z.object({
	id: z.string().optional(),
	etag: z.string().optional(),
	kind: z.string().optional(),
	snippet: z.object({
...
const ChannelSectionsListResponseSchema = z.object({
	etag: z.string().optional(),
	kind: z.string().optional(),
...
const ChannelSectionsCreateInputSchema = z.object({
	snippet: z.object({
		type: z.enum([
			'allPlaylists', 'completedEvents', 'liveEvents', 'multipleChannels',
			'multiplePlaylists', 'popularUploads', 'recentUploads', 'singlePlaylist',
			'subscriptions', 'upcomingEvents',
		]).describe('The type of channel section'),
		title: z.string().optional().describe('Section title (for multiplePlaylists/multipleChannels types)'),
		position: z.number().int().optional().describe('Zero-based position on the channel page'),
	}).describe('Section snippet'),
	contentDetails: z.object({
		channels: z.array(z.string()).optional().describe('Channel IDs to feature (for multipleChannels type)'),
		playlists: z.array(z.string()).optional().describe('Playlist IDs to include'),
	}).optional(),
});
...
const CommentsListInputSchema = z.object({
	...
	part: z.string().optional(),
	parentId: z.string().optional().describe('Parent comment thread ID to list replies for'),
	pageToken: z.string().optional(),
	maxResults: z.number().int().optional(),
...
const CommentThreadResourceSchema = z.object({
	id: z.string().optional(),
	etag: z.string().optional(),
	kind: z.string().optional(),
	snippet: z.object({
...
const CommentThreadsList2InputSchema = z.object({
	...
	textFormat: z.enum(['html', 'plainText']).optional(),
	searchTerms: z.string().optional(),
	moderationStatus: z.enum(['heldForReview', 'likelySpam', 'published', 'rejected']).optional(),
	allThreadsRelatedToChannelId: z.string().optional(),
});
...
const CommentsPostResponseSchema = z.object({
	id: z.string().optional(),
	etag: z.string().optional(),
	kind: z.string().optional(),
	snippet: z.object({
...
const CommentsCreateReplyInputSchema = z.object({
	parentId: z.string().describe('The ID of the parent comment thread to reply to'),
...
const CommentsSetModerationStatusInputSchema = z.object({
	...
	moderationStatus: z.enum(['heldForReview', 'published', 'rejected']).describe('The moderation status to set'),
...
const SearchYouTubeInputSchema = z.object({
	...
	part: z.string().optional(),
	type: z.string().optional().describe('Resource type to search (video, channel, playlist)'),
	pageToken: z.string().optional(),
	maxResults: z.number().int().optional(),
});
...
const SearchYouTubeResponseSchema = z.object({
	etag: z.string().optional(),
	kind: z.string().optional(),
...
const SubscriptionsSubscribeResponseSchema = z.object({
	id: z.string().optional(),
	etag: z.string().optional(),
	kind: z.string().optional(),
	snippet: SubscriptionSnippetSchema.optional(),
	contentDetails: z.object({ totalItemCount: z.number().optional(), newItemCount: z.number().optional() }).optional(),
	subscriberSnippet: z.object({ title: z.string().optional(), channelId: z.string().optional() }).optional(),
...
const VideoActionsGetRatingResponseSchema = z.object({
	etag: z.string().optional(),
	kind: z.string().optional(),
	items: z.array(z.object({
		videoId: z.string().optional(),
...
const VideoActionsReportAbuseInputSchema = z.object({
	...
	comments: z.string().optional().describe('Additional comments about the abuse'),
...
const VideoActionsListAbuseReasonsResponseSchema = z.object({
	etag: z.string().optional(),
	kind: z.string().optional(),
	items: z.array(z.object({
		id: z.string().optional(),
		label: z.string().optional(),
		secondaryReasons: z.array(z.object({ id: z.string().optional(), label: z.string().optional() })).optional(),
	})).optional(),
	eventId: z.string().optional(),
	visitorId: z.string().optional(),
}).passthrough();
...
const VideoActionsUpdateThumbnailInputSchema = z.object({
	videoId: z.string().describe('The ID of the video to update the thumbnail for'),
	thumbnailUrl: z.string().describe('URL of the new thumbnail image'),
});

const VideoActionsUpdateThumbnailResponseSchema = z.object({
	etag: z.string().optional(),
	kind: z.string().optional(),
	items: z.array(z.object({ url: z.string().optional(), width: z.number().optional(), height: z.number().optional() })).optional(),
	eventId: z.string().optional(),
	visitorId: z.string().optional(),
}).passthrough();
...
const CaptionResourceSchema = z.object({
	id: z.string().optional(),
	etag: z.string().optional(),
	kind: z.string().optional(),
	snippet: z.object({
...
const CaptionsListResponseSchema = z.object({
	etag: z.string().optional(),
	kind: z.string().optional(),
...
const CaptionsUpdateInputSchema = z.object({
	...
	snippet: z.object({
		isDraft: z.boolean().optional().describe('Whether the caption track is a draft'),
...
const CaptionsLoadResponseSchema = z.object({
...
const LiveChatListMessagesInputSchema = z.object({
	liveChatId: z.string().describe('The ID of the live chat to list messages for'),
	hl: z.string().optional(),
	part: z.string().optional(),
	pageToken: z.string().optional(),
	maxResults: z.number().int().optional(),
...
const LiveChatMessageSchema = z.object({
	...
	snippet: z.object({
		...
		textMessageDetails: z.object({ messageText: z.string().optional() }).optional(),
	}).optional(),
...
const LiveChatListMessagesResponseSchema = z.object({
	etag: z.string().optional(),
	kind: z.string().optional(),
...
const LiveChatListSuperChatEventsResponseSchema = z.object({
	etag: z.string().optional(),
	kind: z.string().optional(),
	items: z.array(z.object({
		id: z.string().optional(),
...
const I18nListLanguagesResponseSchema = z.object({
	etag: z.string().optional(),
	kind: z.string().optional(),
	items: z.array(z.object({
		id: z.string().optional(),
		etag: z.string().optional(),
		kind: z.string().optional(),
		snippet: z.object({ hl: z.string().optional(), name: z.string().optional() }).optional(),
	})).optional(),
}).passthrough();
...
const I18nListRegionsResponseSchema = z.object({
	etag: z.string().optional(),
	kind: z.string().optional(),
	items: z.array(z.object({
		id: z.string().optional(),
		etag: z.string().optional(),
		kind: z.string().optional(),
		snippet: z.object({ gl: z.string().optional(), name: z.string().optional() }).optional(),
	})).optional(),
}).passthrough();
...
const VideoCategoriesListResponseSchema = z.object({
	etag: z.string().optional(),
	kind: z.string().optional(),
	items: z.array(z.object({
		id: z.string().optional(),
...
const PlaylistImagesListResponseSchema = z.object({
	kind: z.string().optional(),
	items: z.array(z.object({
		id: z.string().optional(),
		kind: z.string().optional(),
...
export type YoutubeEndpointInputs = {
	...
	commentsSetModerationStatus: z.infer<typeof CommentsSetModerationStatusInputSchema>;
	// Search
	...
	videoActionsListAbuseReasons: z.infer<typeof VideoActionsListAbuseReasonsInputSchema>;
	videoActionsUpdateThumbnail: z.infer<typeof VideoActionsUpdateThumbnailInputSchema>;
	// Captions
	...
	liveChatListSuperChatEvents: z.infer<typeof LiveChatListSuperChatEventsInputSchema>;
	// i18n
...
export type YoutubeEndpointOutputs = {
	...
	commentsSetModerationStatus: z.infer<typeof CommentsSetModerationStatusResponseSchema>;
	// Search
	...
	subscriptionsUnsubscribe: z.infer<typeof SubscriptionsUnsubscribeResponseSchema>;
	// Video Actions
	...
	videoActionsReportAbuse: z.infer<typeof VideoActionsReportAbuseResponseSchema>;
	videoActionsListAbuseReasons: z.infer<typeof VideoActionsListAbuseReasonsResponseSchema>;
	videoActionsUpdateThumbnail: z.infer<typeof VideoActionsUpdateThumbnailResponseSchema>;
	// Captions
	...
	liveChatListSuperChatEvents: z.infer<typeof LiveChatListSuperChatEventsResponseSchema>;
	// i18n
...
export type PlaylistItemsAddResponse = YoutubeEndpointOutputs['playlistItemsAdd'];
export type PlaylistItemsListInput = YoutubeEndpointInputs['playlistItemsList'];
export type PlaylistItemsListResponse = YoutubeEndpointOutputs['playlistItemsList'];
export type PlaylistItemsUpdateInput = YoutubeEndpointInputs['playlistItemsUpdate'];
export type PlaylistItemsUpdateResponse = YoutubeEndpointOutputs['playlistItemsUpdate'];
export type PlaylistItemsDeleteInput = YoutubeEndpointInputs['playlistItemsDelete'];
export type PlaylistItemsDeleteResponse = YoutubeEndpointOutputs['playlistItemsDelete'];
...
export type VideosListMostPopularInput = YoutubeEndpointInputs['videosListMostPopular'];
export type VideosListMostPopularResponse = YoutubeEndpointOutputs['videosListMostPopular'];
...
export type VideosUploadMultipartInput = YoutubeEndpointInputs['videosUploadMultipart'];
export type VideosUploadMultipartResponse = YoutubeEndpointOutputs['videosUploadMultipart'];
...
export type ChannelsGetStatisticsInput = YoutubeEndpointInputs['channelsGetStatistics'];
export type ChannelsGetStatisticsResponse = YoutubeEndpointOutputs['channelsGetStatistics'];
export type ChannelsGetIdByHandleInput = YoutubeEndpointInputs['channelsGetIdByHandle'];
export type ChannelsGetIdByHandleResponse = YoutubeEndpointOutputs['channelsGetIdByHandle'];
export type ChannelsGetActivitiesInput = YoutubeEndpointInputs['channelsGetActivities'];
export type ChannelsGetActivitiesResponse = YoutubeEndpointOutputs['channelsGetActivities'];
...
export type ChannelSectionsListInput = YoutubeEndpointInputs['channelSectionsList'];
export type ChannelSectionsListResponse = YoutubeEndpointOutputs['channelSectionsList'];
export type ChannelSectionsCreateInput = YoutubeEndpointInputs['channelSectionsCreate'];
export type ChannelSectionsCreateResponse = YoutubeEndpointOutputs['channelSectionsCreate'];
export type ChannelSectionsUpdateInput = YoutubeEndpointInputs['channelSectionsUpdate'];
export type ChannelSectionsUpdateResponse = YoutubeEndpointOutputs['channelSectionsUpdate'];
export type ChannelSectionsDeleteInput = YoutubeEndpointInputs['channelSectionsDelete'];
export type ChannelSectionsDeleteResponse = YoutubeEndpointOutputs['channelSectionsDelete'];
...
export type CommentThreadsListInput = YoutubeEndpointInputs['commentThreadsList'];
export type CommentThreadsListResponse = YoutubeEndpointOutputs['commentThreadsList'];
export type CommentThreadsList2Input = YoutubeEndpointInputs['commentThreadsList2'];
export type CommentThreadsList2Response = YoutubeEndpointOutputs['commentThreadsList2'];
...
export type CommentsCreateReplyInput = YoutubeEndpointInputs['commentsCreateReply'];
export type CommentsCreateReplyResponse = YoutubeEndpointOutputs['commentsCreateReply'];
...
export type CommentsMarkSpamResponse = YoutubeEndpointOutputs['commentsMarkSpam'];
export type CommentsSetModerationStatusInput = YoutubeEndpointInputs['commentsSetModerationStatus'];
export type CommentsSetModerationStatusResponse = YoutubeEndpointOutputs['commentsSetModerationStatus'];
...
export type SubscriptionsListResponse = YoutubeEndpointOutputs['subscriptionsList'];
export type SubscriptionsSubscribeInput = YoutubeEndpointInputs['subscriptionsSubscribe'];
export type SubscriptionsSubscribeResponse = YoutubeEndpointOutputs['subscriptionsSubscribe'];
export type SubscriptionsUnsubscribeInput = YoutubeEndpointInputs['subscriptionsUnsubscribe'];
export type SubscriptionsUnsubscribeResponse = YoutubeEndpointOutputs['subscriptionsUnsubscribe'];

export type VideoActionsRateInput = YoutubeEndpointInputs['videoActionsRate'];
export type VideoActionsRateResponse = YoutubeEndpointOutputs['videoActionsRate'];
export type VideoActionsGetRatingInput = YoutubeEndpointInputs['videoActionsGetRating'];
export type VideoActionsGetRatingResponse = YoutubeEndpointOutputs['videoActionsGetRating'];
export type VideoActionsReportAbuseInput = YoutubeEndpointInputs['videoActionsReportAbuse'];
export type VideoActionsReportAbuseResponse = YoutubeEndpointOutputs['videoActionsReportAbuse'];
export type VideoActionsListAbuseReasonsInput = YoutubeEndpointInputs['videoActionsListAbuseReasons'];
export type VideoActionsListAbuseReasonsResponse = YoutubeEndpointOutputs['videoActionsListAbuseReasons'];
export type VideoActionsUpdateThumbnailInput = YoutubeEndpointInputs['videoActionsUpdateThumbnail'];
export type VideoActionsUpdateThumbnailResponse = YoutubeEndpointOutputs['videoActionsUpdateThumbnail'];
...
export type LiveChatListMessagesInput = YoutubeEndpointInputs['liveChatListMessages'];
export type LiveChatListMessagesResponse = YoutubeEndpointOutputs['liveChatListMessages'];
export type LiveChatListSuperChatEventsInput = YoutubeEndpointInputs['liveChatListSuperChatEvents'];
export type LiveChatListSuperChatEventsResponse = YoutubeEndpointOutputs['liveChatListSuperChatEvents'];

export type I18nListLanguagesInput = YoutubeEndpointInputs['i18nListLanguages'];
export type I18nListLanguagesResponse = YoutubeEndpointOutputs['i18nListLanguages'];
...
export type VideoCategoriesListInput = YoutubeEndpointInputs['videoCategoriesList'];
export type VideoCategoriesListResponse = YoutubeEndpointOutputs['videoCategoriesList'];

export type PlaylistImagesListInput = YoutubeEndpointInputs['playlistImagesList'];
export type PlaylistImagesListResponse = YoutubeEndpointOutputs['playlistImagesList'];
