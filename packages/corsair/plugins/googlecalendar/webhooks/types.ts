...
export function decodePubSubMessage(data: string): GoogleCalendarPushNotification {
	const decodedData = Buffer.from(data, 'base64').toString('utf-8');
	return JSON.parse(decodedData);
}

export function createGoogleCalendarWebhookMatcher(eventType: GoogleCalendarEventName): CorsairWebhookMatcher {
