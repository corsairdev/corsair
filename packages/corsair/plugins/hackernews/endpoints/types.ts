...
const HackerNewsItemDetailedSchema = z.object({
	id: z.number(),
...
const GetItemWithIdResponseSchema = z.object({
	found: z.boolean(),
	item: HackerNewsItemDetailedSchema.optional(),
	error_message: z.string().optional(),
}).passthrough();

const GetMaxItemIdResponseSchema = z.object({
	max_item_id: z.number(),
}).passthrough();

const GetTopStoriesResponseSchema = z.object({
	story_ids: z.array(z.number()),
	count: z.number(),
}).passthrough();

const GetBestStoriesResponseSchema = z.object({
	story_ids: z.array(z.number()),
	count: z.number(),
}).passthrough();

const GetNewStoriesResponseSchema = z.object({
	story_ids: z.array(z.number()),
}).passthrough();

const GetAskStoriesResponseSchema = z.object({
	story_ids: z.array(z.number()),
}).passthrough();

const GetShowStoriesResponseSchema = z.object({
	story_ids: z.array(z.number()),
}).passthrough();

const GetJobStoriesResponseSchema = z.object({
...
const GetLatestPostsResponseSchema = z.object({
	hits: z.array(HackerNewsHitSchema),
	nbHits: z.number(),
	page: z.number(),
	nbPages: z.number(),
...
const GetFrontpageResponseSchema = z.object({
	posts: z.array(FrontpagePostSchema),
	total_hits: z.number(),
}).passthrough();

const GetTodaysPostsResponseSchema = z.object({
...
export type GetBestStoriesResponse = z.infer<typeof GetBestStoriesResponseSchema>;
...
export type GetShowStoriesResponse = z.infer<typeof GetShowStoriesResponseSchema>;
...
export type GetLatestPostsResponse = z.infer<typeof GetLatestPostsResponseSchema>;
export type GetFrontpageResponse = z.infer<typeof GetFrontpageResponseSchema>;
export type GetTodaysPostsResponse = z.infer<typeof GetTodaysPostsResponseSchema>;
