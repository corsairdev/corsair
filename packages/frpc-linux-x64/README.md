# @corsair-dev/frpc-linux-x64

The prebuilt `frpc` binary ([fatedier/frp](https://github.com/fatedier/frp), linux/x64) that the [`corsair`](https://www.npmjs.com/package/corsair) dev tunnel spawns.
