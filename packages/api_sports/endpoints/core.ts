...
export const getCountries: ApiSportsEndpoints['getCountries'] = async (ctx, input) => {
	...
	const response = await executeApiSportsRequest<ApiSportsEndpointOutputs['getCountries']>(
		ctx,
		route.sport,
		route.path,
...
export const getTimezone: ApiSportsEndpoints['getTimezone'] = async (ctx, input) => {
	...
	const response = await executeApiSportsRequest<ApiSportsEndpointOutputs['getTimezone']>(
		ctx,
		route.sport,
		route.path,
		{ apiKey: ctx.key, query: input },
...
export const getLeagues: ApiSportsEndpoints['getLeagues'] = async (ctx, input) => {
	...
	const response = await executeApiSportsRequest<ApiSportsEndpointOutputs['getLeagues']>(
		ctx,
		route.sport,
		route.path,
		{ apiKey: ctx.key, query: input },
...
export const getLeagueSeasons: ApiSportsEndpoints['getLeagueSeasons'] = async (ctx, input) => {
	...
	const response = await executeApiSportsRequest<ApiSportsEndpointOutputs['getLeagueSeasons']>(
		ctx,
		route.sport,
		route.path,
		{ apiKey: ctx.key, query: input },
...
export const getTeams: ApiSportsEndpoints['getTeams'] = async (ctx, input) => {
	...
	const response = await executeApiSportsRequest<ApiSportsEndpointOutputs['getTeams']>(
		ctx,
		route.sport,
		route.path,
		{ apiKey: ctx.key, query: input },
...
export const getTeamSeasons: ApiSportsEndpoints['getTeamSeasons'] = async (ctx, input) => {
	...
	const response = await executeApiSportsRequest<ApiSportsEndpointOutputs['getTeamSeasons']>(
		ctx,
		route.sport,
		route.path,
		{ apiKey: ctx.key, query: input },
...
export const getTeamStatistics: ApiSportsEndpoints['getTeamStatistics'] = async (ctx, input) => {
	...
	const response = await executeApiSportsRequest<ApiSportsEndpointOutputs['getTeamStatistics']>(
		ctx,
		route.sport,
		route.path,
		{ apiKey: ctx.key, query: input },
...
export const getVenues: ApiSportsEndpoints['getVenues'] = async (ctx, input) => {
	...
	const response = await executeApiSportsRequest<ApiSportsEndpointOutputs['getVenues']>(
		ctx,
		route.sport,
		route.path,
		{ apiKey: ctx.key, query: input },
...
export const getCoaches: ApiSportsEndpoints['getCoaches'] = async (ctx, input) => {
	...
	const response = await executeApiSportsRequest<ApiSportsEndpointOutputs['getCoaches']>(
		ctx,
		route.sport,
		route.path,
		{ apiKey: ctx.key, query: input },
...
export const getInjuries: ApiSportsEndpoints['getInjuries'] = async (ctx, input) => {
	...
	const response = await executeApiSportsRequest<ApiSportsEndpointOutputs['getInjuries']>(
		ctx,
		route.sport,
		route.path,
		{ apiKey: ctx.key, query: input },
...
export const getSidelined: ApiSportsEndpoints['getSidelined'] = async (ctx, input) => {
	...
	const response = await executeApiSportsRequest<ApiSportsEndpointOutputs['getSidelined']>(
		ctx,
		route.sport,
		route.path,
		{ apiKey: ctx.key, query: input },
...
export const getTransfers: ApiSportsEndpoints['getTransfers'] = async (ctx, input) => {
	...
	const response = await executeApiSportsRequest<ApiSportsEndpointOutputs['getTransfers']>(
		ctx,
		route.sport,
		route.path,
		{ apiKey: ctx.key, query: input },
...
export const getTrophies: ApiSportsEndpoints['getTrophies'] = async (ctx, input) => {
	...
	const response = await executeApiSportsRequest<ApiSportsEndpointOutputs['getTrophies']>(
		ctx,
		route.sport,
		route.path,
		{ apiKey: ctx.key, query: input },
...
export const getPredictions: ApiSportsEndpoints['getPredictions'] = async (ctx, input) => {
	...
	const response = await executeApiSportsRequest<ApiSportsEndpointOutputs['getPredictions']>(
		ctx,
		route.sport,
		route.path,
		{ apiKey: ctx.key, query: input },
