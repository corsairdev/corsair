...
export const getBasketballStatistics: ApiSportsEndpoints['getBasketballStatistics'] =
	async (ctx, input) => {
		...
		await logEventFromContext(
			ctx,
			'api_sports.basketball.getBasketballStatistics',
			input ?? {},
			'completed',
		);
		return response;
...
export const getBasketballBets: ApiSportsEndpoints['getBasketballBets'] =
	async (ctx, input) => {
		...
		await logEventFromContext(
			ctx,
			'api_sports.basketball.getBasketballBets',
			input ?? {},
			'completed',
		);
		return response;
...
export const getBasketballBookmakers: ApiSportsEndpoints['getBasketballBookmakers'] =
	async (ctx, input) => {
		...
		await logEventFromContext(
			ctx,
			'api_sports.basketball.getBasketballBookmakers',
			input ?? {},
			'completed',
		);
		return response;
...
export const getNbaGameStatistics: ApiSportsEndpoints['getNbaGameStatistics'] =
	async (ctx, input) => {
		...
		await logEventFromContext(
			ctx,
			'api_sports.basketball.getNbaGameStatistics',
			input ?? {},
			'completed',
		);
		return response;
...
export const getPlayerStatistics: ApiSportsEndpoints['getPlayerStatistics'] =
	async (ctx, input) => {
		...
		await logEventFromContext(
			ctx,
			'api_sports.basketball.getPlayerStatistics',
			input ?? {},
			'completed',
		);
		return response;
...
export const getGameStatisticsByTeams: ApiSportsEndpoints['getGameStatisticsByTeams'] =
	async (ctx, input) => {
		...
		await logEventFromContext(
			ctx,
			'api_sports.basketball.getGameStatisticsByTeams',
			input ?? {},
			'completed',
		);
		return response;
...
export const getGamesEvents: ApiSportsEndpoints['getGamesEvents'] = async (
	...
	await logEventFromContext(
		ctx,
		'api_sports.basketball.getGamesEvents',
		input ?? {},
		'completed',
	);
	return response;
