...
export const getCampaignReportsEmailActivity: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, getCampaignReportsEmailActivityRoute);
};
...
export const getContactsStatisticsCampaign: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, getContactsStatisticsCampaignRoute);
};
...
export const getContactsSubscriptionAllContacts: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, getContactsSubscriptionAllContactsRoute);
};
...
export const getContactsSubscriptionCustomersStatus: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, getContactsSubscriptionCustomersStatusRoute);
};
...
export const getContactsSubscriptionSubscribers: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, getContactsSubscriptionSubscribersRoute);
};
...
export const getContactsSubscriptionUnsubscribers: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, getContactsSubscriptionUnsubscribersRoute);
};
...
export const getContactsUnsubscribersSms: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, getContactsUnsubscribersSmsRoute);
};
...
export const getCustomerStatsForTransactionalMessage: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, getCustomerStatsForTransactionalMessageRoute);
};
...
export const listTransactionalSmsMessages: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, listTransactionalSmsMessagesRoute);
};
