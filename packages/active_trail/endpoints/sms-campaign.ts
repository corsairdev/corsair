...
export const getTransactionalSmsMessage: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, getTransactionalSmsMessageRoute);
};
...
export const updateSmsOperationalMessage: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, updateSmsOperationalMessageRoute);
};
