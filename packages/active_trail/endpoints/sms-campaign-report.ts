...
export const getAutomationReportsSmsCampaignSummary: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, getAutomationReportsSmsCampaignSummaryRoute);
};
...
export const getAutomationReportsSummaryReport: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, getAutomationReportsSummaryReportRoute);
};
...
export const getPushCampaignReportSummary: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, getPushCampaignReportSummaryRoute);
};
...
export const getSmsCampaignReportClicks: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, getSmsCampaignReportClicksRoute);
};
...
export const getSmsCampaignReportFailed: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, getSmsCampaignReportFailedRoute);
};
...
export const getSmsCampaignReportSummary: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, getSmsCampaignReportSummaryRoute);
};
...
export const getSmsCampaignReportUnsubscribed: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, getSmsCampaignReportUnsubscribedRoute);
};
