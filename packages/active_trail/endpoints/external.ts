...
export const createSmsOperationalMessage: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, createSmsOperationalMessageRoute);
};
...
export const removeExternalContactFromGroup: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, removeExternalContactFromGroupRoute);
};
...
export const sendOperationalMessageEmail: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, sendOperationalMessageEmailRoute);
};
