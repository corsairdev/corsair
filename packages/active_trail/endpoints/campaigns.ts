...
export const createCampaignForContacts: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, createCampaignForContactsRoute);
};
...
export const getCampaignsSentCampaigns: ActiveTrailEndpoint = async (ctx, input = {}) => {
	return executeActiveTrailOperation(ctx, input, getCampaignsSentCampaignsRoute);
};
