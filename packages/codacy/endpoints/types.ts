...
export const CodacyEndpointOutputSchemas = {
	createApiToken: z.record(z.unknown()),
	deleteApiToken: z.record(z.unknown()),
	getAccountDetails: z.record(z.unknown()),
	getConfigurationStatus: z.record(z.unknown()),
	getHealth: z.record(z.unknown()),
	getOrganizationsRepositoriesSettingsLanguages: z.record(z.unknown()),
	getToolPattern: z.record(z.unknown()),
	getUserOrganizations: z.record(z.unknown()),
	getVersion: z.record(z.unknown()),
	listAnalysisOrganizationsRepositories: z.record(z.unknown()),
	listDuplicationTools: z.record(z.unknown()),
	listLanguagesAndTools: z.record(z.unknown()),
	listLoginIntegrations: z.record(z.unknown()),
	listMetricsTools: z.record(z.unknown()),
	listProjects: z.record(z.unknown()),
	listProviderIntegrations: z.record(z.unknown()),
	listTools: z.record(z.unknown()),
	listToolsPatterns: z.record(z.unknown()),
};
