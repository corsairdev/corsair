...
export const getProspect: WorkdayEndpoints['getProspect'] = async (
	...
	>('v1/prospect/getProspect', ctx.key, {
		method: 'GET',
...
export const getProspectExperiences: WorkdayEndpoints['getProspectExperiences'] =
	async (ctx, input) => {
		...
		>('v1/prospect/getProspectExperiences', ctx.key, {
			method: 'GET',
			// Justification: The makeWorkdayRequest client expects a generic string/number/boolean query record.
			query: input as { [key: string]: string | number | boolean | undefined },
		});
...
export const getProspectResumeAttachments: WorkdayEndpoints['getProspectResumeAttachments'] =
	async (ctx, input) => {
		...
		>('v1/prospect/getProspectResumeAttachments', ctx.key, {
			method: 'GET',
			// Justification: The makeWorkdayRequest client expects a generic string/number/boolean query record.
			query: input as { [key: string]: string | number | boolean | undefined },
		});
...
export const getProspectSkills: WorkdayEndpoints['getProspectSkills'] = async (
	...
	>('v1/prospect/getProspectSkills', ctx.key, {
		method: 'GET',
		// Justification: The makeWorkdayRequest client expects a generic unknown record.
		query: input as { [key: string]: string | number | boolean | undefined },
	});
