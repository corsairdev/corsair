...
export const listSignatureRequests: DropboxSignEndpoints['listSignatureRequests'] = async (ctx, input) => {
	const result = await makeDropboxSignRequest<DropboxSignEndpointOutputs['listSignatureRequests']>(
...
export const sendSignatureRequest: DropboxSignEndpoints['sendSignatureRequest'] = async (ctx, input) => {
	const result = await makeDropboxSignRequest<DropboxSignEndpointOutputs['sendSignatureRequest']>(
...
export const createEmbeddedSignatureRequest: DropboxSignEndpoints['createEmbeddedSignatureRequest'] = async (ctx, input) => {
	const result = await makeDropboxSignRequest<DropboxSignEndpointOutputs['createEmbeddedSignatureRequest']>(
...
export const createEmbeddedSignatureRequestWithTemplate: DropboxSignEndpoints['createEmbeddedSignatureRequestWithTemplate'] = async (ctx, input) => {
	const result = await makeDropboxSignRequest<DropboxSignEndpointOutputs['createEmbeddedSignatureRequestWithTemplate']>(
