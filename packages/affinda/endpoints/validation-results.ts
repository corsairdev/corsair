...
export const createValidationResult: AffindaEndpoint = async (ctx, input = {}) => {
	return executeAffindaOperation(ctx, input, createValidationResultRoute);
};

const createValidationResultsBatchRoute = getRoute('createValidationResultsBatch');
export const createValidationResultsBatch: AffindaEndpoint = async (ctx, input = {}) => {
...
export const deleteValidationResults: AffindaEndpoint = async (ctx, input = {}) => {
...
export const getAllValidationResults: AffindaEndpoint = async (ctx, input = {}) => {
