...
export const createResthookSubscription: AffindaEndpoint = async (ctx, input = {}) => {
...
export const deleteResthookSubscription: AffindaEndpoint = async (ctx, input = {}) => {
...
export const getResthookSubscription: AffindaEndpoint = async (ctx, input = {}) => {
...
export const getResthookSubscriptions: AffindaEndpoint = async (ctx, input = {}) => {
...
export const updateResthookSubscription: AffindaEndpoint = async (ctx, input = {}) => {
