...
export const createWorkspaceMembership: AffindaEndpoint = async (ctx, input = {}) => {
...
export const deleteWorkspaceMembership: AffindaEndpoint = async (ctx, input = {}) => {
...
export const getAllWorkspaceMemberships: AffindaEndpoint = async (ctx, input = {}) => {
...
export const getWorkspaceMembership: AffindaEndpoint = async (ctx, input = {}) => {
