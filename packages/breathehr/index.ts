...
export type BreatheHrBoundEndpoints = BindEndpoints<typeof breatheHrEndpointsNested>;

type BreatheHrEndpoint<K extends keyof BreatheHrEndpointOutputs> = CorsairEndpoint<
  BreatheHrContext,
...
} as const satisfies RequiredPluginEndpointSchemas<typeof breatheHrEndpointsNested>;

const breatheHrEndpointMeta = {
  'employees.list': { riskLevel: 'read', description: 'List all employees' },
  'employees.get': { riskLevel: 'read', description: 'Get employee details by ID' },
  'employees.create': { riskLevel: 'write', description: 'Create a new employee profile' },
  'leaves.list': { riskLevel: 'read', description: 'List employee leaves and absences' },
  'leaves.get': { riskLevel: 'read', description: 'Get a specific leave request' },
} as const satisfies RequiredPluginEndpointMeta<typeof breatheHrEndpointsNested>;
...
export type BaseBreatheHrPlugin<T extends BreatheHrPluginOptions> = CorsairPlugin<
  'breathehr',
  typeof BreatheHrSchema,
...
export type InternalBreatheHrPlugin = BaseBreatheHrPlugin<BreatheHrPluginOptions>;
export type ExternalBreatheHrPlugin<T extends BreatheHrPluginOptions> = BaseBreatheHrPlugin<T>;

export function breathehr<const T extends BreatheHrPluginOptions>(
  incomingOptions: BreatheHrPluginOptions & T = {} as BreatheHrPluginOptions & T,
