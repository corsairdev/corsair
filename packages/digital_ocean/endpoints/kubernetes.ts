...
export const createNewKubernetesCluster: DigitalOceanEndpoint = async (ctx, input = {}) => {
	return executeDigitalOceanOperation(ctx, input, createNewKubernetesClusterRoute);
};
...
export const listAllKubernetesClusters: DigitalOceanEndpoint = async (ctx, input = {}) => {
	return executeDigitalOceanOperation(ctx, input, listAllKubernetesClustersRoute);
};
