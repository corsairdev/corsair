...
export const BenzingaWebhookPayloadSchema = z.object({
	type: z.string(),
	created_at: z.string(),
...
export const ExampleEventSchema = BenzingaWebhookPayloadSchema.extend({
...
export function createBenzingaMatch(eventType: string): CorsairWebhookMatcher {
