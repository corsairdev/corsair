...
export const list: YoutubeEndpoints['commentsList'] = async (ctx, input) => {
	const response = await makeYoutubeRequest<YoutubeEndpointOutputs['commentsList']>(
		'/comments',
		ctx.key,
		{
			method: 'GET',
	...
	await logEventFromContext(ctx, 'youtube.comments.list', { parentId: input.parentId }, 'completed');
	return response;
};

export const threadsList: YoutubeEndpoints['commentThreadsList'] = async (ctx, input) => {
	const response = await makeYoutubeRequest<YoutubeEndpointOutputs['commentThreadsList']>(
		'/commentThreads',
		ctx.key,
		{
			method: 'GET',
	...
	await logEventFromContext(ctx, 'youtube.comments.threadsList', { videoId: input.videoId }, 'completed');
	return response;
};

export const threadsList2: YoutubeEndpoints['commentThreadsList2'] = async (ctx, input) => {
	const response = await makeYoutubeRequest<YoutubeEndpointOutputs['commentThreadsList2']>(
		'/commentThreads',
		ctx.key,
		{
			method: 'GET',
	...
	await logEventFromContext(ctx, 'youtube.comments.threadsList2', { videoId: input.videoId }, 'completed');
	return response;
};

export const post: YoutubeEndpoints['commentsPost'] = async (ctx, input) => {
	const response = await makeYoutubeRequest<YoutubeEndpointOutputs['commentsPost']>(
		'/commentThreads',
		ctx.key,
		{
			method: 'POST',
	...
	await logEventFromContext(ctx, 'youtube.comments.post', { videoId: input.videoId }, 'completed');
	return response;
};

export const createReply: YoutubeEndpoints['commentsCreateReply'] = async (ctx, input) => {
	const response = await makeYoutubeRequest<YoutubeEndpointOutputs['commentsCreateReply']>(
		'/comments',
		ctx.key,
		{
			method: 'POST',
	...
	await logEventFromContext(ctx, 'youtube.comments.createReply', { parentId: input.parentId }, 'completed');
	return response;
};

export const update: YoutubeEndpoints['commentsUpdate'] = async (ctx, input) => {
	const response = await makeYoutubeRequest<YoutubeEndpointOutputs['commentsUpdate']>(
		'/comments',
		ctx.key,
		{
			method: 'PUT',
	...
	await logEventFromContext(ctx, 'youtube.comments.update', { id: input.id }, 'completed');
	return response;
};
...
export const setModerationStatus: YoutubeEndpoints['commentsSetModerationStatus'] = async (ctx, input) => {
	...
	await logEventFromContext(ctx, 'youtube.comments.setModerationStatus', { id: input.id, moderationStatus: input.moderationStatus }, 'completed');
	return {
		success: true,
