...
export const ZoominfoWebhookPayloadSchema = z.object({
	type: z.string(),
	created_at: z.string(),
...
export const ExampleEventSchema = ZoominfoWebhookPayloadSchema.extend({
...
export function createZoominfoMatch(eventType: string): CorsairWebhookMatcher {
