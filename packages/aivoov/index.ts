...
const aivoovEndpointsNested = {
	aivoov: {
		listVoices: Aivoov.listVoices,
		createAudio: Aivoov.createAudio,
	},
} as const;
...
const aivoovEndpointMeta = {
	'aivoov.listVoices': {
		riskLevel: 'read',
		description: 'List available AiVOOV voices',
	},

	'aivoov.createAudio': {
		riskLevel: 'write',
		description: 'Generate audio from text using an AiVOOV voice',
	},
