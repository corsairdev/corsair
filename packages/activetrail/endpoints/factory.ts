...
const PATH_PARAM_ALIASES: Record<string, readonly string[]> = {
	...
	mailinglistId: ['mailinglist_id', 'id', 'mailinglistId'],
	externalId: ['external_id', 'id', 'externalId'],
	orderId: ['order_id', 'orderId', 'id'],
	messageId: ['message_id', 'transactional_id', 'messageId'],
	parameterid: ['parameter_id', 'parameterid'],
	campaign_id: ['campaign_id', 'id'],
	webhook_id: ['webhook_id', 'id'],
	transactional_sms_id: ['transactional_sms_id', 'id'],
	transactional_id: ['transactional_id', 'message_id'],
