...
export const createContentCategory: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
...
const deleteAccountContentCategoriesRoute = getRoute(
	'deleteAccountContentCategories',
);
export const deleteAccountContentCategories: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
	return executeActiveTrailOperation(
		ctx,
		input,
		deleteAccountContentCategoriesRoute,
	);
};

const getAccountBalanceRoute = getRoute('getAccountBalance');
export const getAccountBalance: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
...
const getAccountContentCategories2Route = getRoute(
	'getAccountContentCategories2',
);
export const getAccountContentCategories2: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
	return executeActiveTrailOperation(
		ctx,
		input,
		getAccountContentCategories2Route,
	);
};

const getAccountIntegrationdataRoute = getRoute('getAccountIntegrationdata');
export const getAccountIntegrationdata: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
	return executeActiveTrailOperation(
		ctx,
		input,
		getAccountIntegrationdataRoute,
	);
};
...
export const getContactFields: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
...
export const getContentCategories: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
...
export const getExecutiveReport: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
...
export const getTwoWaySmsReplies: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
...
const putAccountContentCategoriesRoute = getRoute(
	'putAccountContentCategories',
);
export const putAccountContentCategories: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
	return executeActiveTrailOperation(
		ctx,
		input,
		putAccountContentCategoriesRoute,
	);
};
