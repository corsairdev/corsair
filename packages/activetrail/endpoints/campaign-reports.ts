...
export const getAllCampaignReports: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
...
export const getAllSentCampaigns: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
...
export const getCampaignBounces: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
...
export const getCampaignReportsBounced: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
	return executeActiveTrailOperation(
		ctx,
		input,
		getCampaignReportsBouncedRoute,
	);
};

const getCampaignReportsComplaintsRoute = getRoute(
	'getCampaignReportsComplaints',
);
export const getCampaignReportsComplaints: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
	return executeActiveTrailOperation(
		ctx,
		input,
		getCampaignReportsComplaintsRoute,
	);
};

const getCampaignReportsSentRoute = getRoute('getCampaignReportsSent');
export const getCampaignReportsSent: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
...
export const getCampaignReportsUnopened: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
	return executeActiveTrailOperation(
		ctx,
		input,
		getCampaignReportsUnopenedRoute,
	);
};

const getCampaignUnsubscribedRoute = getRoute('getCampaignUnsubscribed');
export const getCampaignUnsubscribed: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
...
export const getPushCampaignReports: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
