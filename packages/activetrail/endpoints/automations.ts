...
export const deleteAutomations: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
...
export const getAutomationLog: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
...
const getAutomationReportsLogAutomationQueueRoute = getRoute(
	'getAutomationReportsLogAutomationQueue',
);
export const getAutomationReportsLogAutomationQueue: ActiveTrailEndpoint =
	async (ctx, input = {}) => {
		return executeActiveTrailOperation(
			ctx,
			input,
			getAutomationReportsLogAutomationQueueRoute,
		);
	};
...
export const getAutomationsDetails: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
...
const getAutomationsEmailCampaignStepsRoute = getRoute(
	'getAutomationsEmailCampaignSteps',
);
export const getAutomationsEmailCampaignSteps: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
	return executeActiveTrailOperation(
		ctx,
		input,
		getAutomationsEmailCampaignStepsRoute,
	);
};

const getAutomationsSmsCampaignStepsRoute = getRoute(
	'getAutomationsSmsCampaignSteps',
);
export const getAutomationsSmsCampaignSteps: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
	return executeActiveTrailOperation(
		ctx,
		input,
		getAutomationsSmsCampaignStepsRoute,
	);
};

const getAutomationTriggerTypesRoute = getRoute('getAutomationTriggerTypes');
export const getAutomationTriggerTypes: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
	return executeActiveTrailOperation(
		ctx,
		input,
		getAutomationTriggerTypesRoute,
	);
};

const getUpdateActionsRoute = getRoute('getUpdateActions');
export const getUpdateActions: ActiveTrailEndpoint = async (
	ctx,
	input = {},
) => {
