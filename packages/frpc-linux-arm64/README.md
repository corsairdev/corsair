# @corsair-dev/frpc-linux-arm64

The prebuilt `frpc` binary ([fatedier/frp](https://github.com/fatedier/frp), linux/arm64) that the [`corsair`](https://www.npmjs.com/package/corsair) dev tunnel spawns.
