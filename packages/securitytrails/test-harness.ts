import type { SecuritytrailsContext } from './index';

/**
 * Shared fetch/context doubles for the unit tests.
 *
 * Nothing here talks to SecurityTrails. Live coverage lives in `api.test.ts`,
 ...
 * write. Pass `failingEntities` to make a store reject, which is how the tests
 * prove a cache failure cannot fail the endpoint.
 */
export function createContext(
	...
	} as unknown as SecuritytrailsContext;
