...
export const BitbucketAccount = z
	.object({
		type: S,
		uuid: S,
		display_name: S,
...
export const BitbucketRendered = z
	.object({
		raw: S,
		markup: S,
		html: S,
...
export const BitbucketBranchTarget = z
	.object({
		hash: S,
		type: S,
	})
...
export const BitbucketWorkspaceEntity = z
	.object({
		uuid: Id,
		type: S,
		name: S,
...
export const BitbucketUserEntity = z
	.object({
		uuid: Id,
		type: S,
		display_name: S,
...
export const BitbucketProjectEntity = z
	.object({
		uuid: Id,
		type: S,
		key: S,
...
export const BitbucketRepositoryEntity = z
	.object({
		uuid: Id,
		type: S,
		name: S,
...
export const BitbucketPullRequestEndpoint = z
	.object({
...
export const BitbucketPullRequestEntity = z
	.object({
		id: NumId,
		type: S,
		title: S,
...
export const BitbucketIssueEntity = z
	.object({
		id: NumId,
		type: S,
		title: S,
...
export const BitbucketSnippetEntity = z
	.object({
		id: NumId,
		type: S,
		title: S,
...
export const BitbucketPipelineEntity = z
	.object({
		uuid: Id,
		type: S,
		build_number: N,
...
export const BitbucketCommitEntity = z
	.object({
		hash: Id,
		type: S,
		date: S,
...
export const BitbucketBranchEntity = z
	.object({
		name: Id,
		type: S,
...
export const BitbucketTagEntity = z
	.object({
		name: Id,
		type: S,
		message: S,
