export const bitbucketOperationCatalog = [
	...
	},
	{
		...
		queryFields: ['ignore_whitespace', 'merge', 'path', 'renames', 'topic'],
		fixedPathValues: {},
		projectFilterField: undefined,
		acceptsBody: false,
		bodyRequired: false,
