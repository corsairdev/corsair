# @corsair-dev/frpc-darwin-arm64

The prebuilt `frpc` binary ([fatedier/frp](https://github.com/fatedier/frp), darwin/arm64) that the [`corsair`](https://www.npmjs.com/package/corsair) dev tunnel spawns.
