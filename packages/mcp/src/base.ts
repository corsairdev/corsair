...
export function createBaseMcpServer(options: BaseMcpOptions): McpServer {
  ...
  server.registerTool(
    'manage_workflows',
    {
      description: `List, create, update, or delete Corsair workflows. Use action="create" with webhookTrigger to register a webhook-triggered workflow, or cronSchedule for a cron workflow.
      ...
      'request_permission',
      {
        ...
        inputSchema: z.object({
          ...
          jid: z
            .string()
            .optional()
            .describe('Optional chat/conversation ID for resuming after approval'),
        }),
      },
