...
// namespace. A stubbed manage hid a `manage.status` vs `manage.connectionStatus`
// mismatch that only surfaced on a live authorize poll.
...
testDb.cleanup();
console.log('mastra-tool-provider.live.check.ts passed');
