...
export const publish: InstagramEndpoints['PublishInstagramMedia'] = async (ctx, input) => {

    const result = await makeAuthenticatedInstagramRequest<InstagramEndpointOutputs['PublishInstagramMedia']>
