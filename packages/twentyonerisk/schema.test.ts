...
describe('TwentyOneRisk schema', () => {
	it('declares a semver version', () => {
		expect(TwentyOneRiskSchema.version).toBeDefined();
	...
	it('declares an entities map', () => {
		...
		expect(Array.isArray(Object.keys(TwentyOneRiskSchema.entities))).toBe(true);
		for (const entity of Object.values(TwentyOneRiskSchema.entities)) {
