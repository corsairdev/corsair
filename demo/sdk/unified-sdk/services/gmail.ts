...
export class MessagesService {
	...
	public static messagesDelete(userId: string = 'me', id: string) {
	...
	public static messagesTrash(userId: string = 'me', id: string) {
		return __request<Message>(OpenAPI, {
			method: 'POST',
	...
	public static messagesUntrash(userId: string = 'me', id: string) {
		return __request<Message>(OpenAPI, {
			method: 'POST',
...
export class LabelsService {
	...
	public static labelsGet(userId: string = 'me', id: string) {
	...
	public static labelsCreate(userId: string = 'me', body: Label) {
		return __request<Label>(OpenAPI, {
			method: 'POST',
			url: '/gmail/v1/users/{userId}/labels',
			path: {
	...
	public static labelsUpdate(userId: string = 'me', id: string, body: Label) {
		return __request<Label>(OpenAPI, {
			method: 'PUT',
			url: '/gmail/v1/users/{userId}/labels/{id}',
			path: {
	...
	public static labelsDelete(userId: string = 'me', id: string) {
		return __request<void>(OpenAPI, {
			method: 'DELETE',
			url: '/gmail/v1/users/{userId}/labels/{id}',
			path: {
...
export class DraftsService {
	...
	public static draftsCreate(userId: string = 'me', body: Draft) {
		return __request<Draft>(OpenAPI, {
			method: 'POST',
			url: '/gmail/v1/users/{userId}/drafts',
			path: {
	...
	public static draftsUpdate(userId: string = 'me', id: string, body: Draft) {
		return __request<Draft>(OpenAPI, {
			method: 'PUT',
			url: '/gmail/v1/users/{userId}/drafts/{id}',
			path: {
	...
	public static draftsDelete(userId: string = 'me', id: string) {
		return __request<void>(OpenAPI, {
			method: 'DELETE',
			url: '/gmail/v1/users/{userId}/drafts/{id}',
			path: {
...
export class ThreadsService {
	...
	public static threadsDelete(userId: string = 'me', id: string) {
		return __request<void>(OpenAPI, {
			method: 'DELETE',
			url: '/gmail/v1/users/{userId}/threads/{id}',
			path: {
	...
	public static threadsTrash(userId: string = 'me', id: string) {
		return __request<Thread>(OpenAPI, {
			method: 'POST',
	...
	public static threadsUntrash(userId: string = 'me', id: string) {
		return __request<Thread>(OpenAPI, {
			method: 'POST',
...
export class UsersService {
	...
	public static usersWatch(userId: string = 'me', body: WatchRequest) {
