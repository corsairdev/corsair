...
export class MetaService {
	 ...
	 * @throws ApiError
	 */
	public static metaGetOctocat(s?: string): CancelablePromise<string> {
		return __request(OpenAPI, {
			method: 'GET',
			url: '/octocat',
			query: {
...
export class OrgsService {
	 ...
	 * @throws ApiError
	 */
	public static orgsGet(org: string): CancelablePromise<organization_full> {
		return __request(OpenAPI, {
			method: 'GET',
			url: '/orgs/{org}',
			path: {
...
export class ReposService {
	...
	public static reposGetContent(
		...
		content_directory | content_file | content_symlink | content_submodule
	> {
		return __request(OpenAPI, {
			method: 'GET',
...
export class UsersService {
	 ...
	 * @throws ApiError
	 */
	public static usersGetAuthenticated(): CancelablePromise<
		private_user | public_user
	> {
		return __request(OpenAPI, {
			method: 'GET',
			url: '/user',
