import { HistoryService } from '../services/gmail';
import type {
	GmailEventMap,
	GmailEventName,
...
export class GmailWebhookHandler {
	...
	private handlers: Map<GmailEventName, GmailEventHandler<GmailEventName>[]> =
		new Map();
	...
	off<T extends GmailEventName>(
		...
		const index = existingHandlers.indexOf(
			handler as GmailEventHandler<GmailEventName>,
		);
		if (index !== -1) {
...
export function createWebhookHandler(
	options?: GmailWebhookHandlerOptions,
): GmailWebhookHandler {
