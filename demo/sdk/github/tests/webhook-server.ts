...
function saveWebhookPayload(eventType: string, deliveryId: string, payload: object) {
...
handler.on('pull_request', (event) => {
  ...
  console.log(`Base: ${event.pull_request.base.ref} ← Head: ${event.pull_request.head.ref}`);
...
app.listen(PORT, () => {
  ...
  console.log(`Secret configured: ${WEBHOOK_SECRET ? 'Yes' : 'No (signature verification disabled)'}`);
  console.log('');
