...
function saveWebhookPayload(eventType: string, eventId: string, payload: object) {
...
app.listen(PORT, () => {
  ...
  console.log(`Secret configured: ${SLACK_SIGNING_SECRET ? 'Yes' : 'No (signature verification disabled)'}`);
  console.log('');
