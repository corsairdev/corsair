...
export const ConversationsArchiveArgsSchema = z
	.object({
		channel: z.string(),
	})
	.merge(TokenOverridableSchema);
export type ConversationsArchiveArgs = z.infer<
	typeof ConversationsArchiveArgsSchema
>;

export const ConversationsCloseArgsSchema = z
	.object({
		channel: z.string(),
	})
	.merge(TokenOverridableSchema);
export type ConversationsCloseArgs = z.infer<
	typeof ConversationsCloseArgsSchema
>;

export const ConversationsCreateArgsSchema = z
	.object({
		name: z.string(),
	...
	.merge(TokenOverridableSchema);
export type ConversationsCreateArgs = z.infer<
	typeof ConversationsCreateArgsSchema
>;

export const ConversationsInfoArgsSchema = z
	.object({
		channel: z.string(),
...
export const ConversationsListArgsSchema = z
	.object({
...
export const ConversationsHistoryArgsSchema = z
	.object({
		channel: z.string(),
	...
	.merge(TokenOverridableSchema)
	.merge(CursorPaginationSchema);
export type ConversationsHistoryArgs = z.infer<
	typeof ConversationsHistoryArgsSchema
>;

export const ConversationsInviteArgsSchema = z
	.object({
		channel: z.string(),
		users: z.string(),
	...
	.merge(TokenOverridableSchema);
export type ConversationsInviteArgs = z.infer<
	typeof ConversationsInviteArgsSchema
>;

export const ConversationsJoinArgsSchema = z
	.object({
		channel: z.string(),
	})
	.merge(TokenOverridableSchema);
...
export const ConversationsKickArgsSchema = z
	.object({
		channel: z.string(),
		user: z.string(),
	})
...
export const ConversationsLeaveArgsSchema = z
	.object({
		channel: z.string(),
	})
	.merge(TokenOverridableSchema);
export type ConversationsLeaveArgs = z.infer<
	typeof ConversationsLeaveArgsSchema
>;

export const ConversationsMembersArgsSchema = z
	.object({
		channel: z.string(),
	})
	.merge(TokenOverridableSchema)
	.merge(CursorPaginationSchema);
export type ConversationsMembersArgs = z.infer<
	typeof ConversationsMembersArgsSchema
>;

export const ConversationsOpenArgsSchema = z
	.object({
...
export const ConversationsRenameArgsSchema = z
	.object({
		channel: z.string(),
		name: z.string(),
	})
	.merge(TokenOverridableSchema);
export type ConversationsRenameArgs = z.infer<
	typeof ConversationsRenameArgsSchema
>;

export const ConversationsRepliesArgsSchema = z
	.object({
		channel: z.string(),
		ts: z.string(),
		latest: z.string().optional(),
	...
	.merge(TokenOverridableSchema)
	.merge(CursorPaginationSchema);
export type ConversationsRepliesArgs = z.infer<
	typeof ConversationsRepliesArgsSchema
>;

export const ConversationsSetPurposeArgsSchema = z
	.object({
		channel: z.string(),
		purpose: z.string(),
	})
	.merge(TokenOverridableSchema);
export type ConversationsSetPurposeArgs = z.infer<
	typeof ConversationsSetPurposeArgsSchema
>;

export const ConversationsSetTopicArgsSchema = z
	.object({
		channel: z.string(),
		topic: z.string(),
	})
	.merge(TokenOverridableSchema);
export type ConversationsSetTopicArgs = z.infer<
	typeof ConversationsSetTopicArgsSchema
>;

export const ConversationsUnarchiveArgsSchema = z
	.object({
		channel: z.string(),
	})
	.merge(TokenOverridableSchema);
export type ConversationsUnarchiveArgs = z.infer<
	typeof ConversationsUnarchiveArgsSchema
>;

export const UsersInfoArgsSchema = z
	.object({
		user: z.string(),
		include_locale: z.boolean().optional(),
	})
...
export const UsersListArgsSchema = z
	.object({
		include_locale: z.boolean().optional(),
		team_id: z.string().optional(),
	})
...
export const UsersProfileGetArgsSchema = z
	.object({
...
export const UsersGetPresenceArgsSchema = z
	.object({
		user: z.string().optional(),
	})
	.merge(TokenOverridableSchema);
...
export const UsersProfileSetArgsSchema = z
	.object({
...
export const UsergroupsCreateArgsSchema = z
	.object({
		name: z.string(),
...
export const UsergroupsDisableArgsSchema = z
	.object({
		usergroup: z.string(),
		include_count: z.boolean().optional(),
		team_id: z.string().optional(),
...
export const UsergroupsEnableArgsSchema = z
	.object({
		usergroup: z.string(),
		include_count: z.boolean().optional(),
		team_id: z.string().optional(),
...
export const UsergroupsListArgsSchema = z
	.object({
		include_count: z.boolean().optional(),
...
export const UsergroupsUpdateArgsSchema = z
	.object({
		usergroup: z.string(),
		name: z.string().optional(),
		channels: z.string().optional(),
...
export const FilesInfoArgsSchema = z
	.object({
		file: z.string(),
	})
	.merge(TokenOverridableSchema)
	.merge(CursorPaginationSchema)
	.merge(TraditionalPaginationSchema);
export type FilesInfoArgs = z.infer<typeof FilesInfoArgsSchema>;

export const FilesListArgsSchema = z
	.object({
		channel: z.string().optional(),
		user: z.string().optional(),
		types: z.string().optional(),
...
export const FilesUploadArgsSchema = z
	.object({
		channels: z.string().optional(),
...
export const ChatDeleteArgsSchema = z
	.object({
		channel: z.string(),
		ts: z.string(),
...
export const ChatGetPermalinkArgsSchema = z
	.object({
		channel: z.string(),
		message_ts: z.string(),
	})
...
export const SearchMessagesArgsSchema = z
	.object({
		query: z.string(),
...
export const ChatPostMessageArgsSchema = z
	.object({
		channel: z.string(),
		text: z.string().optional(),
...
export const ChatUpdateArgsSchema = z
	.object({
		channel: z.string(),
		ts: z.string(),
		text: z.string().optional(),
...
export const ReactionsAddArgsSchema = z
	.object({
		channel: z.string(),
		timestamp: z.string(),
		name: z.string(),
...
export const ReactionsGetArgsSchema = z
	.object({
		channel: z.string().optional(),
...
export const ReactionsRemoveArgsSchema = z
	.object({
		name: z.string(),
		channel: z.string().optional(),
		timestamp: z.string().optional(),
...
export const StarsAddArgsSchema = z
	.object({
		channel: z.string().optional(),
		timestamp: z.string().optional(),
		file: z.string().optional(),
...
export const StarsRemoveArgsSchema = z
	.object({
		channel: z.string().optional(),
		timestamp: z.string().optional(),
		file: z.string().optional(),
...
export const StarsListArgsSchema = z
	.object({
		team_id: z.string().optional(),
	})
	.merge(TokenOverridableSchema)
...
export type ConversationsArchiveResponse = z.infer<
	typeof ConversationsArchiveResponseSchema
>;
...
export type ConversationsInviteResponse = z.infer<
	typeof ConversationsInviteResponseSchema
>;
...
export type ConversationsLeaveResponse = z.infer<
	typeof ConversationsLeaveResponseSchema
>;
...
export type ConversationsMembersResponse = z.infer<
	typeof ConversationsMembersResponseSchema
>;
...
export type ConversationsOpenResponse = z.infer<
	typeof ConversationsOpenResponseSchema
>;
...
export type ConversationsRenameResponse = z.infer<
	typeof ConversationsRenameResponseSchema
>;
...
export type ConversationsRepliesResponse = z.infer<
	typeof ConversationsRepliesResponseSchema
>;
...
export type ConversationsSetPurposeResponse = z.infer<
	typeof ConversationsSetPurposeResponseSchema
>;
...
export type UsersProfileGetResponse = z.infer<
	typeof UsersProfileGetResponseSchema
>;
...
export type UsersGetPresenceResponse = z.infer<
	typeof UsersGetPresenceResponseSchema
>;
...
export type UsersProfileSetResponse = z.infer<
	typeof UsersProfileSetResponseSchema
>;
...
export type UsergroupsCreateResponse = z.infer<
	typeof UsergroupsCreateResponseSchema
>;
...
export type UsergroupsDisableResponse = z.infer<
	typeof UsergroupsDisableResponseSchema
>;
...
export type UsergroupsEnableResponse = z.infer<
	typeof UsergroupsEnableResponseSchema
>;
...
export type UsergroupsUpdateResponse = z.infer<
	typeof UsergroupsUpdateResponseSchema
>;
...
export type ReactionsRemoveResponse = z.infer<
	typeof ReactionsRemoveResponseSchema
>;
