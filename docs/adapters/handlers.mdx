...
Stays grey? The route isn't reachable at `/api/corsair`. Check the mount path, and on Express and Hono check that `basePath` and the wildcard (`/api/corsair/*`) match the path you mounted.
