...
A tenant has to connect GitHub before the loader has anything to read. That flow is client-side: create the React hook client once and call the hooks from any route or component.
