...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.compositeItems.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.contacts.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.contacts.createPerson({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.contacts.deactivate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.contacts.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.contacts.deletePerson({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.contacts.email({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.contacts.emailStatement({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.contacts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.contacts.getAddress({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.contacts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.creditNotes.addComment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.creditNotes.applyCredits({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.creditNotes.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.creditNotes.email({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.creditNotes.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.creditNotes.getEmailContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.creditNotes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.currencies.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.customerPayments.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.invoices.addAttachment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.invoices.addComment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.invoices.bulkEmail({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.invoices.bulkExport({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.invoices.bulkPrint({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.invoices.cancelWriteOff({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.invoices.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.invoices.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.invoices.deleteAttachment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.invoices.deleteComment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.invoices.disablePaymentReminder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.invoices.email({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.invoices.enablePaymentReminder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.invoices.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.invoices.listPayments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.itemGroups.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.itemGroups.deactivate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.itemGroups.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.itemGroups.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.items.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.items.deactivate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.items.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.items.deleteImage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.items.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.organizations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.packages.bulkPrint({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.packages.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.packages.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.purchaseOrders.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.purchaseOrders.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.salesOrders.bulkDelete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.salesOrders.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.salesOrders.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.salesOrders.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.salesOrders.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohoinventory.api.users.getCurrent({});
```
