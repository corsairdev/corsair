...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.drafts.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.drafts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.drafts.publish({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.drafts.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.feed.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.images.createUploadURL({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.pages.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.pages.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.posts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.posts.getBySlug({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.posts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.posts.publish({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.posts.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.posts.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.publications.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.publications.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.series.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.series.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.tags.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hashnode.api.users.get({});
```
