...
```ts
const tenant = corsair.withTenant('acme');
await tenant.marketstack.api.dividends.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.marketstack.api.eod.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.marketstack.api.exchanges.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.marketstack.api.exchanges.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.marketstack.api.splits.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.marketstack.api.tickers.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.marketstack.api.tickers.getEod({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.marketstack.api.tickers.getEodLatest({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.marketstack.api.tickers.list({});
```
