...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.comments.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.comments.getMany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.comments.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.labels.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.labels.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.labels.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.labels.getMany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.labels.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.projects.archive({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.projects.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.projects.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.projects.getCollaborators({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.projects.getMany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.projects.unarchive({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.projects.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.reminders.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.reminders.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.reminders.getMany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.reminders.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.sections.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.sections.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.sections.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.sections.getMany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.sections.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.tasks.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.tasks.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.tasks.getMany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.tasks.reopen({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.todoist.api.tasks.update({});
```
