...
```ts
const tenant = corsair.withTenant('acme');
await tenant.browseai.api.monitors.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.browseai.api.robots.bulkRun({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.browseai.api.robots.run({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.browseai.api.system.getStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.browseai.api.tasks.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.browseai.api.tasks.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.browseai.api.webhooks.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.browseai.api.webhooks.list({});
```
