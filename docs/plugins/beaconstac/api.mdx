...
await tenant.beaconstac.api.analytics.periodOverview({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.analytics.productOverview({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.bulkQrcodes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.organizations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.places.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.places.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.places.update({});
```
...
Delete a QR Code by ID [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.qrcodes.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.qrcodes.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.qrcodes.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.qrTemplates.create({});
```
...
Delete a QR Code template by ID [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.qrTemplates.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.qrTemplates.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.tags.create({});
```
...
Delete a tag by ID [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.tags.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.tags.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.tags.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.users.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.users.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.users.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.beaconstac.api.users.update({});
```
