...
await tenant.zoom.api.archiveFiles.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zoom.api.devices.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zoom.api.meetings.addRegistrant({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zoom.api.meetings.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zoom.api.meetings.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zoom.api.meetings.getSummary({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zoom.api.meetings.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zoom.api.participants.getPastMeeting({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zoom.api.recordings.deleteMeeting({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zoom.api.recordings.getMeeting({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zoom.api.recordings.listAll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zoom.api.reports.dailyUsage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zoom.api.webinars.addRegistrant({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zoom.api.webinars.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zoom.api.webinars.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zoom.api.webinars.listParticipants({});
```
