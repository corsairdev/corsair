...
```ts
const tenant = corsair.withTenant('acme');
await tenant.notion.api.databasePages.getDatabasePage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.notion.api.databasePages.getManyDatabasePages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.notion.api.databasePages.updateDatabasePage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.notion.api.databases.getDatabase({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.notion.api.databases.getManyDatabases({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.notion.api.databases.searchDatabase({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.notion.api.pages.archivePage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.notion.api.users.getManyUsers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.notion.api.users.getUser({});
```
