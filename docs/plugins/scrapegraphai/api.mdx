...
await tenant.scrapegraphai.api.account.credits({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.account.usageTimeline({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.account.validateApiKey({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.agenticScraper.getLiveSessionUrl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.agenticScraper.history({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.endpoint.getSuggestions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.endpoint.save({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.feedback.submit({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.feedback.submitProduct({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.markdownify.history({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.markdownify.start({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.markdownify.status({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.scheduledJobs.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.schema.generate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.scrape.history({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.searchScraper.history({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.searchScraper.start({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.searchScraper.status({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.sitemap.history({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.smartCrawler.history({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.smartCrawler.start({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.smartCrawler.status({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.smartCrawler.webhookLogs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.smartScraper.history({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.smartScraper.start({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.smartScraper.status({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scrapegraphai.api.utilities.toonify({});
```
