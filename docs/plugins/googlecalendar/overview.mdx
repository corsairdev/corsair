---
title: Overview
description: "Google Calendar plugin for Corsair — events, availability, calendars, and event change webhooks."
---
...
await tenant.googlecalendar.api.calendar.getAvailability({ timeMin: '2026-01-01T00:00:00Z', timeMax: '2026-01-07T23:59:59Z' });
```
