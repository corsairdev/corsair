---
title: API
description: "API reference for Bitbucket Cloud OAuth 2.0: every `bitbucket.api.*` operation with input and output types."
---
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.createRepositoriesCommits2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.deleteCommitComment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.deleteRepositoriesCommitReportsAnnotations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.getCommitChanges({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.getCommitComment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.getCommitDiff({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.getRepositoriesCommit({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.getRepositoriesCommitComments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.getRepositoriesCommitReport({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.getRepositoriesCommitReports({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.getRepositoriesCommitReportsAnnotations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.getRepositoriesCommitStatuses({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.getRepositoriesMergeBase({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.getRepositoryPatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.listCommits({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.listCommitsFromRevision({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.listCommitsOnMaster({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.updateInsightsProjectsReposCommitsReports({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.updateRepositoriesCommitComments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.commitsAndInsights.updateRepositoriesCommitReportsAnnotations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.issues.createIssue({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.issues.createIssueComment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.issues.deleteIssue({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.issues.getRepositoriesIssuesVote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.issues.listIssues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.issues.listVersions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.issues.updateIssue({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.createTeamsPipelinesConfigVariables({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.createUsersPipelinesConfigVariables({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.deleteUserPipelineVariable({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.getDeploymentEnvironmentVariables({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.getOpenidConfiguration({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.getRepositoriesEnvironments2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.getRepositoriesPipelines2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.getRepositoriesPipelinesConfigCaches({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.getRepositoriesPipelinesConfigRunners({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.getRepositoriesPipelinesConfigSchedules({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.getRepositoriesPipelinesConfigSshKnownHosts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.getRepositoriesPipelinesConfigVariables({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.getRepositoriesPipelinesSteps({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.listDeployments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.listPipelines({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.listRepositoriesEnvironments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.updateTeamsPipelinesConfigVariables({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pipelinesAndDeployments.updateUsersPipelinesConfigVariables({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pullRequests.approvePullRequest({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pullRequests.createPullRequest({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pullRequests.createPullRequestComment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pullRequests.getPullRequest({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pullRequests.getPullRequestComment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pullRequests.getPullRequestCommits({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pullRequests.getPullRequestDiff({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pullRequests.getPullRequestDiffstat({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pullRequests.getRepositoriesPullrequestsActivity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pullRequests.getRepositoriesPullrequestsComments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pullRequests.getRepositoriesPullrequestsStatuses({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pullRequests.listPullRequests({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pullRequests.listPullRequestTasks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.pullRequests.requestPullRequestChanges({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.repositories.createRepository({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.repositories.deleteRepository({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.repositories.getRepositoriesWatchers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.repositories.getRepository({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.repositories.listRepositories({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.repositories.listRepositoriesInWorkspace({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.searchAndDiscovery.getHookEvents({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.searchAndDiscovery.getWorkspacesSearchCode({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.searchAndDiscovery.searchTeamCode({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.searchAndDiscovery.searchUserRepositoriesCode({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.snippets.createSnippetComment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.snippets.deleteSnippetsWatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.snippets.getSnippet({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.snippets.getSnippetsWatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.snippets.listSnippets({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.sourceAndRefs.browseRepositoryPath({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.sourceAndRefs.createBranch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.sourceAndRefs.getBranch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.sourceAndRefs.getFileFromRepository({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.sourceAndRefs.getRawFileContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.sourceAndRefs.getRepositoriesBranchingModel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.sourceAndRefs.getRepositoriesEffectiveBranchingModel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.sourceAndRefs.getRepositoriesFilehistory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.sourceAndRefs.getRepositoriesRefs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.sourceAndRefs.getRepositoriesRefsTags({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.sourceAndRefs.getRepositoriesSrc({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.sourceAndRefs.listBranches({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.sourceAndRefs.listRepositoryPaths({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.sourceAndRefs.listTags({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.usersAndPermissions.getCurrentUser2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.usersAndPermissions.getSshLatestKeys({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.usersAndPermissions.getUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.usersAndPermissions.getUserEmails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.usersAndPermissions.getUserEmails2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.usersAndPermissions.getUserPermissionsRepositories({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.usersAndPermissions.getUserPermissionsWorkspaces({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.usersAndPermissions.getUserWorkspaces({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.workspacesAndProjects.getProjectsRepos({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.workspacesAndProjects.getWorkspace({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.workspacesAndProjects.getWorkspacesPullrequests({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.workspacesAndProjects.listWorkspaceMembers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.workspacesAndProjects.listWorkspaceProjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitbucket.api.workspacesAndProjects.listWorkspaces({});
```
