---
title: API
description: "API reference for Canvas: every `canvas.api.*` operation with input and output types."
---
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.accounts.createAccountNotification({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.accounts.getAccountGraphQl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.accounts.getAccountNotifications({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.accounts.getAccountsThatUsersCanCreateCoursesIn({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.accounts.getSingleAccount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.appointmentGroups.createAppointmentGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.appointmentGroups.deleteAppointmentGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.assignmentGroups.createAssignmentGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.assignmentGroups.getAnAssignmentGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.assignmentGroups.getAssignmentGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.assignmentOverrides.createAssignmentOverride({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.assignmentOverrides.createBatchOverridesInACourse({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.assignmentOverrides.deleteAssignmentOverride({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.assignmentOverrides.getCourses12Assignments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.assignmentOverrides.getSingleAssignmentOverride({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.assignments.createAssignment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.assignments.createAssignmentGraphQl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.assignments.deleteAssignment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.assignments.editAssignment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.assignments.getAllAssignments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.assignments.getAssignment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.assignments.getAssignment2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.assignments.getSubmissionSummary({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.auditReports.getAuditLogs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.auditReports.getStatusOfLastReport({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.authentication.getAuthenticationProvider({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.blackoutDates.createBlackoutDateForCourse({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.blackoutDates.deleteBlackoutDate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.blueprints.getCoursesBlueprint({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.bookmarks.createBookmark({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.bookmarks.deleteBookmark({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.bookmarks.getBookmark({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.brandConfig.getBrandVariables({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.brandConfig.getInternalSettings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.brandConfig.getKalturaConfig({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.calendarEvents.createCalendarEvent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.calendarEvents.createOrUpdateTimetableEvents({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.calendarEvents.deleteCalendarEvent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.commentBank.deleteCommentBankItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.communicationChannels.createCommunicationChannel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.communicationChannels.deleteCommunicationChannel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.communicationChannels.deleteCommunicationChannelByTypeAndAddress({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.contentExports.exportContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.contentExports.exportGroupContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.contentExports.exportUserContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.contentMigrations.createAContentMigration4({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.contentMigrations.createGroupContentMigration({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.contentMigrations.getAContentMigration3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.contentMigrations.getAContentMigration4({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.contentShares.addUsersToContentShare({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.contentShares.createContentShare({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.contentShares.getContentShare({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.contentShares.getContentSharesUnreadCount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.conversations.addConversationMessage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.conversations.addRecipientsToConversation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.conversations.createConversation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.conversations.createConversationGraphQl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.conversations.deleteConversationMessages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.conversations.deleteConversations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.conversations.editConversation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.conversations.findRecipients({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.conversations.getSingleConversation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.conversations.getUnreadCount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.courseNicknames.clearCourseNicknames({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.courses.addCourseToFavorites({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.courses.createCourse({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.courses.getAccountCourse({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.courses.getCourseLevelParticipationData({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.courses.getCoursePermissions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.courses.getSingleCourse({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.discussions.createDiscussionEntry({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.discussions.createDiscussionEntryGraphQl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.discussions.createDiscussionTopic({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.discussions.createDiscussionTopicGraphQl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.discussions.deleteAnEntry({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.discussions.deleteDiscussionEntry({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.discussions.deleteDiscussionTopicGraphQl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.discussions.getSingleTopic({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.enrollments.addLastAttendedDate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.enrollments.concludeDeactivateOrDeleteEnrollment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.enrollments.createEnrollment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.enrollments.getEnrollmentInvitations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.ePortfolios.getAllEPortfoliosForUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.epubExports.createEpubExport({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.externalFeeds.createExternalFeed({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.externalFeeds.createExternalFeedForGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.externalFeeds.deleteExternalFeedFromGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.externalTools.createExternalTool({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.externalTools.createExternalToolInCourse({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.externalTools.createLtiResourceLink({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.externalTools.deleteAnExternalTool({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.externalTools.getASingleExternalTool2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.externalTools.getSingleExternalTool({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.fetchData.fetchData({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.files.copyFileToFolder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.files.copyFolder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.files.createFiles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.files.createFolder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.files.createFolderInGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.files.deleteFile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.files.deleteFolder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.files.getFolderById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.files.getGroupFolder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.files.getQuotaInformation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.gradebookColumns.createCustomGradebookColumn({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.gradebookColumns.deleteCustomGradebookColumn({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.gradebookColumns.updateCustomGradebookColumnData({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.grading.createCourseGradingStandard({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.grading.deleteCustomGradeStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.grading.getSingleGradingStandardIn2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.graphql.getLegacyNode({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groupCategories.assignUnassignedMembersToGroupCategory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groupCategories.createGroupCategoryCourses({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groupCategories.createGroupInSet({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groupCategories.createGroupSet({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groupDiscussions.createGroupDiscussionTopic({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groupDiscussions.deleteAnEntry2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groupDiscussions.deleteGroupDiscussionTopic({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groupDiscussions.duplicateGroupDiscussionTopic({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groupDiscussions.getFullTopicGroups({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groupDiscussions.getSingleTopic2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groupMemberships.createMembership({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groupMemberships.getASingleGroupMembership({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groupMemberships.getASingleGroupMembership2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groups.addGroupToFavorites({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groups.createGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groups.deleteGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groups.getGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groups.getGroupActivityStreamSummary({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.groups.getGroupPermissions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.latePolicy.getALatePolicy({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.modules.createModule({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.modules.createModuleGraphQl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.modules.createModuleItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.modules.getModuleItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.modules.getModuleItemSequence({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.outcomeGroups.createLinkOutcomeCourses({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.outcomeGroups.createSubgroupCourses({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.outcomeGroups.deleteAnOutcomeGroupCourses({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.outcomeGroups.getAccountsOutcomeGroups({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.outcomeGroups.getAllOutcomeGroupsForContext({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.outcomeGroups.getAllOutcomeGroupsForContext2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.outcomeGroups.getAllOutcomeLinksForContext({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.outcomeGroups.getAllOutcomeLinksForContext2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.outcomeGroups.getGlobalOutcomeGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.outcomeGroups.getRootOutcomeGroupForCourse({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.outcomes.createLearningOutcome({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.outcomes.deleteOutcomeLinks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.outcomes.getAlignedAssignmentsForAnOutcome({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.outcomes.getOutcomeResults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.pages.createPageForCourse({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.pages.createPageForGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.pages.deletePageForGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.pages.getPageForCourse({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.peerReviews.getAllPeerReviews({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.peerReviews.getAllPeerReviewsForSectionAssignment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.peerReviews.getAllPeerReviewsForSectionSubmission({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.planner.createPlannerNote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.planner.createPlannerOverride({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.planner.deletePlannerNote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.planner.deletePlannerOverride({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.polls.createSinglePoll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.polls.createSinglePollChoice({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.polls.createSinglePollSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.polls.createSinglePollSubmission({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.polls.deletePoll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.polls.deletePollChoice({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.polls.deletePollSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.polls.getSinglePoll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.polls.getSinglePollChoice({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.quizReports.abortQuizReportGeneration({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.quizReports.createQuizReport({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.quizReports.getQuizReport({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.quizzes.answerQuizQuestions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.quizzes.createQuestionGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.quizzes.createQuiz({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.quizzes.createQuizQuestion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.quizzes.createQuizSubmission({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.quizzes.deleteQuiz({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.quizzes.editQuiz({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.quizzes.getQuizStatistics({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.quizzes.getSingleQuiz({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.rubrics.createRubric({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.rubrics.getAssignmentRubric({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.rubrics.getRubricAssessmentsReadState({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.rubrics.getRubricsUploadTemplate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.submissions.createSubmissionDraft({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.submissions.deleteSubmissionDraft({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.submissions.getAUsersMostRecentlyGraded({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.userCustomData.createUsersCustomData({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.userCustomData.deleteCustomData({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.userCustomData.deleteUsersCustomDataScope({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.userCustomData.getUsersCustomDataScope({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.userInboxLabels.createUserInboxLabel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.userInboxLabels.deleteUserInboxLabel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.users.editUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.users.getAllUsers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.users.getCurrentUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.users.getCustomColor({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.users.getCustomColors({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.users.getDashboardPositions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.users.getSingleUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.users.getUserAvatars({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.users.getUserProfile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.userTokens.createUsersTokens({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.userTokens.deleteAccessToken({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canvas.api.userTokens.getUsersTokens({});
```
