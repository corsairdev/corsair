...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.agency.getAgencyBrandingById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.agency.getAgentList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.agency.getPricingForUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.agency.retrieveUserMonthlyUsagesAggregation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.agency.updateUserProfile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.assistants.addIntentToAssistant({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.assistants.createIntent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.assistants.createPrompt({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.assistants.deleteAssistantById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.assistants.deletePromptById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.assistants.getAssistantById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.assistants.getIntentById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.assistants.getPromptById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.assistants.readIntentsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.contacts.createContactCustomField({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.contacts.deleteContactsInBulk({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.contacts.getContactById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.contacts.getListOfContacts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.contacts.readCampaignContactList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.contacts.readContactCustomFieldList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.contacts.readContactSyncLogList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.contacts.sendMessagesToContacts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.contacts.upsertContactByEmailOrPhoneNumber({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.datasources.createTag({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.datasources.deleteLinkedAssistantDatasource({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.datasources.deleteLinkTagEntityById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.datasources.deleteTagById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.datasources.getDatasourceById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.datasources.getListOfDatasources({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.datasources.getListOfDataSourcesLinkedToAssistantId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.datasources.readTagList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.forms.createForm({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.forms.deleteBulkFormsByIds({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.forms.deleteFormById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.forms.getCapturedFormByFormId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.providers.createProvider({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.providers.deleteProviderById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.providers.getProviderById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.providers.getSpeechtotextList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.providers.retrieveListOfUserCustomVoice({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.tools.createToolfunction({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.tools.deleteToolById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.tools.deleteToolfunctionById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.tools.readToolFunctionInvokeLogList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.tools.readToolToolfunctionList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.tools.retrieveLinkedToolAndUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.tools.updateLinkToolUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.tools.updateToolById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.tools.updateToolfunctionById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.webhooksTelephony.createWebhook({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.webhooksTelephony.deleteTwilioAuthById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.webhooksTelephony.deleteUserwhatsappById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.webhooksTelephony.deleteWebhookById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.webhooksTelephony.readTwilioAuthList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.webhooksTelephony.retrieveWebhookLog({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.webhooksTelephony.updateTwilioAuthById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.webhooksTelephony.updateUserwhatsappById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.webhooksTelephony.updateWebhookById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.widgets.createWidget({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.widgets.deleteWidgetById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.widgets.getListOfConversations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.widgets.getListOfWidgetsLinkedToAssistantId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.widgets.getWidgetById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.insightoai.api.widgets.listChannels({});
```
