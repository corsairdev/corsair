...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.collaborators.getOnProject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.collaborators.getProjectAccess({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.collaborators.invite({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.collaborators.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.collaborators.listOnProject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.collaborators.listProjectAccesses({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.collaborators.listProjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.collaborators.projectAccessCounts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.collaborators.updatePermissions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.dataDeletions.confirmForProject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.dataDeletions.createForOrganization({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.dataDeletions.createForProject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.dataDeletions.getForOrganization({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.dataDeletions.getForProject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.dataRequests.createForOrganization({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.dataRequests.createForProject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.dataRequests.getForOrganization({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.dataRequests.getForProject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.errors.bulkUpdate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.errors.deleteAll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.errors.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.eventFields.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.eventFields.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.eventFields.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.events.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.events.listForError({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.featureFlags.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.featureFlags.listSummaries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.integrations.configure({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.integrations.deleteConfigured({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.integrations.getConfigured({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.integrations.listConfigured({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.integrations.listSupported({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.integrations.test({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.organizations.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.organizations.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.organizations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.pivots.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.pivots.values({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.projects.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.projects.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.projects.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.projects.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.projects.networkGroupingRuleset({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.projects.regenerateApiKey({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.releases.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.releases.listGroups({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.savedSearches.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.savedSearches.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.savedSearches.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.savedSearches.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.savedSearches.usageSummary({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.teams.addCollaboratorMemberships({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.teams.addMembers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.teams.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.teams.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.teams.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.teams.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bugsnag.api.trends.projectBuckets({});
```
