...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zendesk.api.tickets.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zendesk.api.tickets.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zendesk.api.tickets.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zendesk.api.users.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zendesk.api.users.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zendesk.api.users.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zendesk.api.users.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zendesk.api.users.update({});
```
