...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.clients.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.clients.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.clients.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.contacts.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.contacts.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.contacts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.contacts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.contacts.listForClient({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.contacts.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.estimates.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.estimates.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.estimates.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.estimates.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.estimates.listForClient({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.estimates.listForProject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.estimates.send({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.estimates.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.expenses.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.expenses.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.expenses.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.expenses.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.expenses.listForClient({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.expenses.listForProject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.expenses.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.hours.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.hours.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.hours.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.hours.listForProject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.hours.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.invoices.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.invoices.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.invoices.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.invoices.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.invoices.listForClient({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.invoices.listForProject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.invoices.listForRecurring({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.invoices.send({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.invoices.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.leads.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.leads.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.leads.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.leads.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.leads.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.paymentProfiles.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.paymentProfiles.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.paymentProfiles.listForClient({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.payments.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.payments.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.payments.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.projects.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.projects.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.projects.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.projects.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.projects.listForClient({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.projects.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.recurring.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.recurring.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.recurring.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.recurring.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.recurring.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.staff.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.staff.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.tasks.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.tasks.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.tasks.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.tasks.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.tasks.listForProject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.clientary.api.tasks.update({});
```
