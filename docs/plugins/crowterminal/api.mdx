---
title: API
description: "API reference for CrowTerminal: every `crowterminal.api.*` operation with input and output types."
---
...
await tenant.crowterminal.api.agent.register({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.data.getTypes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.data.ingest({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.data.ingestBulk({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.intelligence.getByokPlatform({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.intelligence.getPlatform({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.memory.compareMd({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.memory.engagementAnalysis({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.memory.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.memory.getBulk({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.memory.getChangelog({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.memory.getPattern({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.memory.validateChanges({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.sandbox.engagementAnalysis({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.sandbox.getClient({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.sandbox.getMemory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.sandbox.validate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.status.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.status.getComponents({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.status.getHistory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.status.getIncidents({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.status.getUptime({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.status.ping({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.webhooks.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.webhooks.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.webhooks.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.webhooks.test({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.crowterminal.api.webhooks.update({});
```
