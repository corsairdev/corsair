...
```ts
const tenant = corsair.withTenant('acme');
await tenant.amplitude.api.charts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.amplitude.api.cohorts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.amplitude.api.cohorts.getMembers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.amplitude.api.cohorts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.amplitude.api.dashboards.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.amplitude.api.dashboards.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.amplitude.api.events.getList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.amplitude.api.events.identifyUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.amplitude.api.events.uploadBatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.amplitude.api.exports.getData({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.amplitude.api.users.getActivity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.amplitude.api.users.getProfile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.amplitude.api.users.search({});
```
