...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sourcegraph.api.repository.getCommitDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sourcegraph.api.repository.getFileContents({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sourcegraph.api.repository.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sourcegraph.api.repository.listFiles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sourcegraph.api.repository.listLanguages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sourcegraph.api.site.checkSettingsEditPermission({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sourcegraph.api.user.getCurrent({});
```
