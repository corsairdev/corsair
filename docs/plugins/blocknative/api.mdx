...
```ts
const tenant = corsair.withTenant('acme');
await tenant.blocknative.api.gas.getDistribution({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.blocknative.api.gas.getOracles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.blocknative.api.gas.getPrices({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.blocknative.api.gas.getSupportedChains({});
```
