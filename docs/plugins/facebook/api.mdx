...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.comments.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.comments.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.comments.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.conversations.getMessages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.conversations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.messages.getDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.messages.markSeen({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.messages.send({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.messages.sendMedia({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.messages.toggleTyping({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.pages.assignTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.pages.getDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.pages.getInsights({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.pages.getRoles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.pages.listManaged({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.pages.removeTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.pages.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.pages.updateSettings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.photos.addToAlbum({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.photos.createAlbum({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.photos.createPost({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.photos.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.photos.upload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.photos.uploadBatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.posts.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.posts.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.posts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.posts.getInsights({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.posts.getReactions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.posts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.posts.listScheduled({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.posts.listTagged({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.posts.publishScheduled({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.posts.reschedule({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.posts.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.reactions.add({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.reactions.unlike({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.users.getCurrentUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.users.getUserPages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.videos.createPost({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.videos.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.facebook.api.videos.upload({});
```
