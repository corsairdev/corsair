...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.companies.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.companies.getMany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.companies.getRecentlyCreated({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.companies.getRecentlyUpdated({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.companies.searchByDomain({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.companies.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.contactLists.addContact({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.contactLists.removeContact({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.contacts.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.contacts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.contacts.getRecentlyCreated({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.contacts.getRecentlyUpdated({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.contacts.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.deals.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.deals.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.deals.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.deals.getMany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.deals.getRecentlyCreated({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.deals.getRecentlyUpdated({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.deals.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.deals.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.engagements.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.engagements.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.engagements.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.engagements.getMany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.tickets.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.tickets.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.tickets.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.tickets.getMany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hubspot.api.tickets.update({});
```
