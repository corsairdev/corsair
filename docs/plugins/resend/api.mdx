...
```ts
await corsair.resend.api.contacts.create({});
```
...
```ts
await corsair.resend.api.contacts.delete({});
```
...
```ts
await corsair.resend.api.contacts.get({});
```
...
```ts
await corsair.resend.api.contacts.list({});
```
...
```ts
await corsair.resend.api.contacts.update({});
```
...
```ts
await corsair.resend.api.emails.batch({});
```
...
```ts
await corsair.resend.api.emails.cancel({});
```
