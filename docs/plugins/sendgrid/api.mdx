---
title: API
description: "API reference for SendGrid v3: every `sendgrid.api.*` operation with input and output types."
---
...
await tenant.sendgrid.api.apiKeys.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.apiKeys.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.apiKeys.getAll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.apiKeys.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.apiKeys.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.asm.addGroupSuppressions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.asm.createGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.asm.deleteGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.asm.deleteGroupSuppression({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.asm.getGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.asm.getGroups({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.asm.getGroupSuppressions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.asm.updateGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.contacts.addOrUpdate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.contacts.export({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.contacts.exportStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.contacts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.contacts.getCount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.contacts.getSample({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.contacts.import({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.contacts.importStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.contacts.listExports({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.contacts.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.contacts.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.contacts.searchEmails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.fields.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.fields.getAll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.fields.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.fields.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.lists.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.lists.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.lists.getAll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.lists.getContactCount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.lists.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.lists.removeContacts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.lists.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.mail.cancelScheduledSend({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.mail.createBatchId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.mail.deleteScheduledSend({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.mail.getScheduledSend({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.mail.listScheduledSends({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.mail.send({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.mail.updateScheduledSend({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.mail.validateBatchId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.segments.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.segments.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.segments.getAll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.segments.refresh({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.segments.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.segments.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.senders.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.senders.createIdentity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.senders.getAll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.senders.getIdentity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.senders.listIdentities({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.senders.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.senders.resend({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.senders.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.stats.getCategory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.stats.getClient({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.stats.getDevice({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.stats.getGeo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.stats.getGlobal({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.stats.getMailboxProvider({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.addGlobalUnsubscribes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.deleteBlock({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.deleteBlocks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.deleteBounce({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.deleteBounces({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.deleteGlobalUnsubscribe({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.deleteInvalidEmail({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.deleteInvalidEmails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.deleteSpamReport({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.deleteSpamReports({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.getBlock({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.getBlocks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.getBounce({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.getBounces({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.getGlobalUnsubscribe({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.getGlobalUnsubscribes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.getInvalidEmail({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.getInvalidEmails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.getSpamReport({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.suppressions.getSpamReports({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.templates.activateVersion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.templates.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.templates.createVersion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.templates.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.templates.getAll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.templates.getVersion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.templates.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.templates.removeVersion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.templates.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.templates.updateVersion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.user.getAccount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.user.getCredits({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.user.getEmail({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.user.getProfile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.user.getScopes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sendgrid.api.user.getUsername({});
```
