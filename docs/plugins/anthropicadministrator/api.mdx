---
title: API
description: "API reference for Anthropic Admin API: every `anthropicadministrator.api.*` operation with input and output types."
---
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.apiKeys.listApiKeys({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.invites.createInvite({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.invites.deleteInvite({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.invites.getInvite({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.invites.listInvites({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.organization.getOrganization({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.users.getUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.users.listUsers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.users.removeUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.users.updateUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.workspaceMembers.createWorkspaceMember({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.workspaceMembers.deleteWorkspaceMember({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.workspaceMembers.getWorkspaceMember({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.workspaceMembers.listWorkspaceMembers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.workspaceMembers.updateWorkspaceMember({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.workspaces.archiveWorkspace({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.workspaces.createWorkspace({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.workspaces.getWorkspace({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.workspaces.listWorkspaces({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anthropicadministrator.api.workspaces.updateWorkspace({});
```
