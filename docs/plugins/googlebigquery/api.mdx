...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.analyticsHub.createListing({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.analyticsHub.createQueryTemplate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.analyticsHub.listListings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.analyticsHub.listOrganizationDataExchanges({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.analyticsHub.listQueryTemplates({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.connections.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.connections.listBigQueryConnections({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.connections.listLocationsConnections({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.connections.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.datasets.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.datasets.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.datasets.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.datasets.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.datasets.patch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.datasets.undelete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.datasets.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.iam.createLocationsDatapolicies({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.iam.getConnectionIamPolicy({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.iam.getRoutineIamPolicy({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.iam.getServiceAccount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.iam.getTableIamPolicy({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.iam.listLocationsDatapolicies({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.iam.listRowAccessPolicies({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.iam.setRoutineIamPolicy({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.iam.testRoutineIamPermissions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.ml.deleteModel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.ml.getBigqueryModel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.ml.listLocations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.ml.listModels({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.ml.listProjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.ml.patchModel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.queries.cancelJob({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.queries.deleteJobMetadata({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.queries.getJob({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.queries.getQueryResults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.queries.insertAll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.queries.insertJob({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.queries.insertJobWithUpload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.queries.listJobs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.queries.query({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.reservations.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.reservations.createAssignment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.reservations.createCapacityCommitment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.reservations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.reservations.listAssignments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.reservations.listCapacityCommitments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.reservations.listGroups({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.reservations.searchAllAssignments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.routines.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.routines.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.routines.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.routines.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.routines.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.tables.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.tables.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.tables.getSchema({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.tables.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.tables.listTableData({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.tables.patch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlebigquery.api.tables.update({});
```
