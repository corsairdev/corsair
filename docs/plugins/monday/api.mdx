---
title: API
description: "API reference for Monday: every `monday.api.*` operation with input and output types."
---
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.boards.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.boards.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.boards.duplicate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.boards.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.boards.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.columns.changeValue({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.columns.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.columns.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.groups.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.groups.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.groups.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.groups.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.items.archive({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.items.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.items.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.items.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.items.move({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.items.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.updates.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.updates.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.users.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.users.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.webhooks.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.webhooks.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.webhooks.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.monday.api.workspaces.list({});
```
