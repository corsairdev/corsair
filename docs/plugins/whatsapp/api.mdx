...
```ts
const tenant = corsair.withTenant('acme');
await tenant.whatsapp.api.media.getInfo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.whatsapp.api.messages.markRead({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.whatsapp.api.messages.send({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.whatsapp.api.messageTemplates.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.whatsapp.api.messageTemplates.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.whatsapp.api.messageTemplates.getStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.whatsapp.api.messageTemplates.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.whatsapp.api.phoneNumbers.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.whatsapp.api.phoneNumbers.list({});
```
