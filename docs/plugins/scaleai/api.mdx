...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.batches.finalizeBatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.batches.getBatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.batches.getBatchStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.batches.listBatches({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.files.getAssets({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.files.importFile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.files.uploadFile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.projects.getProject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.projects.listProjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.projects.setProjectOntology({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.projects.setProjectParams({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.quality.getQualityLabelers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.studio.addStudioAssignments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.studio.getStudioAssignments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.studio.getStudioBatches({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.studio.removeStudioAssignments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.studio.resetBatchPriorities({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.studio.setBatchPriorities({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.addTaskTags({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.createDocumentTranscriptionTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.createImageAnnotationTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.createLidarAnnotationTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.createLidarSegmentationTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.createNamedEntityRecognitionTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.createSegmentationAnnotationTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.createTextCollectionTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.createVideoAnnotationTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.createVideoPlaybackAnnotationTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.deleteTaskTags({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.deleteTaskUniqueId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.getTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.getTaskResponseUrl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.listTasks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.sendTaskCallback({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.setTaskMetadata({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.tasks.updateTaskUniqueId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.teams.getTeams({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.scaleai.api.teams.inviteTeamMember({});
```
