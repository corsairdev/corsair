...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.albums.getNewReleases({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.albums.getTracks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.albums.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.artists.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.artists.getAlbums({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.artists.getRelatedArtists({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.artists.getTopTracks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.artists.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.library.getLikedTracks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.myData.getFollowedArtists({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.player.getCurrentlyPlaying({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.player.getRecentlyPlayed({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.player.pause({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.player.setVolume({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.player.skipToNext({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.player.skipToPrevious({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.player.startPlayback({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.playlists.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.playlists.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.playlists.getTracks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.playlists.getUserPlaylists({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.playlists.removeItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.playlists.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.tracks.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.tracks.getAudioFeatures({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.spotify.api.tracks.search({});
```
