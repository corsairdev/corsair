...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitwarden.api.collections.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitwarden.api.members.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitwarden.api.members.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitwarden.api.organizations.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bitwarden.api.organizations.list({});
```
