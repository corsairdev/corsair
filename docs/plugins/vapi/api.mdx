...
await tenant.vapi.api.assistants.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.assistants.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.assistants.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.assistants.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.assistants.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.calls.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.calls.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.calls.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.calls.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.calls.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.files.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.files.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.files.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.files.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.knowledgeBases.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.knowledgeBases.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.knowledgeBases.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.knowledgeBases.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.knowledgeBases.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.phoneNumbers.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.phoneNumbers.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.phoneNumbers.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.phoneNumbers.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.phoneNumbers.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.squads.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.squads.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.squads.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.squads.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.squads.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.tools.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.tools.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.tools.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.tools.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vapi.api.tools.update({});
```
