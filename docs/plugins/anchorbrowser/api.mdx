...
await tenant.anchorbrowser.api.agent.listAgentResources({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.agent.pauseAgent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.agent.resumeAgent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.agent.uploadFile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.batchSessions.getBatchSessionStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.downloads.listSessionDownloads({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.events.signalEvent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.events.waitForEvent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.extensions.deleteExtension({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.extensions.listExtensions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.extensions.uploadExtension({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.integrations.createIntegration({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.integrations.deleteIntegration({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.integrations.listIntegrations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.osLevel.clickMouse({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.osLevel.copySelectedText({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.osLevel.doubleClickMouse({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.osLevel.dragAndDrop({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.osLevel.getClipboardContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.osLevel.moveMouse({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.osLevel.navigateToUrl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.osLevel.pasteText({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.osLevel.performKeyboardShortcut({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.osLevel.pressMouseButton({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.osLevel.releaseMouseButton({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.osLevel.scrollSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.osLevel.setClipboardContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.osLevel.typeText({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.pages.getSessionPages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.profiles.createProfile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.profiles.deleteProfile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.profiles.getProfile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.profiles.listProfiles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.profiles.updateProfile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.recordings.listSessionRecordings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.recordings.pauseSessionRecording({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.recordings.resumeSessionRecording({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.screenshots.takeScreenshot({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.sessions.endAllSessions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.sessions.endBrowserSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.sessions.getBrowserSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.sessions.listSessions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.sessions.startBrowserSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tasks.createOrUpdateTaskDraft({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tasks.createTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tasks.deleteTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tasks.deleteTaskVersion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tasks.deployTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tasks.getLatestTaskVersion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tasks.getTaskDraft({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tasks.getTaskExecutionResult({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tasks.getTaskMetadata({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tasks.getTaskVersion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tasks.listTaskExecutions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tasks.listTasks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tasks.listTaskVersions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tasks.publishTaskVersion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tasks.runTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tasks.runTaskByName({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tasks.updateTaskMetadata({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tools.getWebpageContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tools.performWebTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.tools.screenshotWebpage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.anchorbrowser.api.uploads.uploadFilesToSession({});
```
