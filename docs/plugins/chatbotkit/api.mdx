...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.blueprints.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.blueprints.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.blueprints.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.bots.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.bots.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.bots.downvote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.bots.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.bots.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.bots.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.bots.upvote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.conversations.complete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.conversations.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.conversations.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.conversations.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.conversations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.conversations.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.datasets.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.datasets.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.datasets.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.datasets.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.datasets.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.datasets.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.files.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.files.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.files.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.files.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.secrets.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.secrets.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.secrets.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.secrets.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.secrets.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.skillsets.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.skillsets.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.skillsets.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.skillsets.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.skillsets.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.tasks.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.tasks.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.tasks.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.tasks.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.chatbotkit.api.tasks.update({});
```
