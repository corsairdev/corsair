...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.connect.getConnectIntegrations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.couriers.getCourierAccounts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.couriers.getCourierFields({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.couriers.getCourierPackagesStatusHistory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.couriers.getCouriersList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.couriers.getOrderPackages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.couriers.getPackageDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.couriers.getProtocol({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.couriers.getRequestParcelPickupFields({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.couriers.runRequestParcelPickup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.documents.addInvoice({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.documents.addInvoiceCorrection({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.documents.getInvoiceFile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.documents.getInvoices({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.documents.getNewReceipts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.documents.getReceipts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.documents.getSeries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.documents.setOrderReceipt({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.externalStorages.addCategory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.externalStorages.getExternalStorageProductsQuantity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.externalStorages.getExternalStoragesList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.externalStorages.getStoragesList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.addInventory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.addInventoryCategory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.addInventoryManufacturer({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.addInventoryPayer({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.addInventoryPriceGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.addInventoryProduct({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.addInventorySupplier({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.addInventoryWarehouse({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.deleteInventory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.deleteInventoryCategory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.deleteInventoryManufacturer({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.deleteInventoryPayer({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.deleteInventoryPriceGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.deleteInventoryProduct({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.deleteInventoryWarehouse({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.getInventories({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.getInventoryAvailableTextFieldKeys({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.getInventoryCategories({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.getInventoryExtraFields({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.getInventoryIntegrations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.getInventoryManufacturers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.getInventoryPayers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.getInventoryPriceGroups({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.getInventoryPrintoutTemplates({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.getInventoryProductLogs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.getInventoryProductsData({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.getInventoryProductsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.getInventoryProductsPrices({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.getInventoryProductsStock({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.getInventorySuppliers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.getInventoryTags({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.getInventoryWarehouses({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.runProductMacroTrigger({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventory.updateInventoryProductsStock({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventoryDocuments.addInventoryDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventoryDocuments.getInventoryDocumentItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventoryDocuments.getInventoryDocuments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.inventoryDocuments.getInventoryDocumentSeries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.addOrder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.addOrderBySplit({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.addOrderDuplicate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.deleteOrderProduct({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.deleteOrders({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.getJournalList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.getOrderExtraFields({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.getOrderPaymentsHistory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.getOrderPickPackHistory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.getOrderPrintoutTemplates({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.getOrders({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.getOrdersByPhone({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.getOrderSources({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.getOrderStatusList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.getOrderTransactionData({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.getPickPackCarts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.runOrderMacroTrigger({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.setOrderFields({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.setOrderPayment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.setOrderProductFields({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.setOrdersMerge({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.setOrderStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.orders.setOrderStatuses({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.purchaseOrders.addInventoryPurchaseOrder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.purchaseOrders.addInventoryPurchaseOrderItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.purchaseOrders.getInventoryPurchaseOrderItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.purchaseOrders.getInventoryPurchaseOrders({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.purchaseOrders.getInventoryPurchaseOrderSeries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.purchaseOrders.setInventoryPurchaseOrderStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.returns.addOrderReturn({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.returns.addOrderReturnProduct({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.returns.deleteOrderReturnProduct({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.returns.getOrderReturnExtraFields({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.returns.getOrderReturnJournalList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.returns.getOrderReturnPaymentsHistory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.returns.getOrderReturnProductStatuses({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.returns.getOrderReturnReasonsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.returns.getOrderReturns({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.returns.getOrderReturnStatusList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.returns.setOrderReturnFields({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.returns.setOrderReturnProductFields({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.returns.setOrderReturnRefund({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.returns.setOrderReturnStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.baselinker.api.returns.setOrderReturnStatuses({});
```
