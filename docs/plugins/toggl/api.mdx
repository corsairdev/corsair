---
title: API
description: "API reference for Toggl: every `toggl.api.*` operation with input and output types."
---
...
await tenant.toggl.api.clients.archive({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.clients.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.clients.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.clients.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.clients.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.clients.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.me.disableProductEmails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.me.disableWeeklyReport({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.me.getClients({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.me.getLocation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.me.getLogged({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.me.getPreferences({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.me.getProjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.me.getQuota({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.me.getTags({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.me.getTasks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.me.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.me.updatePreferences({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.organizations.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.organizations.createGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.organizations.createInvitation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.organizations.deleteGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.organizations.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.organizations.getGroups({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.organizations.getPlans({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.organizations.getSubscriptionPlans({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.organizations.getUsers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.organizations.getWorkspaces({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.organizations.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.projects.addUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.projects.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.projects.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.projects.deleteGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.projects.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.projects.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.projects.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.reference.getCountries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.reference.getCountrySubdivisions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.reference.getCurrencies({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.reference.getKeys({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.reference.getTimezoneOffsets({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.reference.getTimezones({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.smail.sendContact({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.smail.sendDemo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.smail.sendMeet({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.tags.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.tags.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.tags.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.tags.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.tasks.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.tasks.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.tasks.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.tasks.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.tasks.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.timeEntries.bulkEdit({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.timeEntries.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.timeEntries.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.timeEntries.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.timeEntries.getCurrent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.timeEntries.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.timeEntries.stop({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.timeEntries.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.webhooks.deleteSubscription({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.webhooks.getEventFilters({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.webhooks.getStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.webhooks.listSubscriptions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.workspaces.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.workspaces.getLogo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.workspaces.getPreferences({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.workspaces.getUsers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.workspaces.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.toggl.api.workspaces.update({});
```
