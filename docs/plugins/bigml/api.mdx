...
await tenant.bigml.api.anomalies.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.anomalyScores.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.associations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.associationSets.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.batchAnomalyScores.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.batchCentroids.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.batchPredictions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.batchProjections.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.batchTopicDistributions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.centroids.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.clusters.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.composites.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.configurations.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.configurations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.correlations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.datasets.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.deepnets.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.ensembles.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.evaluations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.executions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.externalConnectors.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.externalConnectors.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.forecasts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.fusions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.libraries.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.linearRegressions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.logisticRegressions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.models.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.optimls.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.pcas.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.predictions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.projections.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.projects.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.projects.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.projects.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.projects.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.samples.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.scripts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.sources.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.sources.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.sources.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.statisticalTests.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.timeSeries.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.topicDistributions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigml.api.topicModels.list({});
```
