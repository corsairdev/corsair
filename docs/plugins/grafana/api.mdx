...
```ts
const tenant = corsair.withTenant('acme');
await tenant.grafana.api.health.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.grafana.api.jwks.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.grafana.api.ring.getDistributorHaTracker({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.grafana.api.ring.getIndexGateway({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.grafana.api.ring.getOverridesExporter({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.grafana.api.ring.getRuler({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.grafana.api.saml.postAcs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.grafana.api.status.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.grafana.api.storeGateway.getTenants({});
```
