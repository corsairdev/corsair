...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vercel.api.deployments.createDeployment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vercel.api.deployments.getDeployment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vercel.api.deployments.getDeployments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vercel.api.domains.getDomains({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vercel.api.domains.getProjectDomains({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vercel.api.envs.createEnvVariable({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vercel.api.envs.getEnvVariables({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vercel.api.projects.getProject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vercel.api.projects.getProjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vercel.api.teams.getTeams({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vercel.api.webhooks.createWebhook({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.vercel.api.webhooks.getWebhooks({});
```
