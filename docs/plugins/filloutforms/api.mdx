---
title: API
description: "API reference for FilloutForms: every `filloutforms.api.*` operation with input and output types."
---
...
Permanently delete a Zite database [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.databases.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.databases.getById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.fields.create({});
```
...
Permanently delete a Zite field [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.fields.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.fields.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.forms.getFormMetadata({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.forms.getForms({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.oauth.authorize({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.records.create({});
```
...
Permanently delete a Zite record [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.records.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.records.getById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.records.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.records.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.submissions.create({});
```
...
Delete a form submission by ID [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.submissions.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.submissions.getById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.submissions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.tables.create({});
```
...
Permanently delete a Zite table [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.tables.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.tables.update({});
```
...
Invalidate/revoke an OAuth access token [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.token.invalidate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.webhooks.createDatabase({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.webhooks.createForm({});
```
...
Delete a Zite database webhook [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.webhooks.deleteDatabase({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.webhooks.listDatabase({});
```
...
Remove a Fillout form webhook [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.filloutforms.api.webhooks.removeForm({});
```
