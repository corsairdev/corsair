...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.activities.getStreams({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.activities.getZones({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.activities.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.activities.listComments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.activities.listKudoers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.activities.listLaps({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.athletes.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.athletes.getStats({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.athletes.getZones({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.athletes.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.clubs.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.gear.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.routes.exportGpx({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.routes.exportTcx({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.routes.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.routes.getStreams({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.segmentEfforts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.segmentEfforts.getStreams({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.segments.explore({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.segments.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.segments.getStreams({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.segments.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.segments.star({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.uploads.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.strava.api.uploads.get({});
```
