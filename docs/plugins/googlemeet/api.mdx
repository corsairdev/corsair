...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemeet.api.conferenceRecords.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemeet.api.participants.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemeet.api.participants.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemeet.api.participantSessions.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemeet.api.participantSessions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemeet.api.recordings.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemeet.api.recordings.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemeet.api.smartNotes.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemeet.api.smartNotes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemeet.api.spaces.endActiveConference({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemeet.api.spaces.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemeet.api.spaces.patch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemeet.api.transcriptEntries.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemeet.api.transcriptEntries.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemeet.api.transcripts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemeet.api.transcripts.list({});
```
