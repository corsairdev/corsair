...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.client.contactsState({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.client.createDisplay({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.client.createUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.client.environment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.client.identifyUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.contactAttributeKeys.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.contactAttributeKeys.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.contactAttributeKeys.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.contactAttributeKeys.getClass({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.contactAttributeKeys.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.contactAttributeKeys.listClasses({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.contactAttributeKeys.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.contactAttributes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.contacts.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.contacts.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.contacts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.contacts.getPerson({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.contacts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.contacts.listPeople({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.contacts.updateAttributes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.contacts.uploadBulk({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.health.check({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.health.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.me.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.me.getAccountInfo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.me.getManagement({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.responses.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.responses.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.responses.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.responses.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.roles.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.storage.uploadPrivate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.storage.uploadPublic({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.surveys.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.surveys.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.surveys.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.surveys.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.teams.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.teams.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.teams.listWorkspaceTeams({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.webhooks.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.webhooks.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.webhooks.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.webhooks.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.formbricks.api.webhooks.update({});
```
