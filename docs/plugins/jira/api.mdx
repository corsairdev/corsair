...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.comments.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.comments.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.comments.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.groups.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.groups.getAll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.issues.addAttachment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.issues.addWatcher({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.issues.assign({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.issues.bulkFetch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.issues.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.issues.edit({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.issues.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.issues.getTransitions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.issues.linkIssues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.issues.removeWatcher({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.issues.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.issues.transition({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.projects.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.projects.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.projects.getRoles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.projects.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.sprints.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.sprints.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.sprints.listBoards({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.sprints.moveIssues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.users.find({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.users.getAll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.jira.api.users.getCurrent({});
```
