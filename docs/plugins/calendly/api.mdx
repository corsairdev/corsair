...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.activityLog.listOutgoingCommunications({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.eventTypes.createOneOff({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.eventTypes.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.eventTypes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.eventTypes.listAvailableTimes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.eventTypes.listHosts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.eventTypes.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.eventTypes.updateAvailability({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.groups.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.groups.getRelationship({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.groups.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.groups.listRelationships({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.invitees.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.invitees.deleteData({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.invitees.deleteNoShow({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.invitees.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.invitees.getNoShow({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.invitees.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.invitees.markNoShow({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.organizations.deleteMembership({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.organizations.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.organizations.getInvitation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.organizations.getMembership({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.organizations.invite({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.organizations.listInvitations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.organizations.listMemberships({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.organizations.removeMember({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.organizations.revokeInvitation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.routingForms.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.routingForms.getSampleWebhookData({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.routingForms.getSubmission({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.routingForms.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.scheduledEvents.cancel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.scheduledEvents.deleteData({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.scheduledEvents.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.scheduledEvents.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.schedulingLinks.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.schedulingLinks.createShare({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.schedulingLinks.createSingleUse({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.users.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.users.getAvailabilitySchedule({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.users.getCurrent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.users.listAvailabilitySchedules({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.users.listBusyTimes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.users.listEventTypes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.users.listMeetingLocations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.webhookSubscriptions.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.webhookSubscriptions.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.webhookSubscriptions.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.calendly.api.webhookSubscriptions.list({});
```
