---
title: API
description: "API reference for StudioByAI21Labs: every `studiobyai21labs.api.*` operation with input and output types."
---
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.studiobyai21labs.api.library.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.studiobyai21labs.api.library.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.studiobyai21labs.api.library.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.studiobyai21labs.api.library.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.studiobyai21labs.api.library.upload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.studiobyai21labs.api.maestro.createRun({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.studiobyai21labs.api.maestro.retrieveRun({});
```
