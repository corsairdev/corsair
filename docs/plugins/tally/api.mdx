...
await tenant.tally.api.forms.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.forms.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.forms.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.forms.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.forms.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.organizations.cancelInvite({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.organizations.createInvite({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.organizations.listInvites({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.organizations.listUsers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.organizations.removeUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.questions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.submissions.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.submissions.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.submissions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.users.getMe({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.webhookManagement.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.webhookManagement.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.webhookManagement.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.webhookManagement.listEvents({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.webhookManagement.retryEvent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.webhookManagement.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.workspaces.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.workspaces.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.workspaces.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.workspaces.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.tally.api.workspaces.update({});
```
