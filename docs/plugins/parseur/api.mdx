...
await tenant.parseur.api.bootstrap.getBootstrap({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.documents.copyDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.documents.createEmailDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.documents.deleteDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.documents.getDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.documents.getDocumentLogs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.documents.listDocuments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.documents.processDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.documents.skipDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.documents.uploadDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.exportConfigs.createExportConfig({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.exportConfigs.deleteExportConfig({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.exportConfigs.listExportConfigs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.exportConfigs.updateExportConfig({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.mailboxes.copyMailbox({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.mailboxes.createMailbox({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.mailboxes.deleteMailbox({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.mailboxes.getMailbox({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.mailboxes.getMailboxSchema({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.mailboxes.listMailboxes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.mailboxes.updateMailbox({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.templates.copyTemplate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.templates.deleteTemplate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.templates.getTemplate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.templates.listTemplates({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.webhooks.createWebhook({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.webhooks.deleteWebhook({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.webhooks.disableWebhook({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.webhooks.enableWebhook({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.parseur.api.webhooks.listWebhooks({});
```
