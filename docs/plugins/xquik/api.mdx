...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.trends.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.tweets.batch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.tweets.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.tweets.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.tweets.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.tweets.like({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.tweets.retweet({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.tweets.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.tweets.unlike({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.users.batch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.users.follow({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.users.followers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.users.following({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.users.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.users.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.users.tweets({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.users.unfollow({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.webhooks.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.webhooks.deactivate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.webhooks.deliveries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.webhooks.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.webhooks.test({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.webhooks.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.xquik.api.writeActions.get({});
```
