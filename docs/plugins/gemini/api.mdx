...
await tenant.gemini.api.content.countTokens({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gemini.api.content.embedContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gemini.api.content.generateContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gemini.api.images.generateImage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gemini.api.models.listModels({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gemini.api.videos.generateVideos({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gemini.api.videos.getVideosOperation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gemini.api.videos.waitForVideo({});
```
