---
title: API
description: "API reference for GoogleMaps: every `googlemaps.api.*` operation with input and output types."
---
...
await tenant.googlemaps.api.aerial.lookupAerialVideo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.aerial.renderAerialVideo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.geocoding.geocodeAddress({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.geocoding.geocodeAddressWithQuery({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.geocoding.geocodeDestinations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.geocoding.geocodePlace({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.geocoding.geocodingApi({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.geocoding.reverseGeocodeLocation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.geolocation.geolocate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.places.autocomplete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.places.getPlaceDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.places.getPlacePhoto({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.places.nearbySearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.places.textSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.routes.computeRouteMatrix({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.routes.distanceMatrix({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.routes.getDirection({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.routes.getRoute({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.tiles.createTilesSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.tiles.embedMap({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.tiles.get2dTile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlemaps.api.tiles.get3dTilesRoot({});
```
