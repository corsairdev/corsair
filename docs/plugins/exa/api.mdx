...
```ts
const tenant = corsair.withTenant('acme');
await tenant.exa.api.contents.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.exa.api.events.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.exa.api.events.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.exa.api.imports.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.exa.api.imports.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.exa.api.monitors.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.exa.api.search.findSimilar({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.exa.api.search.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.exa.api.webhooksApi.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.exa.api.websets.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.exa.api.websets.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.exa.api.websets.get({});
```
