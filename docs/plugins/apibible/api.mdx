...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.audioBibles.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.audioBooks.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.audioBooks.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.audioChapters.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.audioChapters.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.bibles.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.bibles.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.books.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.books.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.chapters.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.chapters.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.chapters.listSections({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.passages.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.search.query({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.sections.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.sections.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.verses.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apibible.api.verses.list({});
```
