...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brightdata.api.filterDataset({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brightdata.api.getAvailableCountries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brightdata.api.getSnapshotResults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brightdata.api.getSnapshotStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brightdata.api.listDatasets({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brightdata.api.listWebUnlockerZones({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brightdata.api.serpSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brightdata.api.webUnlocker({});
```
