...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.aiClipping.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.aiClipping.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.assets.completeUpload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.assets.createFolder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.assets.createUploadSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.assets.deleteAsset({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.assets.deleteAssetV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.assets.getAsset({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.assets.getTemplate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.assets.listAssets({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.assets.listAssets2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.assets.listFolders({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.assets.listTemplates({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.assets.restoreFolder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.assets.trashFolder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.assets.updateFolder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.assets.uploadAsset({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.assets.uploadAssetV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.audio.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatarRealtime.appendText({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatarRealtime.cancelSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatarRealtime.createSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatarRealtime.getSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.addLooks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.addMotion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.checkLookStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.createConsent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.createPhotoGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.deleteGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.deleteLook({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.deletePhoto({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.deletePhotoGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.deleteTalkingPhoto({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.generatePhotos({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.getDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.getGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.getLook({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.getPhotoDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.getTrainingStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.listGroupAvatars({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.listGroups({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.listLooks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.listTalkingPhotos({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.searchPublicGroups({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.updateLook({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.uploadTalkingPhoto({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.avatars.upscale({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.brand.listGlossaries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.brand.listKits({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.hyperframes.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.hyperframes.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.hyperframes.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.hyperframes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.knowledgeBases.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.knowledgeBases.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.knowledgeBases.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.knowledgeBases.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.lipsync.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.lipsync.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.lipsync.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.lipsync.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.lipsync.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.proofread.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.proofread.downloadSrt({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.proofread.generateVideo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.proofread.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.proofread.uploadSrt({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.streaming.createToken({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.streaming.ice({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.streaming.interrupt({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.streaming.keepAlive({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.streaming.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.streaming.listAvatars({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.streaming.listSessionHistory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.streaming.new({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.streaming.newSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.streaming.start({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.streaming.stop({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.streaming.task({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videoAgents.createSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videoAgents.getResource({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videoAgents.getSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videoAgents.listSessions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videoAgents.listStyles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videoAgents.listVideos({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videoAgents.sendMessage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videoAgents.stopSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videos.createWebm({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videos.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videos.deleteV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videos.generate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videos.getSharableUrl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videos.getStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videos.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videos.listV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videos.personalizedAddContact({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videos.personalizedProjectDetail({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videos.templateGenerate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videos.translate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videos.translateStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videos.translateTargetLanguages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videoTranslations.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videoTranslations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.videoTranslations.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.voices.clone({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.voices.deleteV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.voices.design({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.voices.generatePreview({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.voices.generateSpeech({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.voices.generateSpeechV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.voices.getV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.voices.listBrandVoices({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.voices.listLocales({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.voices.listTts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.voices.listV1({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.voices.listV2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.voices.listV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.webhooksQuota.addEndpoint({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.webhooksQuota.addEndpointV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.webhooksQuota.deleteEndpoint({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.webhooksQuota.deleteEndpointV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.webhooksQuota.getCurrentUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.webhooksQuota.listEndpoints({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.webhooksQuota.listEndpointsV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.webhooksQuota.listEvents({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.webhooksQuota.listEventTypes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.webhooksQuota.listEventTypesV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.webhooksQuota.remainingQuota({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.webhooksQuota.rotateSecret({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.webhooksQuota.updateEndpoint({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.heygen.api.webhooksQuota.updateEndpointV3({});
```
