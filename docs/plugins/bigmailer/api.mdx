...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.brandProperties.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.brandProperties.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.brandProperties.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.brandProperties.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.brands.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.brands.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.brands.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.brands.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.bulkCampaigns.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.bulkCampaigns.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.bulkCampaigns.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.bulkCampaigns.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.connections.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.contacts.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.contacts.createBatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.contacts.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.contacts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.contacts.getBatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.contacts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.contacts.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.contacts.upsert({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.fields.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.fields.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.fields.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.fields.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.fields.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.lists.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.lists.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.lists.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.lists.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.lists.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.messageTypes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.segments.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.segments.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.segments.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.segments.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.segments.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.senders.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.suppressionLists.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.suppressionLists.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.suppressionLists.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.templates.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.templates.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.templates.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.templates.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.templates.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.transactionalCampaigns.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.transactionalCampaigns.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.transactionalCampaigns.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.transactionalCampaigns.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.users.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.users.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.users.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.users.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bigmailer.api.users.update({});
```
