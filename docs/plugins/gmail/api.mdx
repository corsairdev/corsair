...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gmail.api.drafts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gmail.api.drafts.send({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gmail.api.labels.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gmail.api.labels.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gmail.api.labels.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gmail.api.labels.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gmail.api.messages.untrash({});
```
