...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.assistantChat.completion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.assistantChat.context({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.assistantFiles.describe({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.assistantFiles.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.assistantFiles.upload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.assistants.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.assistants.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.assistants.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.assistants.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.assistants.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.backups.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.backups.createIndex({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.backups.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.backups.describe({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.backups.listForIndex({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.backups.listForProject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.bulkImports.cancel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.bulkImports.describe({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.bulkImports.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.bulkImports.start({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.collections.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.indexes.configure({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.indexes.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.indexes.createForModel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.indexes.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.indexes.describe({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.indexes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.inference.embed({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.inference.getModel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.inference.listModels({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.inference.rerank({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.namespaces.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.namespaces.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.namespaces.describe({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.namespaces.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.records.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.records.upsert({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.restoreJobs.describe({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.restoreJobs.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.vectors.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.vectors.describeIndexStats({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.vectors.fetch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.vectors.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.vectors.query({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.vectors.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pinecone.api.vectors.upsert({});
```
