...
```ts
const tenant = corsair.withTenant('acme');
await tenant.browserless.api.function.run({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.browserless.api.pdf.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.browserless.api.scrape.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.browserless.api.screenshot.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.browserless.api.unblock.create({});
```
