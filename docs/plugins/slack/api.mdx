...
await tenant.slack.api.admin.conversationsGetTeams({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.admin.conversationsSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.admin.conversationsSetTeams({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.admin.listTeams({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.channels.archive({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.channels.close({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.channels.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.channels.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.channels.getHistory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.channels.getMembers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.channels.getReplies({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.channels.invite({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.channels.join({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.channels.kick({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.channels.leave({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.channels.open({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.channels.rename({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.channels.setPurpose({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.channels.setTopic({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.channels.unarchive({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.files.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.files.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.files.upload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.messages.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.messages.getPermalink({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.messages.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.messages.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.reactions.add({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.reactions.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.reactions.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.stars.add({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.stars.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.stars.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.userGroups.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.userGroups.disable({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.userGroups.enable({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.userGroups.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.userGroups.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.users.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.users.getPresence({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.users.getProfile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.users.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.slack.api.users.updateProfile({});
```
