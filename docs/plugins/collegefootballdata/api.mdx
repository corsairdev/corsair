---
title: API
description: "API reference for CollegeFootballData: every `collegefootballdata.api.*` operation with input and output types."
---
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.betting.getLines({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.coaches.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.conferences.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.conferences.listDivisions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.conferences.listMemberships({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.draft.listPicks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.draft.listPositions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.draft.listTeams({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.drives.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.games.getAdvancedBoxScore({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.games.getGamesAndResults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.games.getMedia({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.games.getPlayerStats({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.games.getTeamStats({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.metrics.getFieldGoalExpectedPoints({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.metrics.getPregameWinProbabilities({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.metrics.getWinProbability({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.players.getReturningProduction({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.players.getUsage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.players.listTransferPortal({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.players.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.plays.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.plays.listStats({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.plays.listStatTypes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.plays.listTypes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.ppa.getByPlayerGame({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.ppa.getByPlayerSeason({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.ppa.getByTeamGame({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.ppa.getByTeamSeason({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.ppa.getPredictedPoints({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.rankings.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.ratings.getConferenceSP({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.ratings.getElo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.ratings.getFPI({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.ratings.getSP({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.ratings.getSRS({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.recruiting.getGroupRatings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.recruiting.getTeamRankings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.recruiting.getTeamTalent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.recruiting.listRecruits({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.seasonTypes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.stats.getAdvancedGameStats({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.stats.getAdvancedSeasonStats({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.stats.getGameHavocStats({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.stats.getPlayerSeasonStats({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.stats.getTeamSeasonStats({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.stats.listCategories({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.teams.getATSRecords({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.teams.getMatchup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.teams.getRecords({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.teams.getRoster({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.teams.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.teams.listFBS({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.teams.listFCS({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.collegefootballdata.api.venues.list({});
```
