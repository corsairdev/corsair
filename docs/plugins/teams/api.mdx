...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.channels.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.channels.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.channels.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.chats.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.chats.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.chats.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.chats.listMessages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.chats.sendMessage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.members.add({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.members.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.members.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.members.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.messages.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.messages.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.messages.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.messages.listReplies({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.messages.reply({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.messages.send({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.teams.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.teams.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.teams.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.teams.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.teams.api.teams.update({});
```
