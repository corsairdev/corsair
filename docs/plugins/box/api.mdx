...
```ts
const tenant = corsair.withTenant('acme');
await tenant.box.api.files.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.box.api.files.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.box.api.files.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.box.api.files.share({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.box.api.files.upload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.box.api.folders.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.box.api.folders.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.box.api.folders.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.box.api.folders.share({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.box.api.folders.update({});
```
