...
```ts
const tenant = corsair.withTenant('acme');
await tenant.securitytrails.api.account.usage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.securitytrails.api.company.associatedIps({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.securitytrails.api.domain.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.securitytrails.api.domain.ssl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.securitytrails.api.ips.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.securitytrails.api.ips.stats({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.securitytrails.api.projects.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.securitytrails.api.scroll.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.securitytrails.api.sql.query({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.securitytrails.api.sql.scroll({});
```
