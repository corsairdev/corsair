...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.calendar.isPublicHoliday({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.calendar.isWorkingDay({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.calendar.publicHolidays({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.calendar.timezone({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.calendar.workingDays({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.calendar.worldTime({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.economics.gdp({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.economics.incomeTax({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.economics.incomeTaxCalculator({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.economics.inflation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.economics.interestRate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.economics.mortgageCalculator({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.economics.mortgageRate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.economics.population({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.economics.propertyTax({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.economics.salesTax({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.economics.salesTaxCalculator({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.economics.unemployment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.economics.vatRates({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.advice({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.bucketList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.chuckNorris({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.dadJokes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.factOfTheDay({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.facts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.generateSudoku({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.hobbies({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.horoscope({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.jokeOfTheDay({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.jokes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.quoteOfTheDay({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.quotes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.randomQuotes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.riddles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.solveSudoku({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.trivia({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.entertainment.triviaOfTheDay({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.health.caloriesBurned({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.health.cocktails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.health.exercises({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.health.nutrition({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.health.recipes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.internet.dnsRecords({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.internet.domain({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.internet.ipLookup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.internet.mxRecords({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.internet.scrape({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.internet.urlLookup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.internet.userAgent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.internet.webpage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.internet.whois({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.location.airQuality({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.location.cities({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.location.country({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.location.county({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.location.evChargers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.location.geocode({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.location.hospitals({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.location.postalCode({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.location.reverseGeocode({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.location.universities({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.location.weather({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.location.weatherForecast({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.location.zipCode({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.bitcoin({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.commodityPrice({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.convertCurrency({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.cryptoPrice({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.earnings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.earningsCalendar({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.earningsTranscript({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.etf({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.exchangeRate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.insiderTransactions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.marketCap({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.mutualFund({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.secFilings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.sp500({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.stockExchanges({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.stockPrice({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.ticker({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.markets.tickerList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.reference.animals({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.reference.babyNames({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.reference.cats({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.reference.celebrities({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.reference.dayInHistory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.reference.dogs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.reference.historicalEvents({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.reference.historicalFigures({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.reference.planets({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.reference.stars({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.text.dictionary({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.text.embeddings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.text.language({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.text.loremIpsum({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.text.profanityFilter({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.text.randomWord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.text.rhymes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.text.sentiment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.text.similarity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.text.spellCheck({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.text.thesaurus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.transport.aircraft({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.transport.airlines({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.transport.airports({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.transport.cars({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.transport.electricVehicles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.transport.helicopters({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.transport.motorcycles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.transport.vin({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.utility.barcode({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.utility.convertUnit({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.utility.countryFlag({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.utility.emoji({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.utility.logo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.utility.password({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.utility.qrCode({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.utility.randomImage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.utility.randomUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.validation.bin({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.validation.disposableEmail({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.validation.email({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.validation.iban({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.validation.phone({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.validation.routingNumber({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.apininjas.api.validation.swiftCode({});
```
