...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.aws.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.dashboards.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.dashboards.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.dashboards.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.dashboards.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.downtimes.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.downtimes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.events.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.events.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.hosts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.hosts.totals({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.incidents.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.logs.aggregate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.logs.listIndexes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.logs.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.metrics.listActive({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.metrics.query({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.metrics.submit({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.monitors.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.monitors.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.monitors.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.monitors.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.monitors.mute({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.monitors.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.monitors.unmute({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.monitors.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.roles.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.services.listDefinitions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.slos.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.slos.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.spans.aggregate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.spans.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.synthetics.createApiTest({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.synthetics.getApiTest({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.synthetics.listLocations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.synthetics.listTests({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.tags.getHost({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.tags.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.tags.updateHost({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.usage.getSummary({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.users.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.webhooks.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datadog.api.webhooks.get({});
```
