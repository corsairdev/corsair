...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.documents.createBlankDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.documents.createDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.documents.createDocumentMarkdown({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.documents.getDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.documents.getDocumentPlaintext({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.documents.listSpreadsheetCharts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.documents.searchDocuments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.documents.updateDocumentBatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.documents.updateDocumentMarkdown({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.documents.updateDocumentSectionMarkdown({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.documents.updateDocumentStyle({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.documents.updateExistingDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.structure.createFooter({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.structure.createFootnote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.structure.createHeader({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.structure.createNamedRange({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.structure.createParagraphBullets({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.structure.deleteFooter({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.structure.deleteHeader({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.structure.deleteNamedRange({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.structure.deleteParagraphBullets({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.tables.deleteTableColumn({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.tables.deleteTableRow({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.tables.insertTable({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.tables.insertTableColumn({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.tables.unmergeTableCells({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.tables.updateTableRowStyle({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.text.deleteContentRange({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.text.insertInlineImage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.text.insertPageBreak({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.text.insertText({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.text.replaceAllText({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledocs.api.text.replaceImage({});
```
