...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hackernews.api.items.getMaxId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hackernews.api.items.getWithId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hackernews.api.search.getFrontpage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hackernews.api.search.getLatest({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hackernews.api.search.getTodays({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hackernews.api.search.posts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hackernews.api.stories.getAsk({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hackernews.api.stories.getBest({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hackernews.api.stories.getJobs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hackernews.api.stories.getNew({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hackernews.api.stories.getShow({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hackernews.api.stories.getTop({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hackernews.api.users.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.hackernews.api.users.getByUsername({});
```
