...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.assistants.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.assistants.modify({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.assistants.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.audio.createSpeech({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.audio.createTranscription({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.audio.createTranslation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.batches.cancel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.batches.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.batches.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.batches.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.chat.createCompletion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.chatCompletions.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.chatCompletions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.chatCompletions.listMessages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.chatCompletions.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.chatCompletions.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.chatkit.getThread({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.chatkit.listThreadItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.chatkit.listThreads({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.completions.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.containerFiles.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.containerFiles.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.containerFiles.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.containerFiles.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.containerFiles.retrieveContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.containers.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.containers.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.containers.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.containers.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.conversations.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.conversations.createItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.conversations.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.conversations.deleteItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.conversations.getItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.conversations.listItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.conversations.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.embeddings.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.engines.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.engines.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.evalRuns.cancel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.evalRuns.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.evalRuns.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.evalRuns.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.evalRuns.getOutputItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.evalRuns.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.evalRuns.listOutputItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.evals.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.evals.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.evals.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.evals.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.evals.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.files.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.files.downloadContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.files.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.files.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.files.upload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.fineTuning.cancelJob({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.fineTuning.createJob({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.fineTuning.listCheckpoints({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.fineTuning.listEvents({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.fineTuning.listJobs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.fineTuning.retrieveJob({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.graders.run({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.graders.validate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.images.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.images.createEdit({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.images.createVariation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.messages.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.messages.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.messages.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.messages.modify({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.messages.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.models.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.models.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.moderation.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.realtime.createCall({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.realtime.createClientSecret({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.realtime.createSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.realtime.createTranscriptionSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.responses.cancel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.responses.compact({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.responses.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.responses.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.responses.listInputItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.responses.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.runs.cancel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.runs.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.runs.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.runs.modify({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.runs.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.runs.submitToolOutputs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.runSteps.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.runSteps.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.skills.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.skills.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.skills.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.threads.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.threads.createAndRun({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.threads.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.threads.modify({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.threads.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.tokens.countInput({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.uploads.addPart({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.uploads.cancel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.uploads.complete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.uploads.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.vectorStoreFileBatches.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.vectorStoreFileBatches.listFiles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.vectorStoreFileBatches.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.vectorStoreFiles.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.vectorStoreFiles.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.vectorStoreFiles.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.vectorStoreFiles.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.vectorStoreFiles.retrieveContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.vectorStoreFiles.updateAttributes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.vectorStores.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.vectorStores.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.vectorStores.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.vectorStores.modify({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.vectorStores.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.vectorStores.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.videos.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.videos.createRemix({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.videos.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.videos.download({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.videos.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openai.api.videos.retrieve({});
```
