...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ticktick.api.projects.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ticktick.api.projects.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ticktick.api.projects.getData({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ticktick.api.projects.getMany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ticktick.api.projects.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ticktick.api.tasks.complete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ticktick.api.tasks.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ticktick.api.tasks.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ticktick.api.tasks.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ticktick.api.tasks.listAll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ticktick.api.tasks.update({});
```
