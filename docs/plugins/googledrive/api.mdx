...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.files.createFromText({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.files.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.files.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.files.move({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.files.share({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.files.upload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.folders.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.folders.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.folders.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.folders.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.folders.share({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.search.filesAndFolders({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.sharedDrives.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.sharedDrives.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.sharedDrives.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.sharedDrives.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.sharedDrives.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googledrive.api.storage.getQuota({});
```
