...
```ts
const tenant = corsair.withTenant('acme');
await tenant.certifier.api.credentialInteractions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.certifier.api.credentials.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.certifier.api.credentials.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.certifier.api.credentials.send({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.certifier.api.designs.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.certifier.api.emailTemplates.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.certifier.api.groups.list({});
```
