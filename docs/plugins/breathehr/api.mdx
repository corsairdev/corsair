...
await tenant.breathehr.api.absences.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.account.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.benefits.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.bonuses.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.changeRequests.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.companyDocuments.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.companyProjects.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.companyTrainingTypes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.departments.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.departments.listAbsences({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.departments.listBenefits({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.departments.listBonuses({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.departments.listLeaveRequests({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.departments.listSalaries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.divisions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employeeExpenseClaims.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employeeExpenseClaims.update({});
```
...
Delete an employee expense [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employeeExpenses.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employeeExpenses.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employeeExpenses.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employeeJobs.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employees.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employees.createChangeRequest({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employees.createExpense({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employees.createExpenseClaim({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employees.createSickness({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employees.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employees.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employees.listAbsences({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employees.listBenefits({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employees.listBonuses({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employees.listChangeRequests({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employees.listHolidayYears({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employees.listLeaveRequests({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employees.listSalaries({});
```
...
Delete an employee training course [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employeeTrainingCourses.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employeeTrainingCourses.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.employeeTrainingCourses.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.holidayAllowances.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.leaveRequests.approve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.leaveRequests.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.leaveRequests.getCancelling({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.leaveRequests.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.leaveRequests.reject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.locations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.otherLeaveReasons.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.salaries.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.sicknesses.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.sicknesses.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.breathehr.api.workingPatterns.list({});
```
