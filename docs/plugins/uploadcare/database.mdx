...
| `datetime_uploaded` | `date` | equals, before, after, between |
| `datetime_stored` | `date` | equals, before, after, between |
| `datetime_removed` | `date` | equals, before, after, between |
...
| `datetime_created` | `date` | equals, before, after, between |
| `datetime_stored` | `date` | equals, before, after, between |
