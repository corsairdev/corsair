...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.contentTypes.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.contentTypes.createListField({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.contentTypes.getAll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.contentTypes.getById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.contentTypes.getForList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.contentTypes.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.drive.createSharingLink({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.drive.deleteVersion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.drive.getAnalytics({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.drive.listRecentItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.drive.restoreVersion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.drive.updateItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.files.checkIn({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.files.checkOut({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.files.download({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.files.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.files.listInFolder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.files.recycle({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.files.undoCheckout({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.files.upload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.folders.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.folders.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.folders.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.folders.getAll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.folders.listSubfolders({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.folders.rename({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.items.addAttachment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.items.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.items.createByGuid({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.items.createInFolder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.items.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.items.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.items.getAttachmentContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.items.getEtag({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.items.getVersion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.items.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.items.listAttachments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.items.listByGuid({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.items.recycle({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.items.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.lists.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.lists.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.lists.deleteByTitle({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.lists.getByGuid({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.lists.getByTitle({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.lists.getChanges({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.lists.listAll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.lists.listColumns({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.lists.renderDataAsStream({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.lists.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.permissions.addRoleToItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.permissions.addRoleToList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.permissions.breakInheritanceOnItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.permissions.breakInheritanceOnList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.permissions.getRoleDefinitions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.recycleBin.deletePermanent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.recycleBin.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.recycleBin.restore({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.search.query({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.search.suggest({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.social.follow({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.social.getFollowed({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.social.getFollowers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.social.isFollowed({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.users.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.users.ensure({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.users.find({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.users.getCurrent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.users.getEffectivePermissions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.users.getGroupUsers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.users.getGroupUsersById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.users.listGroups({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.users.listSite({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.users.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.web.createSubsite({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.web.getContextInfo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.web.getDriveItemByPath({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.web.getInfo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.web.getSiteCollectionInfo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.web.getSitePage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.web.logEvent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.web.updateSite({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.webhookSubscriptions.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.sharepoint.api.webhookSubscriptions.getAll({});
```
