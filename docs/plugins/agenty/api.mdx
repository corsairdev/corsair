...
```ts
await corsair.agenty.api.agents.agentsDeleteById({});
```
...
```ts
await corsair.agenty.api.agents.agentsGetAll({});
```
...
```ts
await corsair.agenty.api.agents.agentsGetById({});
```
...
```ts
await corsair.agenty.api.agents.agentsUpdateById({});
```
...
```ts
await corsair.agenty.api.agents.copyAgent({});
```
...
```ts
await corsair.agenty.api.agents.transferAgentOwnership({});
```
...
```ts
await corsair.agenty.api.apiKeys.apiKeysControllerCreateApiKeys({});
```
...
```ts
await corsair.agenty.api.apiKeys.apiKeysDeleteById({});
```
...
```ts
await corsair.agenty.api.apiKeys.apiKeysDownload({});
```
...
```ts
await corsair.agenty.api.apiKeys.apiKeysGetAll({});
```
...
```ts
await corsair.agenty.api.apiKeys.apiKeysGetById({});
```
...
```ts
await corsair.agenty.api.apiKeys.apiKeysResetById({});
```
...
```ts
await corsair.agenty.api.apiKeys.apiKeysUpdateById({});
```
...
```ts
await corsair.agenty.api.apiKeys.changeApiKeyStatusById({});
```
...
```ts
await corsair.agenty.api.browser.captureScreenshot({});
```
...
```ts
await corsair.agenty.api.browser.captureScreenshotWithOptions({});
```
...
```ts
await corsair.agenty.api.browser.convertUrlToPdf({});
```
...
```ts
await corsair.agenty.api.browser.convertUrlToPdfWithOptions({});
```
...
```ts
await corsair.agenty.api.browser.extractBrowserStructuredData({});
```
...
```ts
await corsair.agenty.api.browser.extractStructuredData({});
```
...
```ts
await corsair.agenty.api.browser.getBrowserRedirects({});
```
...
```ts
await corsair.agenty.api.browser.getPageContent({});
```
...
```ts
await corsair.agenty.api.browser.getPageContentWithOptions({});
```
...
```ts
await corsair.agenty.api.browser.getRedirectsWithOptions({});
```
...
```ts
await corsair.agenty.api.browser.scrapeWebpageData({});
```
...
```ts
await corsair.agenty.api.connections.connectionsGetAll({});
```
...
```ts
await corsair.agenty.api.dashboard.dashboardGetReportsUsage({});
```
...
```ts
await corsair.agenty.api.inputs.inputsGetByAgentId({});
```
...
```ts
await corsair.agenty.api.inputs.inputsUpdateByAgentId({});
```
...
```ts
await corsair.agenty.api.jobs.downloadAgentResult({});
```
...
```ts
await corsair.agenty.api.jobs.getAgentResult({});
```
...
```ts
await corsair.agenty.api.jobs.getJobResult({});
```
...
```ts
await corsair.agenty.api.jobs.jobsDownload({});
```
...
```ts
await corsair.agenty.api.jobs.jobsDownloadFilesById({});
```
...
```ts
await corsair.agenty.api.jobs.jobsDownloadResultById({});
```
...
```ts
await corsair.agenty.api.jobs.jobsGetAll({});
```
...
```ts
await corsair.agenty.api.jobs.jobsGetById({});
```
...
```ts
await corsair.agenty.api.jobs.jobsGetLogsById({});
```
...
```ts
await corsair.agenty.api.jobs.jobsListFilesById({});
```
...
```ts
await corsair.agenty.api.jobs.jobsStart({});
```
...
```ts
await corsair.agenty.api.jobs.jobsStopById({});
```
...
```ts
await corsair.agenty.api.lists.addListRows({});
```
...
```ts
await corsair.agenty.api.lists.deleteListRow({});
```
...
```ts
await corsair.agenty.api.lists.deleteListRows({});
```
...
```ts
await corsair.agenty.api.lists.downloadListRows({});
```
...
```ts
await corsair.agenty.api.lists.getListById({});
```
...
```ts
await corsair.agenty.api.lists.getListRowById({});
```
...
```ts
await corsair.agenty.api.lists.listsClearRows({});
```
...
```ts
await corsair.agenty.api.lists.listsControllerCreateList({});
```
...
```ts
await corsair.agenty.api.lists.listsDeleteById({});
```
...
```ts
await corsair.agenty.api.lists.listsDownload({});
```
...
```ts
await corsair.agenty.api.lists.listsGetAll({});
```
...
```ts
await corsair.agenty.api.lists.listsGetRowsById({});
```
...
```ts
await corsair.agenty.api.lists.listsUpdateById({});
```
...
```ts
await corsair.agenty.api.lists.listsUploadCsv({});
```
...
```ts
await corsair.agenty.api.lists.updateListRow({});
```
...
```ts
await corsair.agenty.api.projects.deleteProject({});
```
...
```ts
await corsair.agenty.api.projects.getProjectById({});
```
...
```ts
await corsair.agenty.api.projects.projectsAddAgents({});
```
...
```ts
await corsair.agenty.api.projects.projectsControllerCreateProject({});
```
...
```ts
await corsair.agenty.api.projects.projectsGetAll({});
```
...
```ts
await corsair.agenty.api.projects.removeAgentFromProject({});
```
...
```ts
await corsair.agenty.api.projects.updateProject({});
```
...
```ts
await corsair.agenty.api.scheduler.deleteSchedule({});
```
...
```ts
await corsair.agenty.api.scheduler.getSchedule({});
```
...
```ts
await corsair.agenty.api.scheduler.toggleSchedule({});
```
...
```ts
await corsair.agenty.api.scheduler.updateSchedule({});
```
...
```ts
await corsair.agenty.api.users.downloadUsers({});
```
...
```ts
await corsair.agenty.api.users.getAllTeamMembers({});
```
...
```ts
await corsair.agenty.api.users.getUserById({});
```
...
```ts
await corsair.agenty.api.users.updateUserById({});
```
...
```ts
await corsair.agenty.api.workflows.createWorkflow({});
```
...
```ts
await corsair.agenty.api.workflows.deleteWorkflow({});
```
...
```ts
await corsair.agenty.api.workflows.downloadWorkflows({});
```
...
```ts
await corsair.agenty.api.workflows.getWorkflowById({});
```
...
```ts
await corsair.agenty.api.workflows.patchWorkflow({});
```
...
```ts
await corsair.agenty.api.workflows.updateWorkflow({});
```
