...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.comments.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.comments.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.comments.reply({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.comments.send({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.comments.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.conversations.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.conversations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.image.post({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.image.story({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.media.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.media.insights({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.media.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.media.status({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.messages.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.messages.send({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.profile.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.profile.insights({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.publish.publish_media({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.reel.post({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.video.container({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.instagram.api.video.story({});
```
