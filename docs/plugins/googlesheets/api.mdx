...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlesheets.api.sheets.clearSheet({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlesheets.api.sheets.createSheet({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlesheets.api.sheets.deleteRowsOrColumns({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlesheets.api.sheets.deleteSheet({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlesheets.api.sheets.listSheetsInSpreadsheet({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlesheets.api.sheets.updateRow({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlesheets.api.spreadsheets.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlesheets.api.spreadsheets.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.googlesheets.api.spreadsheets.list({});
```
