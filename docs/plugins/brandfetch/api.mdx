...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brandfetch.api.brands.getCompany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brandfetch.api.brands.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brandfetch.api.graphql.getVersion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brandfetch.api.logos.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brandfetch.api.taxonomy.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brandfetch.api.transactions.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brandfetch.api.webhooks.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brandfetch.api.webhooks.listEvents({});
```
