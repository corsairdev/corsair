...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.actions.create({});
```
...
Delete an action in Synthflow AI [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.actions.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.actions.detach({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.actions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.actions.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.assistants.create({});
```
...
Delete a Synthflow AI assistant [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.assistants.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.assistants.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.assistants.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.assistants.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.calls.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.calls.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.calls.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.contacts.create({});
```
...
Delete a contact in Synthflow AI [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.contacts.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.contacts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.contacts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.contacts.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.knowledgeBases.attach({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.knowledgeBases.create({});
```
...
Delete a knowledge base in Synthflow AI [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.knowledgeBases.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.knowledgeBases.detach({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.knowledgeBases.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.knowledgeBases.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.memoryStores.attachToAgent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.memoryStores.create({});
```
...
Delete a memory store in Synthflow AI [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.memoryStores.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.memoryStores.detachFromAgent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.memoryStores.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.memoryStores.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.memoryStores.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.phoneBooks.create({});
```
...
Delete a phone book in Synthflow AI [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.phoneBooks.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.phoneBooks.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.synthflowai.api.voices.list({});
```
