...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.islands.getAvgMinutesPerPlayer({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.islands.getFavorites({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.islands.getMetricsByInterval({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.islands.getMinutesPlayed({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.islands.getPeakCcu({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.islands.getPlays({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.islands.getRecommendations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.islands.getRetention({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.islands.getUniquePlayers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.islands.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.remote.callObjectFunction({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.remote.corsPreflight({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.remote.deletePresetMetadataKey({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.remote.describeObject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.remote.getObjectThumbnail({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.remote.getPreset({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.remote.getPresetMetadata({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.remote.getPresetMetadataKey({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.remote.getPresetProperty({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.remote.initiateSession({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.remote.invokePresetFunction({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.remote.listBlueprintCallableFunctions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.remote.putObjectProperty({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.remote.putPresetMetadataKey({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.remote.updatePresetProperty({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.epicgames.api.remote.waitForObjectEvent({});
```
