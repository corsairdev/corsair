...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.assets.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.assetUploads.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.assetUploads.createFromUrl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.assetUploads.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.assetUploads.getFromUrl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.autofills.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.autofills.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.brandTemplates.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.brandTemplates.getDataset({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.brandTemplates.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.comments.createReply({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.comments.createThread({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.comments.getReply({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.comments.getThread({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.comments.listReplies({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.designs.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.designs.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.designs.getExportFormats({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.designs.getPages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.designs.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.exports.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.exports.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.folders.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.folders.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.folders.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.folders.listItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.folders.moveItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.folders.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.imports.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.imports.createFromUrl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.imports.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.imports.getFromUrl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.resizes.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.resizes.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.users.getCapabilities({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.users.getMe({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.canva.api.users.getProfile({});
```
