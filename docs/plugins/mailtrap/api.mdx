...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.account.getPermissionResources({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.account.listAccounts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contactFields.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contactFields.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contactFields.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contactFields.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contactLists.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contactLists.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contactLists.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contactLists.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contactLists.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contacts.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contacts.createEvent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contacts.createExport({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contacts.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contacts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contacts.getExport({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contacts.getImport({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contacts.import({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.contacts.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.emailTemplates.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.emailTemplates.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.emailTemplates.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.emailTemplates.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.emailTemplates.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.inboxes.clean({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.inboxes.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.inboxes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.inboxes.markAsRead({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.inboxes.resetCredentials({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.inboxes.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.messages.getHtml({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.messages.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.projects.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.projects.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.projects.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.projects.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.sendingDomains.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.sendingDomains.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.sendingDomains.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.sendingDomains.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.stats.byCategories({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.stats.byDate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.stats.byDomains({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.stats.byEsp({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.stats.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailtrap.api.suppressions.list({});
```
