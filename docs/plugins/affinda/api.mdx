...
await tenant.affinda.api.annotations.batchUpdateAnnotations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.annotations.createBatchAnnotations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.annotations.deleteAnnotationsBatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.annotations.getAnnotations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.annotations.updateAnnotation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.apiUsers.createApiUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.apiUsers.getAllApiUsers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.collections.createCollection({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.collections.createDataFieldForCollection({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.collections.deleteCollection({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.collections.getCollection({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.collections.getCollectionFields({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.collections.getCollections({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.collections.getCollectionUsage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.collections.updateCollection({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.collections.updateDataFieldForCollection({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataPointChoices.createDataPointChoice({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataPointChoices.getDataPointChoice({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataPointChoices.listDataPointChoices({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataPointChoices.replaceDataPointChoices({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataPointChoices.updateDataPointChoice({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataPoints.createDataPoint({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataPoints.deleteDataPoint({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataPoints.getDataPoint({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataPoints.listDataPoints({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataPoints.updateDataPoint({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataSources.createDataSource({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataSources.createDataSourceValue({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataSources.deleteDataSource({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataSources.deleteDataSourceValue({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataSources.getDataSource({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataSources.getDataSourceValue({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataSources.getDataSourceValues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataSources.listDataSources({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataSources.replaceDataSourceValues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.dataSources.updateDataSourceValue({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documents.addTagToDocuments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documents.createDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documents.createFromDataDocuments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documents.deleteDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documents.getDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documents.getDocumentRedacted({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documents.getDocuments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documents.removeTagFromDocuments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documents.updateDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documents.updateDocumentData({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documentSplitters.getAllDocumentSplitters({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documentSplitters.getDocumentSplitter({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documentTypes.createDocumentType({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documentTypes.deleteDocumentType({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documentTypes.getDocumentType({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documentTypes.getDocumentTypeJsonSchema({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documentTypes.getDocumentTypePydanticModels({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documentTypes.getDocumentTypes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.documentTypes.updateDocumentType({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.extractors.createExtractor({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.extractors.deleteExtractor({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.extractors.getExtractor({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.extractors.getExtractors({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.extractors.updateExtractor({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.indexes.createIndex({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.indexes.deleteIndex({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.indexes.getIndexDocuments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.indexes.listIndexes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.indexes.updateIndex({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.invitations.createInvitation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.invitations.deleteInvitation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.invitations.getAllInvitations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.invitations.getInvitation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.invitations.updateInvitation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.jobDescriptionSearch.createJobDescriptionSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.jobDescriptionSearch.createJobDescriptionSearchEmbedUrl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.jobDescriptionSearch.getJobDescriptionSearchConfig({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.jobDescriptionSearch.updateJobDescriptionSearchConfig({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.mappings.createMapping({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.mappings.deleteMapping({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.mappings.getMapping({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.mappings.listMappings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.mappings.updateMapping({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.occupationGroups.listOccupationGroups({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.organizationMemberships.getAllOrganizationMemberships({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.organizationMemberships.getOrganizationMembership({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.organizationMemberships.updateOrganizationMembership({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.organizations.createOrganization({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.organizations.deleteOrganization({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.organizations.getOrganization({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.organizations.getOrganizations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.organizations.updateOrganization({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.resthooks.createResthookSubscription({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.resthooks.deleteResthookSubscription({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.resthooks.getResthookSubscription({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.resthooks.getResthookSubscriptions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.resthooks.updateResthookSubscription({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.resumeSearch.createResumeSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.resumeSearch.createResumeSearchEmbedUrl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.resumeSearch.listResumeSearchConfig({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.resumeSearch.listResumeSearchJobTitleSuggestions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.resumeSearch.listResumeSearchSkillSuggestions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.resumeSearch.updateResumeSearchConfig({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.tags.createTag({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.tags.deleteTag({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.tags.getAllTags({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.tags.getTag({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.tags.updateTag({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.validation.splitDocumentPages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.validationResults.createValidationResult({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.validationResults.createValidationResultsBatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.validationResults.deleteValidationResults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.validationResults.getAllValidationResults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.workspaceMemberships.createWorkspaceMembership({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.workspaceMemberships.deleteWorkspaceMembership({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.workspaceMemberships.getAllWorkspaceMemberships({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.workspaceMemberships.getWorkspaceMembership({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.workspaces.createWorkspace({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.workspaces.deleteWorkspace({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.workspaces.getUsageByWorkspace({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.workspaces.getWorkspace({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.workspaces.getWorkspaces({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.affinda.api.workspaces.updateWorkspace({});
```
