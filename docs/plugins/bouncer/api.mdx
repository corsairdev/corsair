...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bouncer.api.email.deleteBatchRequest({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bouncer.api.email.finishBatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bouncer.api.email.getBatchResults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bouncer.api.email.getBatchStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bouncer.api.email.verifyDomain({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bouncer.api.email.verifyEmail({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bouncer.api.toxicity.checkToxicityListJobStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bouncer.api.toxicity.createToxicityListJob({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bouncer.api.toxicity.deleteToxicityListJob({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.bouncer.api.toxicity.getToxicityListResults({});
```
