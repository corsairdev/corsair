...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.competitions.downloadFiles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.competitions.downloadLeaderboard({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.competitions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.competitions.listFiles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.competitions.submit({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.competitions.viewLeaderboard({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.datasets.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.datasets.createVersion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.datasets.download({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.datasets.downloadFile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.datasets.getMetadata({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.datasets.getStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.datasets.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.datasets.listFiles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.kernels.downloadOutput({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.kernels.getStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.kernels.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.kernels.listOutputFiles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.kernels.pull({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.models.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.models.getInstance({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.models.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.kaggle.api.models.listInstanceVersionFiles({});
```
