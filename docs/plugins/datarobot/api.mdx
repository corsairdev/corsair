...
await tenant.datarobot.api.batchPredictions.batchPredictionsCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.batchPredictions.batchPredictionsDelete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.batchPredictions.batchPredictionsFromExistingCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.batchPredictions.batchPredictionsFromJobDefinitionCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.batchPredictions.batchPredictionsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.batchPredictions.batchPredictionsRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.catalogItems.catalogItemsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.catalogItems.catalogItemsRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.credentials.credentialsCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.credentials.credentialsDelete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.credentials.credentialsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.credentials.credentialsRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.customModels.customModelsCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.customModels.customModelsDelete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.customModels.customModelsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.customModels.customModelsRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.customModels.customModelsVersionsCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.customModels.customModelsVersionsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.datasets.datasetsAllFeaturesDetailsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.datasets.datasetsDelete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.datasets.datasetsFeaturelistsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.datasets.datasetsFileList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.datasets.datasetsFromDataSourceCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.datasets.datasetsFromFileCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.datasets.datasetsFromURLCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.datasets.datasetsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.datasets.datasetsPatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.datasets.datasetsProjectsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.datasets.datasetsRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.datasets.datasetsVersionsDelete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.datasets.datasetsVersionsFromFileCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.datasets.datasetsVersionsFromURLCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.datasets.datasetsVersionsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.datasets.datasetsVersionsRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.deployments.deploymentsAccuracyList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.deployments.deploymentsAccuracyOverTimeList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.deployments.deploymentsCapabilitiesList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.deployments.deploymentsDelete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.deployments.deploymentsFeaturesList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.deployments.deploymentsFromLearningModelCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.deployments.deploymentsFromModelPackageCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.deployments.deploymentsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.deployments.deploymentsModelHistoryList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.deployments.deploymentsModelPatchMany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.deployments.deploymentsPatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.deployments.deploymentsPredictionsOverTimeList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.deployments.deploymentsRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.deployments.deploymentsServiceStatsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.deployments.deploymentsSettingsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.deployments.deploymentsSettingsPatchMany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.deployments.deploymentsSharedRolesList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.modelPackages.modelPackagesFeaturesList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.modelPackages.modelPackagesFromLeaderboardCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.modelPackages.modelPackagesList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.modelPackages.modelPackagesRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.predictionServers.predictionServersList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.configureAndStartAutopilot({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsAccessControlList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsAutopilotCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsAutopilotsCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsBlueprintsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsBlueprintsRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsDatetimeModelsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsDelete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsDeploymentReadyModelsCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsFeaturelistsCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsFeaturelistsDelete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsFeaturelistsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsFeaturelistsPatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsFeaturelistsRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsFeaturesList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsFeaturesRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsJobsDelete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsJobsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsJobsRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsModelingFeaturelistsCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsModelingFeaturelistsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsModelsCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsModelsDelete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsModelsFromModelCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsModelsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsModelsRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsPatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsPredictionDatasetsDelete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsPredictionDatasetsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsPredictionDatasetsRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsPredictionsCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsPredictionsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsPredictionsRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsRecommendedModelsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsStatusList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.projectsTrainingPredictionsCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.projects.trainingPredictionsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.status.statusList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.status.statusRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.useCases.useCasesCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.useCases.useCasesDatasetsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.useCases.useCasesDelete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.useCases.useCasesDeploymentsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.useCases.useCasesList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.useCases.useCasesPatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.useCases.useCasesProjectsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.useCases.useCasesRetrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.datarobot.api.version.versionList({});
```
