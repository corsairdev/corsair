...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.boards.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.boards.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.boards.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.cards.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.cards.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.cards.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.cards.move({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.cards.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.checklists.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.checklists.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.checklists.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.labels.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.labels.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.labels.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.labels.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.lists.archive({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.lists.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.lists.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.lists.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.lists.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.members.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.trello.api.members.list({});
```
