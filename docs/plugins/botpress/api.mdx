...
await tenant.botpress.api.account.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.account.getPreference({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.account.setPreference({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.account.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.billing.chargeUnpaidInvoices({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.billing.getUpcomingInvoice({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.billing.listInvoices({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.billing.listUsageHistory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.bots.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.bots.listActionRuns({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.bots.listIssues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.bots.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.chat.createConversation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.chat.listConversations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.chat.sendMessage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.chat.updateWorkflow({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.files.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.files.listTags({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.files.listTagValues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.hub.getDereferencedPluginById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.hub.getIntegration({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.hub.getIntegrationById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.hub.getInterface({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.hub.getInterfaceById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.hub.getPlugin({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.hub.getPluginById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.hub.getPluginCode({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.hub.listIntegrations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.hub.listInterfaces({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.hub.listPlugins({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.integrations.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.integrations.deleteShareableId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.integrations.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.integrations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.integrations.listApiKeys({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.integrations.requestVerification({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.integrations.validateUpdate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.knowledgeBases.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.knowledgeBases.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.plugins.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.tools.getTableRow({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.tools.runVrl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.workspaces.breakDownUsageByBot({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.workspaces.checkHandleAvailability({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.workspaces.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.workspaces.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.workspaces.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.workspaces.getAllQuotaCompletion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.workspaces.getQuota({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.workspaces.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.workspaces.listPublic({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.workspaces.setPreference({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botpress.api.workspaces.update({});
```
