...
```ts
const tenant = corsair.withTenant('acme');
await tenant.connecteam.api.customFieldCategories.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.connecteam.api.customFields.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.connecteam.api.forms.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.connecteam.api.jobs.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.connecteam.api.me.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.connecteam.api.performanceIndicators.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.connecteam.api.policyTypes.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.connecteam.api.publishers.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.connecteam.api.schedulers.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.connecteam.api.smartGroups.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.connecteam.api.taskBoards.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.connecteam.api.users.archive({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.connecteam.api.users.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.connecteam.api.users.get({});
```
