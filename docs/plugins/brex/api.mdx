...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.accounts.getCashPrimary({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.accounts.listCard({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.accounts.listCardStatements({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.accounts.listCash({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.accounts.listCashStatements({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.budgetPrograms.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.budgets.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.budgets.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.budgets.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.budgets.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.cards.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.cards.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.cards.getPan({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.cards.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.cards.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.cards.updateStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.company.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.departments.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.departments.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.departments.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.expenses.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.expenses.getCard({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.expenses.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.expenses.listByBudget({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.expenses.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.fields.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.fields.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.fields.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.fields.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.fields.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.fieldValues.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.fieldValues.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.fieldValues.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.fieldValues.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.fieldValues.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.legalEntities.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.legalEntities.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.locations.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.locations.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.locations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.receipts.match({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.receipts.upload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.referrals.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.referrals.createDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.referrals.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.referrals.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.spendLimits.archive({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.spendLimits.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.spendLimits.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.spendLimits.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.spendLimits.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.spendLimitsV1.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.spendLimitsV1.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.titles.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.titles.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.titles.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.transactions.byAmountRange({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.transactions.byDescription({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.transactions.getById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.transactions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.transfers.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.trips.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.users.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.users.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.users.getLimit({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.users.getMe({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.users.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.users.setLimit({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.users.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.vendors.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.vendors.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.vendors.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.vendors.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.vendors.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.webhookGroups.addMembers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.webhookGroups.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.webhookGroups.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.webhookGroups.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.webhookGroups.listMembers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.webhooks.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.webhooks.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.webhooks.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.webhooks.listSecrets({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.brex.api.webhooks.update({});
```
