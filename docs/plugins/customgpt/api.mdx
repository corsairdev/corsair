...
await tenant.customgpt.api.conversations.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.licenses.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.licenses.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.licenses.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.licenses.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.limits.getUsage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.messages.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.messages.getTrustScore({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.messages.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.messages.submitFeedback({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.messages.verify({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.pages.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.pages.getMetadata({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.pages.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.pages.reindex({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.pages.updateMetadata({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.personas.activate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.personas.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.projects.clone({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.projects.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.projects.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.projects.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.projects.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.projects.plugins({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.projects.stats({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.projects.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.reports.exportLeads({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.reports.getAnalysis({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.reports.getConversations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.reports.getIntelligence({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.reports.getTraffic({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.settings.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.settings.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.sources.add({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.sources.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.sources.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.sources.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.user.getProfile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.user.searchTeamMembers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.customgpt.api.user.updateProfile({});
```
