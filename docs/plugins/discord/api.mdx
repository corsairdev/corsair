...
```ts
const tenant = corsair.withTenant('acme');
await tenant.discord.api.guilds.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.discord.api.guilds.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.discord.api.members.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.discord.api.members.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.discord.api.messages.edit({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.discord.api.messages.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.discord.api.messages.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.discord.api.messages.reply({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.discord.api.reactions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.discord.api.reactions.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.discord.api.threads.create({});
```
