---
title: API
description: "API reference for Attio: every `attio.api.*` operation with input and output types."
---
...
await tenant.attio.api.generated.assertPerson({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.assertUserRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.assertWorkspace({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.createAttribute({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.createComment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.createCompany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.createDealRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.createEntry({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.createList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.createNote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.createObject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.createPerson({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.createRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.createSelectOption({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.createStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.createTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.createUserRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.createWebhook({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.createWorkspaceRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.deleteComment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.deleteCompany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.deleteDeal({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.deleteEntry({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.deleteNote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.deletePerson({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.deleteRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.deleteRecordById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.deleteTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.deleteUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.deleteWebhook({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.deleteWorkspaceRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.findRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getAttribute({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getComment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getCompany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getDealRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getListEntry({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getNote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getObject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getRecordAttributeValues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getRecordEntries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getSelf({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getV2ObjectsObjectRecordsRecordId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getV2Tasks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getV2WorkspaceMembers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getWebhook({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getWorkspaceMember({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.getWorkspaceRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listAttributeOptions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listAttributes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listAttributeStatuses({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listCallRecordings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listCompanies({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listCompanyAttributeValues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listCompanyRecordEntries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listDealEntries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listDealRecordAttributeValues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listDealRecords({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listEntries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listListEntries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listListEntryAttributeValues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listLists({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listMeetings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listNotes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listObjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listPeopleAttributeValues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listPeopleRecordEntries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listRecordAttributeValues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listRecordEntries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listRecords({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listThreads({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listUserRecordEntries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listUserRecords({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listWebhooks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listWorkspaceMembers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listWorkspaceRecordAttributeValues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listWorkspaceRecordEntries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.listWorkspaceRecords({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.patchRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.patchV2ListsListEntriesEntryId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.peopleGetPerson({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.peopleListPersons({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.postV2ListsListEntries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.postV2ListsListEntriesQuery({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.postV2ObjectsObjectRecords({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.postV2ObjectsObjectRecordsQuery({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.postV2ObjectsRecordsSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.putV2ListsListEntries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.putV2ListsListEntriesEntryId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.putV2ObjectsObjectRecords({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.putV2ObjectsObjectRecordsRecordId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.queryRecords({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.searchRecords({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.updateAttribute({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.updateCompany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.updateDealRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.updateEntry({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.updateList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.updateObject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.updatePerson({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.updateRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.updateSelectOption({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.updateStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.updateTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.updateUserRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.updateWebhook({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.attio.api.generated.updateWorkspaceRecord({});
```
