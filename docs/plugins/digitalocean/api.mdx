...
await tenant.digitalocean.api.databases.createDatabaseCluster({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.databases.deleteDatabaseCluster({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.databases.listAllDatabases({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.databases.listDatabaseOptions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.domainRecords.createNewDomainRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.domainRecords.deleteDomainRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.domainRecords.listDomainRecords({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.domainRecords.retrieveDomainRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.domainRecords.updateDomainRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.domains.createNewDomain({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.domains.deleteDomain({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.domains.listAllDomains({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.domains.retrieveDomain({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.droplets.createNewDroplet({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.droplets.deleteExistingDroplet({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.droplets.listAllDroplets({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.droplets.retrieveExistingDroplet({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.firewalls.createNewFirewall({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.firewalls.deleteFirewall({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.firewalls.listAllFirewalls({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.images.createCustomImage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.images.deleteImage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.images.listAllImages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.images.retrieveExistingImage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.kubernetes.createNewKubernetesCluster({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.kubernetes.listAllKubernetesClusters({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.loadBalancers.createNewLoadBalancer({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.loadBalancers.deleteLoadBalancer({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.loadBalancers.listAllLoadBalancers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.snapshots.listAllSnapshots({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.sshKeys.createNewSshKey({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.sshKeys.deleteSshKey({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.sshKeys.listAllSshKeys({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.tags.createNewTag({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.tags.deleteTag({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.tags.listAllTags({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.tags.retrieveTag({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.tags.tagResource({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.tags.untagResource({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.volumes.createNewBlockStorageVolume({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.volumes.deleteBlockStorageVolume({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.volumes.listAllVolumes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.vpcs.createNewVpc({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.vpcs.deleteVpc({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.vpcs.listAllVpcs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.vpcs.retrieveVpc({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.digitalocean.api.vpcs.updateVpc({});
```
