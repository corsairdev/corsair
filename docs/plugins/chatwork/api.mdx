...
```ts
await corsair.chatwork.api.members.list({ room_id: 123456 });
```
...
```ts
await corsair.chatwork.api.messages.get({ room_id: 123456, message_id: '123456789' });
```
...
```ts
await corsair.chatwork.api.messages.list({ room_id: 123456 });
```
...
```ts
await corsair.chatwork.api.messages.send({ room_id: 123456, body: 'Hello from Corsair' });
```
...
```ts
await corsair.chatwork.api.rooms.get({ room_id: 123456 });
```
