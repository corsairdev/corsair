---
title: API
description: "API reference for BetterProposals: every `betterproposals.api.*` operation with input and output types."
---
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.companies.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.currencies.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.currencies.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.documentTypes.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.documentTypes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.proposals.createCover({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.proposals.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.proposals.getCount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.proposals.getNew({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.proposals.getOpened({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.proposals.getPaid({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.proposals.getSent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.proposals.getSigned({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.proposals.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.quotes.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.quotes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.settings.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.settings.getBrand({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.settings.listMergeTags({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.templates.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.betterproposals.api.templates.list({});
```
