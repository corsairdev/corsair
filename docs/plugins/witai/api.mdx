---
title: API
description: "API reference for WitAi: every `witai.api.*` operation with input and output types."
---
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.apps.deleteApp({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.apps.getApp({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.apps.listApps({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.apps.listTags({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.apps.updateApp({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.entities.addKeyword({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.entities.addSynonym({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.entities.createEntity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.entities.deleteEntity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.entities.deleteKeyword({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.entities.deleteRole({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.entities.deleteSynonym({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.entities.getEntity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.entities.listEntities({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.intents.createIntent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.intents.deleteIntent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.intents.getIntent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.intents.listIntents({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.message.detectLanguage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.message.getMessage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.traits.addValue({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.traits.createTrait({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.traits.deleteTrait({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.traits.getTrait({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.traits.listTraits({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.utterances.createUtterances({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.utterances.deleteUtterances({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.utterances.listUtterances({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.voices.getVoice({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.witai.api.voices.listVoices({});
```
