...
await tenant.serpapi.api.engines.baiduSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.engines.bingMaps({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.engines.bingSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.engines.duckDuckGoLightSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.engines.duckDuckGoMaps({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.engines.duckDuckGoSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.engines.naverSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.engines.yahooSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.engines.yahooVideos({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.engines.yandexImagesSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.engines.yandexSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.engines.youtubeSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.marketplace.appleAppStoreSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.marketplace.ebaySearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.marketplace.facebookProfile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.marketplace.openTableReviews({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.marketplace.walmartProductReviews({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.marketplace.walmartSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.marketplace.yelpSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.aboutThisResult({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.eventSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.financeSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.forumsSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.hotelsAutocomplete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.hotelSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.imageSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.imagesLightSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.imagesRelatedContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.jobsSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.lensSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.lightSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.localServicesSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.mapsPosts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.mapsSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.newsSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.patentDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.playProduct({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.playSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.scholarAuthor({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.scholarCite({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.scholarSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.shoppingSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.trendsSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.search.videosLightSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.utilities.domainsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.utilities.locationOptions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.serpapi.api.utilities.searchArchive({});
```
