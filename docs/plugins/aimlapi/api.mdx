---
title: API
description: "API reference for AimlApi: every `aimlapi.api.*` operation with input and output types."
---
...
await tenant.aimlapi.api.assistants.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.assistants.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.assistants.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.assistants.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.assistants.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.batches.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.billing.getBalance({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.chat.createCompletion({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.luma.getGeneration({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.messages.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.messages.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.messages.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.messages.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.messages.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.models.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.models.listWithDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.responses.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.runs.cancel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.runs.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.runs.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.runs.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.runs.submitToolOutputs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.runs.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.runSteps.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.runSteps.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.threads.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.threads.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.threads.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.aimlapi.api.threads.update({});
```
