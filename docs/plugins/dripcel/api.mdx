...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dripcel.api.campaigns.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dripcel.api.compliance.checkSend({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dripcel.api.contacts.create({});
```
...
Delete a Dripcel contact by cell number [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.dripcel.api.contacts.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dripcel.api.contacts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dripcel.api.contacts.optOut({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dripcel.api.contacts.upsert({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dripcel.api.deliveries.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dripcel.api.emailTemplates.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dripcel.api.replies.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dripcel.api.sales.upload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dripcel.api.send.bulkEmail({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dripcel.api.send.sms({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dripcel.api.sendLogs.search({});
```
...
Delete a Dripcel tag by ID [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.dripcel.api.tags.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dripcel.api.tags.list({});
```
