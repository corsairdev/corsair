---
title: API
description: "API reference for Basecamp OAuth: every `basecamp.api.*` operation with input and output types."
---
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.automaticCheckIns.getBucketsQuestionnaires({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.automaticCheckIns.getBucketsQuestionnairesQuestions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.automaticCheckIns.getBucketsQuestions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.automaticCheckIns.listQuestions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.campfireAndChatbots.createChatbotLine({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.campfireAndChatbots.deleteCampfireLine({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.campfireAndChatbots.deleteChatbot({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.campfireAndChatbots.getBucketsChatsIntegrations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.campfireAndChatbots.getBucketsChatsLines({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.campfireAndChatbots.getCampfire({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.campfireAndChatbots.getCampfireLine({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.campfireAndChatbots.getChatbot({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.campfireAndChatbots.getChats({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.campfireAndChatbots.listCampfireLines({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.campfireAndChatbots.listChatbots({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.campfireAndChatbots.postBucketsChatsLines({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.campfireAndChatbots.postIntegrationsChatbotKeyBucketsChatsLines({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.campfireAndChatbots.putBucketsChatsIntegrations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.campfireAndChatbots.updateChatbot({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.createCard({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.createCardStep({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.deleteBucketsCardTablesColumnsOnHold({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.getBucketsCardTablesListsCards({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.getCard({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.getCardTable({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.getCardTableColumn({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.listCards({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.moveCard({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.moveCardTableColumn({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.postBucketsCardTablesCardsMoves({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.postBucketsCardTablesCardsPositions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.postBucketsCardTablesColumns({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.postBucketsCardTablesColumnsOnHold({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.postBucketsCardTablesMoves({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.putBucketsCardTablesCards({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.putBucketsCardTablesColumns({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.putBucketsCardTablesColumnsColor({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.putBucketsCardTablesSteps({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.putBucketsCardTablesStepsCompletions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.repositionCardStep({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.unwatchCardTableColumn({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.updateCard({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.updateCardTableColumn({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.cardTables.watchCardTableColumn({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.createDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.createUpload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.createVault({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.getBucketsUploads({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.getBucketsVaults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.getBucketsVaultsDocuments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.getBucketsVaultsUploads({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.getBucketsVaultsVaults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.getDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.getUpload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.getVault({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.listUploads({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.listVaults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.postAttachments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.putBucketsDocuments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.putBucketsUploads({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.putBucketsVaults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.updateDocument({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.updateUpload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.documentsAndFiles.updateVault({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.inboxesAndForwards.getBucketsInboxesForwards({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.inboxesAndForwards.getInbox({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.inboxesAndForwards.listForwards({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.messages.deleteMessageType({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.messages.getBucketsCategories({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.messages.getBucketsMessageBoardsMessages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.messages.getMessage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.messages.getMessageBoard({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.messages.getMessageType({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.messages.listMessageTypes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.messages.pinMessage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.messages.postBucketsCategories({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.messages.postBucketsMessageBoardsMessages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.messages.putBucketsCategories({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.messages.putBucketsMessages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.messages.unpinMessage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.messages.updateMessageType({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.peopleAndAccess.getCirclesPeople({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.peopleAndAccess.getMyProfile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.peopleAndAccess.getPeople({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.peopleAndAccess.getPeopleByPersonId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.peopleAndAccess.getPerson({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.peopleAndAccess.getProjectsPeople({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.peopleAndAccess.listProjectPeople({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.peopleAndAccess.putProjectsPeopleUsers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.projectsAndTemplates.createProjectConstruction({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.projectsAndTemplates.getProject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.projectsAndTemplates.getProjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.projectsAndTemplates.getProjectsByProjectId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.projectsAndTemplates.getTemplates({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.projectsAndTemplates.getTemplatesByTemplateId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.projectsAndTemplates.getTemplatesProjectConstructions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.projectsAndTemplates.postLineupMarkers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.projectsAndTemplates.postProjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.projectsAndTemplates.postTemplates({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.projectsAndTemplates.putProjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.projectsAndTemplates.putTemplates({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.projectsAndTemplates.trashProject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.projectsAndTemplates.trashTemplate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.deleteBucketsRecordingsPin({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.getBucketsRecordingsComments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.getBucketsRecordingsEvents({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.getComment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.getProjectsRecordings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.getSubscription({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.listComments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.listEvents({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.postBucketsRecordingsComments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.postBucketsRecordingsPin({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.postBucketsRecordingsSubscription({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.putBucketsComments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.putBucketsRecordingsClientVisibility({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.putBucketsRecordingsStatusActive({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.putBucketsRecordingsStatusArchived({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.putBucketsRecordingsStatusTrashed({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.putBucketsRecordingsSubscription({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.subscribeCurrentUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.toggleClientVisibility({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.recordingsAndSubscriptions.unsubscribeCurrentUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.schedulesAndReports.getBucketsSchedulesEntries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.schedulesAndReports.getReportsTimesheet({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.schedulesAndReports.getSchedule({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.schedulesAndReports.getScheduleEntry({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.schedulesAndReports.postBucketsSchedulesEntries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.schedulesAndReports.putBucketsScheduleEntries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.schedulesAndReports.putBucketsSchedules({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.schedulesAndReports.updateScheduleEntry({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.completeTodo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.createTodo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.createTodolistGroup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.getBucketsTodolists({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.getBucketsTodolistsGroups({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.getBucketsTodolistsTodos({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.getBucketsTodos({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.getBucketsTodosets({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.getBucketsTodosetsTodolists({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.getTodo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.getTodolist({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.getTodolistGroups({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.getTodoset({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.listTodolists({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.postBucketsTodolistsComments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.postBucketsTodolistsTodos({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.postBucketsTodosComments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.postBucketsTodosetsTodolists({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.putBucketsTodolistsGroupsPosition({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.putBucketsTodos({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.putBucketsTodosPosition({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.uncompleteTodo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.todos.updateTodo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.webhooks.deleteWebhooks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.webhooks.getBucketsWebhooks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.webhooks.getWebhook({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.webhooks.postBucketsWebhooks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basecamp.api.webhooks.putBucketsWebhooks({});
```
