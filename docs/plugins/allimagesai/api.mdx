...
```ts
const tenant = corsair.withTenant('acme');
await tenant.allimagesai.api.credits.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.allimagesai.api.imageGenerations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.allimagesai.api.images.listDownloaded({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.allimagesai.api.webhooks.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.allimagesai.api.webhooks.get({});
```
