...
```ts
const tenant = corsair.withTenant('acme');
await tenant.boltiot.api.device.checkStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.boltiot.api.device.digitalRead({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.boltiot.api.serial.read({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.boltiot.api.serial.write({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.boltiot.api.serial.writeRead({});
```
