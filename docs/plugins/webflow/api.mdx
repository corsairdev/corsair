...
| `body` | `any` | Yes | Required: `displayName` for the new folder. |
| `query` | `object` | No | — |
| `headers` | `object` | No | — |
| `baseUrl` | `string` | No | — |
...
await corsair.webflow.api.assets.uploadAsset({
  site_id: "580e63e98c9a982ac9b8b741",
  body: { fileName: "logo.png", fileHash: "3c7d87c9575702bc3b1e991f4d3c638e" },
});
```
...
| `order_id` | `string` | No | — |
| `webhook_id` | `string` | No | — |
| `body` | `any` | Yes | Required: `fileName` and `fileHash` (md5) to register the upload. |
| `query` | `object` | No | — |
| `headers` | `object` | No | — |
| `baseUrl` | `string` | No | — |
...
| `order_id` | `string` | No | — |
| `webhook_id` | `string` | No | — |
| `body` | `any` | Yes | Required: field `type` and `displayName`. |
| `query` | `object` | No | — |
| `headers` | `object` | No | — |
| `baseUrl` | `string` | No | — |
...
| `order_id` | `string` | No | — |
| `webhook_id` | `string` | No | — |
| `body` | `any` | Yes | Required: at least one of `displayName`, `helpText`, or `isRequired`. |
| `query` | `object` | No | — |
| `headers` | `object` | No | — |
| `baseUrl` | `string` | No | — |
...
await corsair.webflow.api.collectionItems.createBulkCollectionItems({
  collection_id: "580e63fc8c9a982ac9b8b745",
  body: { items: [{ fieldData: { name: "Blog Post", slug: "blog-post" } }] },
});
```
...
| `order_id` | `string` | No | — |
| `webhook_id` | `string` | No | — |
| `body` | `any` | Yes | Required: `items` array (up to 100) with `fieldData`. |
| `query` | `object` | No | — |
| `headers` | `object` | No | — |
| `baseUrl` | `string` | No | — |
...
await corsair.webflow.api.collectionItems.createCollectionItem({
  collection_id: "580e63fc8c9a982ac9b8b745",
  body: { fieldData: { name: "Blog Post", slug: "blog-post" } },
});
```
...
| `order_id` | `string` | No | — |
| `webhook_id` | `string` | No | — |
| `body` | `any` | Yes | Required: `fieldData` keyed by the collection's field slugs. |
| `query` | `object` | No | — |
| `headers` | `object` | No | — |
| `baseUrl` | `string` | No | — |
...
| `order_id` | `string` | No | — |
| `webhook_id` | `string` | No | — |
| `body` | `any` | Yes | Required: `itemIds` of the staged items to publish. |
| `query` | `object` | No | — |
| `headers` | `object` | No | — |
| `baseUrl` | `string` | No | — |
...
await corsair.webflow.api.collections.createCollection({
  site_id: "580e63e98c9a982ac9b8b741",
  body: { displayName: "Blog Posts", singularName: "Blog Post" },
});
```
...
| `order_id` | `string` | No | — |
| `webhook_id` | `string` | No | — |
| `body` | `any` | Yes | Required: `displayName` and `singularName` for the new collection. |
| `query` | `object` | No | — |
| `headers` | `object` | No | — |
| `baseUrl` | `string` | No | — |
...
| `order_id` | `string` | No | — |
| `webhook_id` | `string` | No | — |
| `body` | `any` | Yes | Required: `inventoryType`, plus `quantity` or `updateQuantity`. |
| `query` | `object` | No | — |
| `headers` | `object` | No | — |
| `baseUrl` | `string` | No | — |
