...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.assets.deleteAsset({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.assets.getAssetFolder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.assets.listAssetFolders({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.assets.listAssets({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.assets.uploadAsset({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionFields.createCollectionField({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionFields.deleteCollectionField({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionFields.updateCollectionField({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionItems.createBulkCollectionItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionItems.createCollectionItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionItems.createLiveCollectionItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionItems.deleteCollectionItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionItems.deleteCollectionItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionItems.getCollectionItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionItems.getLiveCollectionItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionItems.listCollectionItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionItems.publishCollectionItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionItems.unpublishLiveCollectionItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionItems.unpublishLiveCollectionItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionItems.updateCollectionItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionItems.updateCollectionItemLegacy({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionItems.updateLiveCollectionItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collectionItems.updateLiveCollectionItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collections.createCollection({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collections.deleteCollection({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collections.getCollection({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.collections.listCollections({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.comments.listCommentThreads({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.components.getComponentProperties({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.ecommerce.fulfillOrder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.ecommerce.getItemInventory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.ecommerce.getOrder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.ecommerce.listOrders({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.ecommerce.refundOrder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.ecommerce.unfulfillOrder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.ecommerce.updateItemInventory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.ecommerce.updateOrder({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.forms.listFormSubmissions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.pages.getPage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.pages.getPageDom({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.pages.listPages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.pages.updatePageMetadata({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.sites.getCustomDomains({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.sites.getSite({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.sites.listSites({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.sites.publishSite({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.sites.updateSite({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.token.getTokenAuthorizedBy({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.webhooks.deleteWebhook({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.webflow.api.webhooks.listWebhooks({});
```
