...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agilitycms.api.content.getContentModels({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agilitycms.api.content.getItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agilitycms.api.content.getList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agilitycms.api.content.getLogs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agilitycms.api.content.getPage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agilitycms.api.content.getPageModules({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agilitycms.api.content.getSitemapFlat({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agilitycms.api.content.syncPages({});
```
