...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pagerduty.api.incidents.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pagerduty.api.incidents.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pagerduty.api.logEntries.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pagerduty.api.logEntries.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.pagerduty.api.users.get({});
```
