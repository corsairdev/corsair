...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.admins.identify({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.admins.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.admins.listActivityLogs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.articles.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.articles.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.articles.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.articles.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.articles.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.articles.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.collections.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.collections.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.collections.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.collections.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.collections.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.companies.createOrUpdate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.companies.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.companies.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.companies.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.companies.listAttachedContacts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.companies.listAttachedSegments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.companies.retrieve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.companies.scroll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.contacts.addSubscription({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.contacts.addTag({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.contacts.attachToCompany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.contacts.createNote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.contacts.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.contacts.detachFromCompany({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.contacts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.contacts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.contacts.listAttachedCompanies({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.contacts.listAttachedSegments({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.contacts.listNotes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.contacts.listSubscriptions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.contacts.listTags({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.contacts.merge({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.contacts.removeSubscription({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.contacts.removeTag({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.contacts.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.conversations.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.conversations.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.conversations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.conversations.reopen({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.conversations.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.helpCenters.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.intercom.api.helpCenters.list({});
```
