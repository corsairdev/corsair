...
await tenant.basin.api.domains.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.forms.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.forms.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.forms.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.forms.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.forms.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.formViews.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.formViews.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.projects.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.projects.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.projects.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.projects.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.projects.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.submissions.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.submissions.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.submissions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.submissions.markHam({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.submissions.markSpam({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.submissions.refireWebhooks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.submissions.refireWebhooksBulk({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.submissions.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.webhooks.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.webhooks.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.webhooks.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.webhooks.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.basin.api.webhooks.update({});
```
