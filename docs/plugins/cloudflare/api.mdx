...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.dns.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.dns.edit({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.dns.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.rulesets.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.rulesets.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.rulesets.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.rulesets.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.rulesets.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.workers.routes.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.workers.routes.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.workers.routes.edit({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.workers.routes.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.workers.routes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.workers.scripts.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.workers.scripts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.workers.scripts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.workers.scripts.upload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.zones.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.zones.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.zones.edit({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.zones.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.cloudflare.api.zones.list({});
```
