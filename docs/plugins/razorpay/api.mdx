...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.customers.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.customers.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.orders.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.orders.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.orders.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.payments.capture({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.payments.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.payments.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.payouts.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.payouts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.payouts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.refunds.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.refunds.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.refunds.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.settlements.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.settlements.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.subscriptions.cancel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.subscriptions.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.subscriptions.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.subscriptions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.subscriptions.pause({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.subscriptions.resume({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.razorpay.api.subscriptions.update({});
```
