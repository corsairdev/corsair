...
```ts
await corsair.apify.api.actorBuilds.abortActorBuild({});
```
...
```ts
await corsair.apify.api.actorBuilds.deleteActorBuild({});
```
...
```ts
await corsair.apify.api.actorBuilds.getActorBuild({});
```
...
```ts
await corsair.apify.api.actorBuilds.getActorBuildLog({});
```
...
```ts
await corsair.apify.api.actorBuilds.getUserBuildsList({});
```
...
```ts
await corsair.apify.api.actorRuns.abortActorRun({});
```
...
```ts
await corsair.apify.api.actorRuns.deleteActorRun({});
```
...
```ts
await corsair.apify.api.actorRuns.getActorRun({});
```
...
```ts
await corsair.apify.api.actorRuns.getRunDatasetItems({});
```
...
```ts
await corsair.apify.api.actorRuns.listUserActorRuns({});
```
...
```ts
await corsair.apify.api.actorRuns.resurrectRun({});
```
...
```ts
await corsair.apify.api.actorRuns.updateActorRunStatusMessage({});
```
...
```ts
await corsair.apify.api.actors.callActor({});
```
...
```ts
await corsair.apify.api.actors.fetchActorDetails({});
```
...
```ts
await corsair.apify.api.actors.ragWebBrowser({});
```
...
```ts
await corsair.apify.api.actors.searchActors({});
```
...
```ts
await corsair.apify.api.actorTasks.createActorTask({});
```
...
```ts
await corsair.apify.api.actorTasks.deleteActorTask({});
```
...
```ts
await corsair.apify.api.actorTasks.getActorTask({});
```
...
```ts
await corsair.apify.api.actorTasks.getLastActorTaskRun({});
```
...
```ts
await corsair.apify.api.actorTasks.getListOfTaskRuns({});
```
...
```ts
await corsair.apify.api.actorTasks.getListOfTasks({});
```
...
```ts
await corsair.apify.api.actorTasks.getListOfTaskWebhooks({});
```
...
```ts
await corsair.apify.api.actorTasks.getTaskInput({});
```
...
```ts
await corsair.apify.api.actorTasks.getTaskLastRunDatasetItems({});
```
...
```ts
await corsair.apify.api.actorTasks.runTaskAsynchronously({});
```
...
```ts
await corsair.apify.api.actorTasks.runTaskSyncGet({});
```
...
```ts
await corsair.apify.api.actorTasks.runTaskSyncGetDatasetItems({});
```
...
```ts
await corsair.apify.api.actorTasks.runTaskSyncPost({});
```
...
```ts
await corsair.apify.api.actorTasks.runTaskSyncWithInputOverrideGetDatasetItems({});
```
...
```ts
await corsair.apify.api.actorTasks.updateActorTask({});
```
...
```ts
await corsair.apify.api.actorTasks.updateTaskInput({});
```
...
```ts
await corsair.apify.api.acts.buildActor({});
```
...
```ts
await corsair.apify.api.acts.createActor({});
```
...
```ts
await corsair.apify.api.acts.createActorVersion({});
```
...
```ts
await corsair.apify.api.acts.createActorVersionEnvironmentVariable({});
```
...
```ts
await corsair.apify.api.acts.deleteActor({});
```
...
```ts
await corsair.apify.api.acts.deleteActorVersion({});
```
...
```ts
await corsair.apify.api.acts.deleteActorVersionEnvironmentVariable({});
```
...
```ts
await corsair.apify.api.acts.getActorDetails({});
```
...
```ts
await corsair.apify.api.acts.getActorLastRunDatasetItems({});
```
...
```ts
await corsair.apify.api.acts.getActorVersion({});
```
...
```ts
await corsair.apify.api.acts.getActorVersionEnvironmentVariable({});
```
...
```ts
await corsair.apify.api.acts.getDefaultBuild({});
```
...
```ts
await corsair.apify.api.acts.getLastActorRun({});
```
...
```ts
await corsair.apify.api.acts.getListOfActors({});
```
...
```ts
await corsair.apify.api.acts.getListOfActorVersionEnvironmentVariables({});
```
...
```ts
await corsair.apify.api.acts.getListOfActorVersions({});
```
...
```ts
await corsair.apify.api.acts.getListOfActorWebhooks({});
```
...
```ts
await corsair.apify.api.acts.getListOfBuilds({});
```
...
```ts
await corsair.apify.api.acts.getListOfRuns({});
```
...
```ts
await corsair.apify.api.acts.getOpenapiDefinition({});
```
...
```ts
await corsair.apify.api.acts.runActorAsynchronously({});
```
...
```ts
await corsair.apify.api.acts.runActorSync({});
```
...
```ts
await corsair.apify.api.acts.runActorSyncGetDatasetItems({});
```
...
```ts
await corsair.apify.api.acts.runActorSyncGetDatasetItemsItems({});
```
...
```ts
await corsair.apify.api.acts.runActorSyncWithoutInputGet({});
```
...
```ts
await corsair.apify.api.acts.updateActor({});
```
...
```ts
await corsair.apify.api.acts.updateActorVersion({});
```
...
```ts
await corsair.apify.api.acts.updateActorVersionEnvironmentVariable({});
```
...
```ts
await corsair.apify.api.datasets.createDataset({});
```
...
```ts
await corsair.apify.api.datasets.deleteDataset({});
```
...
```ts
await corsair.apify.api.datasets.getDataset({});
```
...
```ts
await corsair.apify.api.datasets.getDatasetItems({});
```
...
```ts
await corsair.apify.api.datasets.getDatasetStatistics({});
```
...
```ts
await corsair.apify.api.datasets.getListOfDatasets({});
```
...
```ts
await corsair.apify.api.datasets.storeDataInDataset({});
```
...
```ts
await corsair.apify.api.datasets.updateDataset({});
```
...
```ts
await corsair.apify.api.docs.fetchApifyDocs({});
```
...
```ts
await corsair.apify.api.docs.searchApifyDocs({});
```
...
```ts
await corsair.apify.api.keyValueStores.checkKeyValueStoreRecordExists({});
```
...
```ts
await corsair.apify.api.keyValueStores.createKeyValueStore({});
```
...
```ts
await corsair.apify.api.keyValueStores.deleteKeyValueStore({});
```
...
```ts
await corsair.apify.api.keyValueStores.deleteKeyValueStoreRecord({});
```
...
```ts
await corsair.apify.api.keyValueStores.getKeyValueRecord({});
```
...
```ts
await corsair.apify.api.keyValueStores.getKeyValueStore({});
```
...
```ts
await corsair.apify.api.keyValueStores.getKeyValueStoreKeys({});
```
...
```ts
await corsair.apify.api.keyValueStores.getListOfKeyValueStores({});
```
...
```ts
await corsair.apify.api.keyValueStores.storeDataInKeyValueStore({});
```
...
```ts
await corsair.apify.api.keyValueStores.updateKeyValueStore({});
```
...
```ts
await corsair.apify.api.logs.getLog({});
```
...
```ts
await corsair.apify.api.requestQueues.addRequestToQueue({});
```
...
```ts
await corsair.apify.api.requestQueues.batchAddRequestsToQueue({});
```
...
```ts
await corsair.apify.api.requestQueues.batchDeleteRequestsFromQueue({});
```
...
```ts
await corsair.apify.api.requestQueues.createRequestQueue({});
```
...
```ts
await corsair.apify.api.requestQueues.deleteRequestFromQueue({});
```
...
```ts
await corsair.apify.api.requestQueues.deleteRequestLock({});
```
...
```ts
await corsair.apify.api.requestQueues.deleteRequestQueue({});
```
...
```ts
await corsair.apify.api.requestQueues.getHeadAndLockQueueRequests({});
```
...
```ts
await corsair.apify.api.requestQueues.getListOfRequestQueues({});
```
...
```ts
await corsair.apify.api.requestQueues.getRequestFromQueue({});
```
...
```ts
await corsair.apify.api.requestQueues.getRequestQueue({});
```
...
```ts
await corsair.apify.api.requestQueues.getRequestQueueHead({});
```
...
```ts
await corsair.apify.api.requestQueues.listRequestQueueRequests({});
```
...
```ts
await corsair.apify.api.requestQueues.prolongRequestLock({});
```
...
```ts
await corsair.apify.api.requestQueues.unlockQueueRequests({});
```
...
```ts
await corsair.apify.api.requestQueues.updateRequestInQueue({});
```
...
```ts
await corsair.apify.api.requestQueues.updateRequestQueue({});
```
...
```ts
await corsair.apify.api.runs.getActorOutput({});
```
...
```ts
await corsair.apify.api.runs.getActorRun({});
```
...
```ts
await corsair.apify.api.schedules.createSchedule({});
```
...
```ts
await corsair.apify.api.schedules.deleteSchedule({});
```
...
```ts
await corsair.apify.api.schedules.getListOfSchedules({});
```
...
```ts
await corsair.apify.api.schedules.getSchedule({});
```
...
```ts
await corsair.apify.api.schedules.getScheduleLog({});
```
...
```ts
await corsair.apify.api.schedules.updateSchedule({});
```
...
```ts
await corsair.apify.api.store.getListOfActorsInStore({});
```
...
```ts
await corsair.apify.api.users.getAccountLimits({});
```
...
```ts
await corsair.apify.api.users.getCurrentUserAccountData({});
```
...
```ts
await corsair.apify.api.users.getMonthlyUsage({});
```
...
```ts
await corsair.apify.api.users.getPublicUserData({});
```
...
```ts
await corsair.apify.api.users.updateAccountLimits({});
```
...
```ts
await corsair.apify.api.webhookDispatches.getListOfWebhookDispatches({});
```
...
```ts
await corsair.apify.api.webhookDispatches.getWebhookDispatch({});
```
...
```ts
await corsair.apify.api.webhooks.createTaskWebhook({});
```
...
```ts
await corsair.apify.api.webhooks.deleteWebhook({});
```
...
```ts
await corsair.apify.api.webhooks.getAllWebhooks({});
```
...
```ts
await corsair.apify.api.webhooks.getWebhook({});
```
...
```ts
await corsair.apify.api.webhooks.getWebhookDispatches({});
```
...
```ts
await corsair.apify.api.webhooks.testWebhook({});
```
...
```ts
await corsair.apify.api.webhooks.updateWebhook({});
```
