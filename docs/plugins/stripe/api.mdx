...
```ts
const tenant = corsair.withTenant('acme');
await tenant.stripe.api.charges.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.stripe.api.charges.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.stripe.api.charges.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.stripe.api.coupons.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.stripe.api.coupons.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.stripe.api.customers.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.stripe.api.customers.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.stripe.api.customers.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.stripe.api.paymentIntents.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.stripe.api.paymentIntents.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.stripe.api.paymentIntents.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.stripe.api.paymentIntents.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.stripe.api.prices.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.stripe.api.prices.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.stripe.api.sources.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.stripe.api.sources.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.stripe.api.tokens.create({});
```
