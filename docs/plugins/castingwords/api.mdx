...
```ts
const tenant = corsair.withTenant('acme');
await tenant.castingwords.api.invoice.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.castingwords.api.prepayBalance.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.castingwords.api.refund.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.castingwords.api.skus.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.castingwords.api.transcript.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.castingwords.api.upgrade.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.castingwords.api.webhook.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.castingwords.api.webhook.register({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.castingwords.api.webhook.test({});
```
