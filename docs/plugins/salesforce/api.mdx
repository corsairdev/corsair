...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.accounts.createAccount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.accounts.deleteAccount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.accounts.getAccount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.accounts.listAccounts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.accounts.removeAccountByUniqueIdentifier({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.accounts.retrieveAccountDataAndErrorResponses({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.accounts.searchAccounts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.accounts.updateAccount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.accounts.updateAccountObjectById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.analyticsReports.getDashboard({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.analyticsReports.getReport({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.analyticsReports.getReportInstance({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.analyticsReports.listAnalyticsTemplates({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.analyticsReports.listDashboards({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.analyticsReports.listEmailTemplates({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.analyticsReports.listReports({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.analyticsReports.queryReport({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.analyticsReports.runReport({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.campaigns.addContactToCampaign({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.campaigns.addLeadToCampaign({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.campaigns.createCampaign({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.campaigns.createCampaignRecordViaPost({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.campaigns.deleteCampaign({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.campaigns.getCampaign({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.campaigns.listCampaigns({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.campaigns.removeCampaignObjectById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.campaigns.removeFromCampaign({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.campaigns.retrieveCampaignDataWithErrorHandling({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.campaigns.retrieveSpecificCampaignObjectDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.campaigns.searchCampaigns({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.campaigns.updateCampaign({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.campaigns.updateCampaignByIdWithJson({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.composite.compositeGraphAction({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.composite.createSobjectTree({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.composite.deleteSobjectCollections({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.composite.getABatchOfRecords({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.composite.getCompositeResources({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.composite.getCompositeSobjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.composite.getSobjectCollections({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.composite.patchCompositeSobjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.composite.postCompositeGraph({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.composite.postCompositeSobjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.contacts.associateContactToAccount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.contacts.createContact({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.contacts.createNewContactWithJsonHeader({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.contacts.deleteContact({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.contacts.getContact({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.contacts.getContactById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.contacts.listContacts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.contacts.queryContactsByName({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.contacts.removeASpecificContactById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.contacts.retrieveContactInfoWithStandardResponses({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.contacts.searchContacts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.contacts.updateContact({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.contacts.updateContactById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.files.deleteFile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.files.getFileContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.files.getFileInformation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.files.getFileShares({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.files.uploadFile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.jobs.closeOrAbortJob({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.jobs.deleteJobQuery({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.jobs.getJobFailedRecordResults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.jobs.getJobSuccessfulRecordResults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.jobs.getJobUnprocessedRecordResults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.jobs.getQueryJobInfo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.jobs.getQueryJobResults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.jobs.uploadJobData({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.leads.applyLeadAssignmentRules({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.leads.createLead({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.leads.createLeadWithSpecifiedContentType({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.leads.deleteALeadObjectByItsId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.leads.deleteLead({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.leads.getLead({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.leads.listLeads({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.leads.retrieveLeadById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.leads.retrieveLeadDataWithVariousResponses({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.leads.searchLeads({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.leads.updateLead({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.leads.updateLeadByIdWithJsonPayload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.cloneRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.createCustomField({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.createCustomObject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.createSObjectRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.deleteSobject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.deleteSobjectRows({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.executeSobjectQuickAction({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getAllCustomObjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getAllFieldsForObject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getApi({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getChatterResources({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getChildRecords({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getConsentAction({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getGlobalActions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getOrgLimits({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getPicklistValuesByRecordType({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getQuickActions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getRecordCounts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getSobjectApprovalLayouts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getSobjectByExternalId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getSobjectPlatformaction({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getSobjectQuickActionDefaultValues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getSObjectRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getSobjectRelationship({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getSobjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getSObjectsDescribeLayoutsRecordTypeId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getSobjectsSobjectDescribeApprovallayouts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getSObjectsUpdated({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getSupport({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getSupportedObjectsDirectory({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getSupportKnowledgeArticles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getTheme({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.getUserInfo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.headActionsCustom({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.headActionsStandard({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.headProcessRulesSObject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.headQuickActions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.headSobjectQuickActionDefaultValues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.headSobjectsGlobalDescribeLayouts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.headSobjectsQuickAction({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.headSobjectsUserPassword({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.listCustomInvocableActions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.listStandardInvocableActions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.massTransferOwnership({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.setUserPassword({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.sobjectRowsUpdate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.sobjectUserPassword({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.updateSobject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.metadata.upsertSobjectByExternalId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.notes.createNote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.notes.createNoteRecordWithContentTypeHeader({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.notes.deleteNote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.notes.getNote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.notes.getNoteByIdWithFields({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.notes.listNotes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.notes.removeNoteObjectById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.notes.retrieveNoteObjectInformation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.notes.searchNotes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.notes.updateNote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.notes.updateSpecificNoteById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.opportunities.addOpportunityLineItem({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.opportunities.cloneOpportunityWithProducts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.opportunities.createOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.opportunities.createOpportunityRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.opportunities.deleteOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.opportunities.getOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.opportunities.listOpportunities({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.opportunities.listPricebookEntries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.opportunities.listPricebooks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.opportunities.removeOpportunityById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.opportunities.retrieveOpportunitiesData({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.opportunities.retrieveOpportunityByIdWithOptionalFields({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.opportunities.searchOpportunities({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.opportunities.updateOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.opportunities.updateOpportunityById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.soqlSosl.executeSoqlQuery({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.soqlSosl.executeSoslSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.soqlSosl.getParameterizedSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.soqlSosl.getSearchLayout({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.soqlSosl.getSearchSuggestions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.soqlSosl.parameterizedSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.soqlSosl.postParameterizedSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.soqlSosl.query({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.soqlSosl.queryAll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.soqlSosl.runSoqlQuery({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.soqlSosl.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.soqlSosl.searchKnowledgeArticles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.soqlSosl.toolingQuery({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.tasks.completeTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.tasks.createTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.tasks.logCall({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.tasks.logEmailActivity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.tasks.searchTasks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.tasks.sendEmail({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.tasks.sendEmailFromTemplate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.tasks.sendMassEmail({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.tasks.updateTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.createARecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.createRecordUiApi({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getAllNavigationItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getApp({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getApps({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getCompactLayouts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getLastSelectedApp({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getListViewActions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getListViewMetadataBatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getListViewMetadataByName({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getListViewRecordsById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getListViewRecordsByName({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getListViewResults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getLookupFieldSuggestions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getLookupSuggestionsCaseContact({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getLookupSuggestionsOpportunityAccount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getMruListViewMetadata({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getMruListViewRecords({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getObjectListViews({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getPhotoActions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getRecordEditPageActions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getRecordUiDataAndMetadata({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getRelatedListActions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getRelatedListPreferencesBatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getRelatedListRecordsContacts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getSobjectListView({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getSobjectListViews({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getUiApiActionsLookupAccount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getUiapiActionsMruListAccount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getUiApiActionsRecordRelatedList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getUiApiAppsUserNavItems({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getUiapiListInfoAccountAllAccounts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getUiapiListInfoAccountRecent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getUiapiListInfoAccountSearchResult({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getUiApiListInfoRecent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getUiapiLookupsOpportunityAccountId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getUiapimruListInfoAccount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getUiApiMruListRecordsAccount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.getUiapiRelatedListPreferences({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.headAppmenuSalesforce1({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.listViewResults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.updateFavorite({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.updateListViewPreferences({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.updateRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.salesforce.api.uiApi.updateRelatedListPreferences({});
```
