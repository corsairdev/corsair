...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dodopayments.api.payments.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dodopayments.api.payments.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dodopayments.api.payments.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dodopayments.api.refunds.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dodopayments.api.subscriptions.cancel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dodopayments.api.subscriptions.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dodopayments.api.subscriptions.get({});
```
