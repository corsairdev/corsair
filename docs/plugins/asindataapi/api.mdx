---
title: API
description: "API reference for AsinDataApi: every `asindataapi.api.*` operation with input and output types."
---
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.collections.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.collections.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.collections.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.collections.start({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.collections.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.destinations.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.destinations.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.destinations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.destinations.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.identifiers.resolve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.offers.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.products.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.requests.add({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.requests.clear({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.requests.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.requests.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.requests.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.resultSets.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.resultSets.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.asindataapi.api.search.get({});
```
