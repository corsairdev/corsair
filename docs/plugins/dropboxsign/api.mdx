...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.account.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.account.verify({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.apiApps.authorize({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.apiApps.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.apiApps.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.apiApps.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.apiApps.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.apiApps.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.bulkSend.createEmbeddedWithTemplate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.bulkSend.getJob({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.bulkSend.listJobs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.bulkSend.sendWithTemplate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.drafts.createEmbeddedUnclaimedWithTemplate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.drafts.createUnclaimed({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.drafts.editAndResendUnclaimed({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.embedded.getSignUrl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.embedded.getTemplateEditUrl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.faxAndReports.createReport({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.faxAndReports.deleteFax({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.faxAndReports.getAreaCodes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.faxAndReports.listFaxes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.faxAndReports.listFaxLines({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.signatureRequests.cancel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.signatureRequests.createEmbedded({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.signatureRequests.createEmbeddedWithTemplate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.signatureRequests.downloadFiles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.signatureRequests.editAndResend({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.signatureRequests.editAndResendEmbedded({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.signatureRequests.editAndResendEmbeddedTemplate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.signatureRequests.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.signatureRequests.getFilesAsDataUri({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.signatureRequests.getFilesAsFileUrl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.signatureRequests.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.signatureRequests.releaseHold({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.signatureRequests.remind({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.signatureRequests.send({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.signatureRequests.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.teams.addMember({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.teams.getCurrent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.teams.getInfo({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.teams.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.teams.listMembers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.teams.listSubTeams({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.templates.addUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.templates.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.templates.createEmbeddedDraft({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.templates.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.templates.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.templates.getFiles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.templates.getFilesAsDataUri({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.templates.getFilesAsFileUrl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.templates.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.templates.removeUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropboxsign.api.templates.updateFiles({});
```
