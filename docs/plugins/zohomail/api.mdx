...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohomail.api.folders.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohomail.api.folders.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohomail.api.folders.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohomail.api.messages.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohomail.api.messages.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohomail.api.messages.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohomail.api.messages.markRead({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohomail.api.messages.markUnread({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohomail.api.messages.move({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.zohomail.api.messages.send({});
```
