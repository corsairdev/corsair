...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.calendars.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.calendars.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.contacts.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.contacts.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.contacts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.contacts.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.events.cancel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.events.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.events.decline({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.events.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.events.findMeetingTimes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.events.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.events.getSchedule({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.events.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.events.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.folders.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.folders.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.folders.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.folders.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.folders.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.messages.addAttachment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.messages.createDraft({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.messages.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.messages.forward({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.messages.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.messages.move({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.messages.query({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.messages.reply({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.messages.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.messages.send({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.outlook.api.messages.sendDraft({});
```
