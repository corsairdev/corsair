---
title: API
description: "API reference for WorldNewsApi: every `worldnewsapi.api.*` operation with input and output types."
---
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.worldnewsapi.api.news.extractNewsLinks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.worldnewsapi.api.news.getGeoCoordinates({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.worldnewsapi.api.news.newsWebsiteToRssFeed({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.worldnewsapi.api.news.searchNews({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.worldnewsapi.api.news.searchNewsSources({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.worldnewsapi.api.news.topNews({});
```
