...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.getCollectionMetadata({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.getCollectionsForOwner({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.getContractMetadataBatchV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.getContractMetadataV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.getContractsForOwnerV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.getFloorPriceV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.getNftMetadata({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.getNftMetadataBatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.getNftSalesV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.getNftsForCollectionV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.getNftsForContract({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.getNftsForOwner({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.getOwnersForCollection({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.getOwnersForContract({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.getOwnersForNftV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.isAirdrop({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.isAirdropNft({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.isHolderOfCollection({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.isHolderOfContract({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.isSpamContract({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.isSpamContractV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.searchContractMetadataV3({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.nft.summarizeNftAttributes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.portfolio.getNftContractsByAddress({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.portfolio.getPortfolioNftsByAddress({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.portfolio.getTokenBalancesByAddress({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.portfolio.getTokensByAddress({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.portfolio.getTransactionsHistoryByAddress({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.prices.getHistoricalPrices({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.prices.getPricesBySymbol({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.prices.getTokenPricesByAddress({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.rpc.getTransactionCount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.token.getTokenBalances({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alchemy.api.token.getTokenMetadata({});
```
