...
await tenant.typeform.api.forms.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.forms.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.forms.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.forms.getMessages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.forms.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.forms.patch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.forms.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.forms.updateMessages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.images.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.images.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.images.getBackgroundBySize({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.images.getBySize({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.images.getChoiceImageBySize({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.images.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.me.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.responses.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.responses.getAllFiles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.responses.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.themes.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.themes.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.themes.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.themes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.themes.patch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.themes.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.videos.upload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.webhooksConfig.createOrUpdate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.webhooksConfig.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.webhooksConfig.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.webhooksConfig.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.workspaces.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.workspaces.createForAccount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.workspaces.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.workspaces.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.workspaces.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.typeform.api.workspaces.update({});
```
