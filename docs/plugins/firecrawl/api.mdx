...
```ts
const tenant = corsair.withTenant('acme');
await tenant.firecrawl.api.agent.start({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.firecrawl.api.crawl.cancel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.firecrawl.api.crawl.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.firecrawl.api.crawl.start({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.firecrawl.api.map.run({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.firecrawl.api.scrape.run({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.firecrawl.api.search.run({});
```
