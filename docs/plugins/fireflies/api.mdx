---
title: API
description: "API reference for Fireflies: every `fireflies.api.*` operation with input and output types."
---
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.fireflies.api.askFred.createThread({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.fireflies.api.askFred.deleteThread({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.fireflies.api.askFred.getThread({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.fireflies.api.askFred.getThreads({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.fireflies.api.audio.upload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.fireflies.api.transcripts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.fireflies.api.transcripts.getAnalytics({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.fireflies.api.transcripts.getAudioUrl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.fireflies.api.transcripts.getSummary({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.fireflies.api.transcripts.getVideoUrl({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.fireflies.api.transcripts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.fireflies.api.users.getCurrent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.fireflies.api.users.list({});
```
