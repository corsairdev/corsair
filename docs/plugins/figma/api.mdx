...
await tenant.figma.api.activityLogs.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.comments.addReaction({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.comments.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.comments.deleteReaction({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.comments.getReactions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.comments.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.components.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.components.getComponentSet({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.components.getComponentSetsForFile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.components.getComponentSetsForTeam({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.components.getForFile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.components.getForTeam({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.designTools.designTokensToTailwind({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.designTools.discoverResources({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.designTools.downloadImages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.designTools.extractDesignTokens({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.designTools.extractPrototypeInteractions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.devResources.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.devResources.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.devResources.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.devResources.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.files.getImageFills({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.files.getJSON({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.files.getMetadata({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.files.getNodes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.files.getProjectFiles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.files.getStyles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.files.getVersions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.files.renderImages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.libraryAnalytics.componentActions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.libraryAnalytics.componentUsages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.libraryAnalytics.styleActions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.libraryAnalytics.styleUsages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.libraryAnalytics.variableActions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.libraryAnalytics.variableUsages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.payments.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.projects.getTeamProjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.styles.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.styles.getForTeam({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.users.getCurrent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.variables.createModifyDelete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.variables.getLocal({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.variables.getPublished({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.webhooks.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.webhooks.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.webhooks.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.webhooks.getRequests({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.webhooks.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.figma.api.webhooks.update({});
```
