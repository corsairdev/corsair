...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.branches.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.branches.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.commits.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.commits.getDiff({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.commits.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.groups.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.groups.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.groups.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.groups.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.groups.listProjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.groups.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.issues.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.issues.createNote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.issues.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.issues.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.issues.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.issues.listNotes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.issues.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.labels.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.labels.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.labels.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.labels.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.mergeRequests.approve({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.mergeRequests.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.mergeRequests.createNote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.mergeRequests.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.mergeRequests.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.mergeRequests.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.mergeRequests.listNotes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.mergeRequests.merge({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.mergeRequests.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.milestones.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.milestones.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.milestones.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.milestones.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.milestones.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.pipelines.cancel({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.pipelines.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.pipelines.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.pipelines.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.pipelines.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.pipelines.listJobs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.pipelines.retry({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.projects.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.projects.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.projects.fork({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.projects.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.projects.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.projects.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.releases.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.releases.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.releases.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.releases.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.releases.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.repository.compare({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.repository.getFile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.repository.getTree({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.users.getCurrentUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.users.getUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.gitlab.api.users.list({});
```
