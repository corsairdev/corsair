...
await tenant.botbaba.api.actions.execute({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.actions.executeByUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.actions.getWidgetSettings({});
```
...
Delete a broadcast [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.broadcasts.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.broadcasts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.broadcasts.list({});
```
...
Delete a Botbaba contact [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.contacts.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.contacts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.contacts.getAnalytics({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.contacts.update({});
```
...
Delete a conversation flow [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.flows.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.flows.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.flows.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.gupshup.forwardMessage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.messages.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.messages.getAnalytics({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.messages.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.messages.sendWhatsappTemplate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.shopify.cartCreation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.shopify.cartUpdate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.shopify.checkoutCreation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.shopify.checkoutUpdate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.shopify.orderCancellation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.shopify.orderFulfillment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.shopify.orderPayment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.simulators.cartCreation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.simulators.checkoutCreation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.simulators.checkoutUpdate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.simulators.gupshup({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.simulators.orderFulfillment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.tags.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.tags.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.tags.update({});
```
...
Delete a message template [DESTRUCTIVE]

**Risk:** `destructive`

```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.templates.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.templates.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.templates.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.templates.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.utils.getFilename({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.webhooks.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.webhooks.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.webhooks.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.webhooks.listEventTypes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.botbaba.api.webhooks.update({});
```
