...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.airPollution.forecast({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.airPollution.history({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.geocoding.byZip({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.geocoding.direct({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.geocoding.reverse({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.history.timeMachine({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.maps.weatherMapTile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.stations.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.stations.getMeasurements({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.stations.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.stations.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.stations.submitMeasurements({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.stations.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.summary.daySummary({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.summary.overview({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.weather.circleCity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.weather.current({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.weather.forecast5Day({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.openweathermap.api.weather.oneCall({});
```
