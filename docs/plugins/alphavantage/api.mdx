...
await tenant.alphavantage.api.commodities.all({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.commodities.aluminum({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.commodities.brent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.commodities.coffee({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.commodities.copper({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.commodities.corn({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.commodities.cotton({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.commodities.sugar({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.commodities.wheat({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.crypto.daily({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.crypto.intraday({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.crypto.monthly({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.crypto.weekly({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.economic.cpi({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.economic.durables({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.economic.federalFundsRate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.economic.inflation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.economic.nonfarmPayroll({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.economic.realGdp({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.economic.realGdpPerCapita({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.economic.retailSales({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.economic.treasuryYield({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.economic.unemployment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.forex.daily({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.forex.exchangeRate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.forex.intraday({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.forex.monthly({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.forex.weekly({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.fundamentals.balanceSheet({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.fundamentals.cashFlow({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.fundamentals.companyOverview({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.fundamentals.dividends({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.fundamentals.earnings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.fundamentals.earningsCalendar({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.fundamentals.earningsCallTranscript({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.fundamentals.incomeStatement({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.fundamentals.ipoCalendar({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.fundamentals.splits({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.intelligence.historicalOptions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.intelligence.newsSentiment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.intelligence.slidingWindowAnalytics({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.market.listingStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.market.sector({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.market.status({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.market.symbolSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.market.topGainersLosers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.technical.indicator({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.timeSeries.daily({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.timeSeries.globalQuote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.timeSeries.intraday({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.timeSeries.intradayExtended({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.timeSeries.monthly({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.timeSeries.monthlyAdjusted({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.timeSeries.realtimeBulkQuotes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.timeSeries.weekly({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alphavantage.api.timeSeries.weeklyAdjusted({});
```
