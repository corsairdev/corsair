...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.captions.load({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.channels.getActivities({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.channels.getIdByHandle({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.channels.getStatistics({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.channels.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.channelSections.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.channelSections.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.channelSections.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.channelSections.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.comments.createReply({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.comments.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.comments.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.comments.markSpam({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.comments.post({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.comments.setModerationStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.comments.threadsList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.comments.threadsList2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.comments.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.i18n.listLanguages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.i18n.listRegions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.liveChat.listMessages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.liveChat.listSuperChatEvents({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.playlistImages.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.playlistItems.add({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.playlistItems.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.playlistItems.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.playlistItems.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.playlists.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.playlists.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.playlists.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.playlists.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.search.youtube({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.subscriptions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.subscriptions.subscribe({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.subscriptions.unsubscribe({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.videoActions.getRating({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.videoActions.listAbuseReasons({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.videoActions.rate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.videoActions.reportAbuse({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.videoActions.updateThumbnail({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.videoCategories.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.videos.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.videos.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.videos.getBatch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.videos.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.videos.listMostPopular({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.videos.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.videos.upload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.youtube.api.videos.uploadMultipart({});
```
