...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alttextai.api.images.bulkCreate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alttextai.api.images.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alttextai.api.images.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alttextai.api.images.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alttextai.api.images.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alttextai.api.images.pageScrape({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alttextai.api.images.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.alttextai.api.images.update({});
```
