...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.auth.logTheUserOut({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.auth.v4SsoLogTheUserIn({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.contact.batchCreateContact({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.customers.createACustomerNote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.customers.deleteACustomer({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.customers.deleteACustomerFile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.customers.deleteACustomerPolicy({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.customers.getPoliciesForACustomer({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.customers.getTheCustomerDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.customers.getTheCustomerTasks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.customers.searchCustomers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.customers.updateCustomer({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.emailThreads.deleteMessage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.emailThreads.deleteThread({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.emailThreads.getThreadDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.emailThreads.markThreadAsUnreadApiEndpoint({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.emailThreads.searchEmailThreads({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.batchCreateLead({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.changeStatusForLead({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.createALeadNote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.createALeadOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.createALeadQuote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.createBizLead({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.createLead({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.deleteALeadFile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.deleteALeadOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.deleteALeadQuote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.getLeadFiles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.getLeadNotes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.getLeadQuotes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.getLeadTasks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.getTheLeadDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.getTheOpportunitiesForALead({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.moveLeadToSold({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.searchLeads({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.searchLeadsCount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.updateALeadFileName({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.updateALeadOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.updateALeadQuote({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.updateBusinessLead({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.updateLead({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.leads.updateLeadStatusById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.life.searchLifeAndHealthLeads({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.createADriverForAnOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.createAnOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.createAVehicleForAnOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.deleteADriver({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.deleteAnOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.deleteAVehicle({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.getAListOfDriversForAnOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.getAListOfVehiclesForAnOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.getTheDriverDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.getTheOpportunityDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.getTheVehicleDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.linkADriverToOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.linkAVehicleToOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.unlinkADriverFromOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.unlinkAVehicleFromOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.updateADriverSDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.updateAnOpportunity({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.opportunities.updateAVehicleSDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.policies.updateAPolicy({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.policies.updateTagsForAPolicy({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.profile.updateMyProfile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.referenceData.getAListOfAssignGroups({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.referenceData.getAListOfCarriers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.referenceData.getAListOfCsrs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.referenceData.getAListOfCustomFields({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.referenceData.getAListOfEmployees({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.referenceData.getAListOfLeadSourceCategories({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.referenceData.getAListOfLeadSources({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.referenceData.getAListOfLifeProfessionals({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.referenceData.getAListOfLocations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.referenceData.getAListOfLossReasons({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.referenceData.getAListOfPipelines({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.referenceData.getAListOfProductLinesPolicyTypes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.referenceData.getAListOfRecycleEvents({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.referenceData.getDepartmentsGroups({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.referenceData.getListOfEndStages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.referenceData.listProductCategories({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.referenceData.searchBusinessClassifications({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.serviceTickets.serviceTicketList({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.tasks.batchDeleteTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.tasks.completeTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.tasks.createTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.tasks.deleteATask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.tasks.getTheTaskDetails({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.tasks.reopenATask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.tasks.searchTasks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.tasks.updateTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.textThreads.getAListOfProducer({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.textThreads.removeTextThreadEndpoint({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.textThreads.searchSmsThreads({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.textThreads.textDetailThread({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.textThreads.unreadThread({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.v4sso.authenticateForJwtviaV4Sso({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.agencyzoom.api.v4sso.getAuthUrlForV4Sso({});
```
