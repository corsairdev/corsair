...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dynapictures.api.webhooks.unsubscribe({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dynapictures.api.workspaces.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dynapictures.api.workspaces.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dynapictures.api.workspaces.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dynapictures.api.workspaces.update({});
```
