...
await tenant.mailchimp.api.account.ping({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.account.root({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.campaigns.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.campaigns.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.campaigns.getContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.campaigns.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.campaigns.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.campaigns.schedule({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.campaigns.send({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.campaigns.sendTest({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.campaigns.setContent({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.campaigns.unschedule({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.campaigns.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.interestCategories.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.interestCategories.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.interestCategories.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.interestCategories.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.interestCategories.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.interests.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.interests.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.interests.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.interests.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.interests.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.lists.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.lists.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.lists.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.lists.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.lists.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.members.add({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.members.archive({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.members.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.members.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.members.listTags({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.members.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.members.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.members.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.members.updateTags({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.members.upsert({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.mergeFields.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.mergeFields.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.mergeFields.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.mergeFields.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.mergeFields.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.segments.addMember({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.segments.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.segments.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.segments.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.segments.listMembers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.segments.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.segments.removeMember({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.segments.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.webhooks.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.webhooks.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.webhooks.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.webhooks.remove({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.mailchimp.api.webhooks.update({});
```
