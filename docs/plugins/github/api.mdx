...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.comments.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.comments.listForIssue({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.comments.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.discussions.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.discussions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.events.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.events.listForNetwork({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.events.listForOrg({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.events.listForRepository({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.events.listForUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.events.listForUserOrg({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.events.listPublicForUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.events.listPublicReceivedForUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.events.listReceivedForUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.forks.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.issues.createComment({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.issues.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.issues.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.pullRequests.createReview({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.pullRequests.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.pullRequests.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.pullRequests.listReviews({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.releases.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.releases.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.releases.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.releases.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.repositories.checkStarred({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.repositories.listBranches({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.repositories.listCommits({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.repositories.listStargazers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.repositories.listStarred({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.repositories.star({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.repositories.unstar({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.search.issues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.search.repositories({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.search.users({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.users.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.users.getAuthenticated({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.users.getById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.users.getHovercard({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.users.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.users.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.workflows.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.workflows.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.github.api.workflows.listRuns({});
```
