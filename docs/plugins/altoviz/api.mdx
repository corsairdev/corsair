...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.account.getCurrentUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.account.getSettings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.account.getUnits({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.account.getVats({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.account.testApiKey({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.colleagues.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.colleagues.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.colleagues.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.contacts.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.contacts.find({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.contacts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.contacts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.customerFamilies.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.customerFamilies.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.customerFamilies.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.customerFamilies.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.customers.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.customers.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.customers.find({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.customers.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.customers.getByInternalId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.customers.getContacts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.customers.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.customers.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.productFamilies.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.productFamilies.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.productFamilies.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.productFamilies.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.products.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.products.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.products.find({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.products.findByNumberOrId({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.products.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.purchaseInvoices.download({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.purchaseInvoices.upload({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.receipts.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.receipts.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.receipts.find({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.receipts.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.receipts.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.receipts.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.saleCredits.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.saleCredits.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.saleCredits.download({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.saleCredits.find({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.saleCredits.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.saleCredits.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.saleCredits.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.saleInvoices.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.saleInvoices.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.saleInvoices.download({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.saleInvoices.find({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.saleInvoices.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.saleInvoices.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.saleQuotes.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.saleQuotes.find({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.saleQuotes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.suppliers.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.suppliers.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.suppliers.getContacts({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.suppliers.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.suppliers.update({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.webhookSubscriptions.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.webhookSubscriptions.register({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.altoviz.api.webhookSubscriptions.unregister({});
```
