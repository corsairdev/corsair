...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.api.webhooks.deleteRule({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.api.webhooks.updateRule({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.communities.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.communities.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.communities.getById({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.communities.getMembers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.communities.getModerators({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.communities.getTweets({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.communities.join({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.communities.leave({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.communities.searchTweets({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.lists.getFollowers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.lists.getMembers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.lists.getTweets({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.replies.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.replies.getV2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.stream.addUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.stream.listUsers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.stream.removeUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.trends.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.tweets.advancedSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.tweets.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.tweets.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.tweets.getByIds({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.tweets.getQuotations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.tweets.getRetweeters({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.tweets.getThreadContext({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.tweets.getUserLastTweets({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.tweets.getUserMentions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.tweets.getUserTimeline({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.tweets.like({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.tweets.retweet({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.tweets.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.tweets.unlike({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.users.batchGetByIds({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.users.checkFollowRelationship({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.users.follow({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.users.getByUsername({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.users.getFollowers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.users.getFollowings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.users.getMe({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.users.getVerifiedFollowers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.users.login({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.users.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.twitterapiio.api.users.unfollow({});
```
