...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.contacts.upsert({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.customers.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.customers.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.customers.upsert({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.enquiries.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.inventory.categories({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.inventory.kits({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.inventory.supplies({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.jobs.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.jobs.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.jobs.search({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.notes.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.quotes.labourRoles({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.quotes.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.quotes.standardSections({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.quotes.standardStages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.supplierInvoices.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.suppliers.get({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.suppliers.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.ascora.api.suppliers.upsert({});
```
