...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.abTests.deleteAbTest({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.abTests.listAbTests({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.abTests.stopAbTest({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getAddToCartRate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getAverageClickPosition({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getClickPositions({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getClickThroughRate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getConversionRate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getNoClickRate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getNoResultsRate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getNoResultsSearches({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getPurchaseRate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getRevenue({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getSearchesCount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getSearchesNoClicks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getTopCountries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getTopFilterAttributes({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getTopFilterForAttribute({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getTopFiltersNoResults({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getTopHits({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getTopSearches({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.analytics.getUsersCount({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.apiKeys.createApiKey({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.apiKeys.deleteApiKey({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.apiKeys.getApiKey({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.apiKeys.listApiKeys({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.apiKeys.restoreApiKey({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.apiKeys.updateApiKey({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.authentications.createAuthentication({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.authentications.deleteAuthentication({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.authentications.getAuthentication({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.authentications.listAuthentications({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.authentications.searchAuthentications({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.authentications.updateAuthentication({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.destinations.createDestination({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.destinations.deleteDestination({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.destinations.getDestination({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.destinations.listDestinations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.destinations.searchDestinations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.destinations.updateDestination({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.dictionaries.getDictionaryLanguages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.dictionaries.getDictionarySettings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.dictionaries.searchDictionaryEntries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.dictionaries.setDictionarySettings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.dictionaries.updateDictionaryEntries({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.addOrReplaceRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.addRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.browseIndex({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.clearObjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.copyIndex({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.deleteIndex({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.deleteObjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.deleteRecordsByFilter({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.executeBatchOnMultipleIndices({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.getRecommendTaskStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.getRecord({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.getSettings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.getTaskStatus({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.indexExists({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.listIndices({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.partialUpdateObjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.setSettings({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.indices.updateRecordPartially({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.insights.clickedObjectIds({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.insights.clickedObjectIdsAfterSearch({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.insights.convertedObjectIds({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.insights.deleteUserToken({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.insights.initInsights({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.logs.getLogs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.personalization.computeRealtimeUser({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.personalization.deleteUserProfile({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.personalization.getConfig2({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.personalization.getUsers({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.personalization.setPersonalizationStrategy({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.querySuggestions.createQsConfig({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.querySuggestions.deleteConfig({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.querySuggestions.getConfig({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.querySuggestions.listQsConfigs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.querySuggestions.updateConfig({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.rules.clearRules({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.rules.createOrUpdateRecommendRules({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.rules.deleteRecommendRule({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.rules.deleteRule({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.rules.exportRules({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.rules.getRecommendRule({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.rules.getRule({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.rules.replaceAllRules({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.rules.saveRule({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.rules.searchRecommendRules({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.runs.listRuns({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.search.findObject({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.search.getObjectPosition({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.search.getObjects({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.search.searchFacetValues({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.search.searchIndex({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.search.searchMultipleIndices({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.sources.createSource({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.sources.deleteSource({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.sources.getSource({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.sources.listSources({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.sources.searchSources({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.sources.updateSource({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.sources.validateSource({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.sources.validateSourceBeforeUpdate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.synonyms.clearSynonyms({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.synonyms.deleteSynonym({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.synonyms.getSynonym({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.synonyms.saveSynonym({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.synonyms.saveSynonyms({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.synonyms.searchSynonyms({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.tasks.createIngestionTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.tasks.disableTaskV1({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.tasks.enableTaskV1({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.tasks.getAppTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.tasks.getTaskV1({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.tasks.listIngestionTasks({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.tasks.pushTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.tasks.replaceTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.tasks.runTaskV1({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.tasks.searchTasksV1({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.tasks.updateTask({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.transformations.createTransformation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.transformations.deleteTransformation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.transformations.getTransformation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.transformations.listTransformations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.transformations.searchTransformations({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.transformations.tryTransformation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.transformations.tryTransformationBeforeUpdate({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.transformations.updateTransformation({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.usage.getUsage({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.algolia.api.usage.getUsageForIndex({});
```
