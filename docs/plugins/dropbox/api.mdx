...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropbox.api.files.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropbox.api.files.move({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropbox.api.folders.copy({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropbox.api.folders.create({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropbox.api.folders.delete({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropbox.api.folders.list({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropbox.api.folders.listContinue({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropbox.api.folders.move({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.dropbox.api.search.query({});
```
