...
```ts
const tenant = corsair.withTenant('acme');
await tenant.api2pdf.api.libreoffice.libreOfficePdfToHtml({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.api2pdf.api.libreoffice.libreOfficeThumbnail({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.api2pdf.api.pdfsharp.extractPages({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.api2pdf.api.pdfsharp.mergePdfs({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.api2pdf.api.pdfsharp.optimizePdf({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.api2pdf.api.pdfsharp.watermarkPdf({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.api2pdf.api.utility.deletePdf({});
```
...
```ts
const tenant = corsair.withTenant('acme');
await tenant.api2pdf.api.zebra.generateBarcode({});
```
