...
<Callout type="info" title="Get a stable URL (recommended)">
...
Already have Corsair set up? Give this to your agent and it'll walk you through the full webhook setup:

```
I want to set up webhooks for my Corsair project.

Use corsair_setup to check my current configuration, then:
1. Tell me exactly what URL to register in GitHub/Slack
2. Show me what code to add to handle the events I care about
3. Help me store the webhook secret

My local server runs on port 3000.
```
...
<Cards>
  <Card
    title="Workflows"
    description="Chain webhook events into multi-step automations."
    href="/guides/workflows"
  />
  <Card
    title="Multi-Tenancy"
    description="Scope incoming webhooks per user with ?tenantId= param."
    href="/multi-tenancy"
  />
  <Card
    title="GitHub Webhooks"
    description="All available GitHub events and payload shapes."
    href="/plugins/github/webhooks"
  />
  <Card
    title="Slack Webhooks"
    description="All available Slack events and payload shapes."
