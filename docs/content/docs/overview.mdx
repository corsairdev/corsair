...
<Callout title="What is Corsair?" type="info">
  ...
  It generates real TypeScript API routes using your existing ORM—no magic, no
  vendor lock-in, no runtime overhead.
</Callout>
...
- Drizzle ORM + Postgres and Prisma + Postgres support
...
<Callout type="warn" title="Early Development">
  Currently supports Next.js with Drizzle or Prisma and Postgres. More ORMs and
