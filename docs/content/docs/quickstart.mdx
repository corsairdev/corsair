...
<Callout type="info" title="Automated Setup">
  Want to skip the manual setup? Run `pnpm corsair init` to automatically generate all necessary files and folders. This guide shows the manual setup for learning purposes.
</Callout>
