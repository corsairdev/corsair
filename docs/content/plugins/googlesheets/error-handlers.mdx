...
description: Built-in and custom error handling for the Google Sheets plugin.
---

The Google Sheets plugin includes comprehensive error handling with built-in handlers for common error scenarios. You can also add custom error handlers to handle specific cases in your application.
...
<Callout>
**Full Implementation:** For the complete, up-to-date error handler implementations, see the [Google Sheets plugin source code](https://github.com/corsairdev/corsair/tree/main/packages/corsair/plugins/googlesheets) on GitHub.
</Callout>

## Built-in Error Handlers

The Google Sheets plugin automatically handles common error scenarios with sensible retry strategies.
