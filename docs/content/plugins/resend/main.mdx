...
<Tab title="Solo">
```bash
pnpm corsair setup --plugin=resend api_key=your-api-key
```

For webhook signature verification:

```bash
pnpm corsair setup --plugin=resend webhook_signature=your-webhook-secret
```
...
<Tab title="Multi-Tenant">
```bash
pnpm corsair setup --plugin=resend api_key=their-api-key --tenant=user_abc123
```
