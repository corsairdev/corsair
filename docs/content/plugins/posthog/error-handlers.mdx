...
description: Built-in and custom error handling for the PostHog plugin.
---
...
<Callout>
**Full Implementation:** For the complete, up-to-date error handler implementations, see the [PostHog plugin source code](https://github.com/corsairdev/corsair/tree/main/packages/corsair/plugins/posthog) on GitHub.
</Callout>
