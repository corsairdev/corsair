...
```ts
await corsair.withTenant('default').keys.slack.setClientId('your-client-id');
await corsair.withTenant('default').keys.slack.setClientSecret('your-client-secret');
await corsair.withTenant('default').slack.keys.setAccessToken('your-access-token');
await corsair.withTenant('default').slack.keys.setRefreshToken('your-refresh-token');
```
