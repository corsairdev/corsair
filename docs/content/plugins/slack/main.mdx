...
```bash
pnpm corsair setup --plugin=slack bot_token=xoxb-your-bot-token webhook_signature=your-signing-secret
```
...
<CardGroup cols={2}>
  ...
  <Card title="API Endpoints" href="/plugins/slack/api-endpoints">
