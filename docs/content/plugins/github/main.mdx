...
- **[`api_key`](/content/concepts/api-key)** - Personal Access Token authentication
- **[`oauth_2`](/content/concepts/oauth)** - OAuth App authentication
...
<Tab title="Multi-Tenant">
```bash
pnpm corsair setup --plugin=github api_key=their-personal-access-token --tenant=user_abc123
```
</Tab>
</Tabs>
