...
<Tab title="Solo">
```bash
pnpm corsair setup --plugin=pagerduty api_key=your-api-key
```

For webhook signature verification:

```bash
pnpm corsair setup --plugin=pagerduty webhook_signature=your-webhook-secret
```
</Tab>
<Tab title="Multi-Tenant">
```bash
pnpm corsair setup --plugin=pagerduty api_key=their-api-key --tenant=user_abc123
```
