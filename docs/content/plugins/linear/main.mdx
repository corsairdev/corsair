...
The plugin will automatically retrieve the API key from your database. Alternatively, you can provide it directly:
...
Linear webhooks can be secured using HMAC signature verification. Store the webhook secret in the database using the keys API:
