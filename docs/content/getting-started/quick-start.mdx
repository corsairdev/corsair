...
<PmTabs install="@types/better-sqlite3" dev />
  ...
  <DbPanel value="PostgreSQL">

Install the driver, then run the migration:

<PmTabs install="pg" />
<PmTabs install="@types/pg" dev />
...
### Add your GitHub token and run setup (optional)
...
<PmTabs run="corsair setup --github api_key=$GITHUB_TOKEN --backfill" />
...
<FrameworkPanel value="Anthropic SDK">

<PmTabs install="@corsair-dev/mcp @anthropic-ai/sdk" />
...
<FrameworkPanel value="Claude Agent SDK">

<PmTabs install="@corsair-dev/mcp @anthropic-ai/claude-agent-sdk" />
...
<FrameworkPanel value="OpenAI Agents">

<PmTabs install="@corsair-dev/mcp @openai/agents" />
