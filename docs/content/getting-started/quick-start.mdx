...
```bash 
pnpm install corsair better-sqlite3 dotenv
pnpm install --save-dev @types/better-sqlite3 @types/dotenv     
```

`better-sqlite3` is the quickest way to get started. Swap to PostgreSQL any time — same API, just a different driver.
...
```bash title=".env"
CORSAIR_KEK="paste-your-generated-key-here"
GITHUB_TOKEN="ghp_your_token_here"
```

Create `setup.ts` and run it once:
...
async function main() {
    ...
    // Backfill seeds your local DB with repos, issues, PRs, and more
