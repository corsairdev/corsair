...
<Tabs items={['Anthropic SDK', 'Claude Agent SDK', 'OpenAI Agents', 'Vercel AI SDK', 'Mastra', 'OpenAI']}>
...
<Cards>
  <Card
    title="Quick Start"
    description="Full walkthrough — install, credentials, first agent prompt."
    href="/quick-start"
  />
  <Card
    title="More Plugins"
    description="Slack, Linear, Gmail, HubSpot, and 30+ more. Same pattern, just add to plugins[]."
    href="/plugins/slack"
  />
  <Card
    title="Webhooks"
    description="React to real-time events from GitHub, Slack, and more."
    href="/webhooks"
  />
  <Card
    title="Multi-Tenancy"
    description="Building a SaaS product? Scope every call per user with withTenant()."
    href="/multi-tenancy"
  />
</Cards>
