...
<Tabs items={['GitHub → Slack', 'Slack → GitHub', 'Multi-step']}>

<Tab value="GitHub → Slack">
...
<Cards>
  <Card
    ...
    description="Get ngrok running and register your first webhook endpoint."
    href="/webhooks"
  />
  <Card
    title="GitHub Webhooks"
    description="All available GitHub events you can react to."
    href="/plugins/github/webhooks"
  />
  <Card
    title="Slack Webhooks"
    description="All available Slack events you can react to."
    href="/plugins/slack/webhooks"
  />
  <Card
    title="Hooks Reference"
    description="Full before/after hook API and all available options."
    href="/hooks"
  />
</Cards>
