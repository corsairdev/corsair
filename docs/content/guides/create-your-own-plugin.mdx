...
export type YourPluginBoundEndpoints = BindEndpoints<typeof yourPluginNestedEndpoints>;
export type YourPluginBoundWebhooks = BindWebhooks<typeof yourPluginNestedWebhooks>;
```
