...
<CardGroup cols={2}>
  <Card title="Inngest" href="/content/guides/inngest">
    Durable step functions triggered from Corsair webhooks.
  </Card>
  <Card title="Trigger.dev" href="/content/guides/trigger-dev">
    Background tasks and scheduled jobs with Trigger.dev.
  </Card>
  <Card title="Hatchet" href="/content/guides/hatchet">
    Event-driven workflows with Hatchet.
  </Card>
  <Card title="Workflows guide" href="/content/guides/workflows">
