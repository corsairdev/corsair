...
<Step title="Scaffold the T3 app">
<CodeGroup>
```bash npm
...
<Step title="Create src/server/corsair.ts">
...
<Step title="Connect Google Calendar (optional)">
...
```
```bash yarn
yarn corsair setup --googlecalendar client_id=YOUR_CLIENT_ID client_secret=YOUR_CLIENT_SECRET
```
```bash pnpm
pnpm corsair setup --googlecalendar client_id=YOUR_CLIENT_ID client_secret=YOUR_CLIENT_SECRET
```
```bash bun
bunx corsair setup --googlecalendar client_id=YOUR_CLIENT_ID client_secret=YOUR_CLIENT_SECRET
```
</CodeGroup>
...
<Step title="Vibe code the dashboard (optional)">
...
<CardGroup cols={2}>
  <Card title="Google Calendar Plugin" href="/plugins/googlecalendar/api-endpoints">
