---
title: MCP Adapters
description: "Connect Corsair to Claude, Cursor, OpenAI Agents, Vercel AI, and other runtimes through MCP adapters. No manual schema wiring."
keywords: ["mcp", "corsair mcp", "ai adapters", "claude", "cursor"]
---
