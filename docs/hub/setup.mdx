---
title: Set up Corsair Hub
sidebarTitle: Setup
description: "Install Corsair, mount /api/corsair, add Hub keys, and run locally. Your app self-registers on the first request. No delivery URL to type in."
keywords: ["hub setup", "corsair hub", "api/corsair", "delivery url"]
---
