...
description: "Corsair Hub hosts OAuth callbacks, connect pages, and approval UIs. Tokens pass through the relay and stay encrypted in your database."
keywords: ["corsair hub", "oauth callback", "connect page", "hosted oauth"]
---
