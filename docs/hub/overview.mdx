...
description: "Hub hosts OAuth callbacks, connect pages, and approval UIs. Tokens stay encrypted in your database."
keywords: ["corsair hub", "oauth callback", "connect page"]
---
