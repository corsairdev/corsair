...
Corsair runs in your own app. A few things, though, need a stable public URL a third party can reach: OAuth callbacks and approval pages. Hub is the recommended way to handle them. It is a hosted relay that provides those surfaces so you skip the boilerplate.
