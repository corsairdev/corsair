---
title: Introduction
description: "The go-to integration layer for AI agents and apps. Add any integration in minutes — OAuth, webhooks, MCP tools, and multi-tenant credentials included."
mode: "wide"
keywords: ["AI agent integrations", "MCP tools", "OAuth for AI agents", "open source integration platform", "Corsair SDK"]
"og:title": "Corsair Docs — Introduction"
"og:description": "Connect your AI agent to Slack, Gmail, GitHub, Linear, and hundreds more with one SDK."
---
