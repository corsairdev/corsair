---
title: Introduction
description: "Set up Corsair, install plugins, and call provider APIs from one typed client. OAuth, webhooks, and MCP included."
mode: "wide"
keywords: ["corsair sdk", "mcp tools", "oauth", "integrations"]
---
