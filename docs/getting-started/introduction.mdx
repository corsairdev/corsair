---
title: What is Corsair
sidebarTitle: Introduction
description: "Corsair is an open-source SDK for AI agents. Install plugins, keep credentials in your database, and call Slack, GitHub, Gmail, and other APIs from one client."
mode: "wide"
keywords: ["what is corsair", "corsair sdk", "mcp tools", "oauth"]
---
