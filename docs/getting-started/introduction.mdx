...
Corsair runs entirely in your own app and stores credentials in your own database. When you would rather not host the connect, approval, and webhook surfaces yourself, [Hub](/hub/overview) is an optional relay that provides them, and it still stores none of your credentials.
...
<CardGroup cols={2}>
  ...
  <Card title="Setup" icon="wrench" href="/going-to-production/provisioning-cli">
