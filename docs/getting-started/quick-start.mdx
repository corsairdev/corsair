---
title: Quick Start
description: "Install the Corsair SDK, add Hub keys, connect GitHub, and make your first API call. Five steps. Credentials stay in your database."
keywords: ["install corsair", "hub setup", "quick start", "github"]
---
