---
title: "Quick Start — Set Up Corsair in Minutes"
sidebarTitle: Quick Start
description: "Install Corsair, connect your first integration, and start using it with your AI agent. A working integration in five steps, powered by Hub."
keywords: ["Corsair quick start", "install Corsair", "AI integration setup", "MCP setup guide", "Corsair Hub setup"]
"og:title": "Quick Start — Corsair"
"og:description": "From zero to your first AI agent integration in under 5 minutes."
---
