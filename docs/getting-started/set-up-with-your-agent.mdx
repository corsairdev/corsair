...
description: "Paste one prompt into Cursor, Claude Code, or Codex. The agent installs Corsair Hub and does not stop until a real integration works."
keywords: ["coding agent", "cursor setup", "claude code", "corsair hub"]
---
