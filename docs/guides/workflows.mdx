...
**Pattern:** an event fires, the webhook hook runs, then you call any plugin API.
...
That's a workflow. A GitHub PR opens, and a Slack message is sent.
...
**When a PR merges, post a Slack message, then create a Linear issue to track follow-up:**
