...
Then configure credentials for each integration (CLI, env, or your app’s setup flow). For a full walkthrough—database migration, `CORSAIR_KEK`, and first run—see [Installation](/getting-started/installation).
