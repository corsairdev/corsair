...
Then configure credentials for each integration (CLI, env, or your app's setup flow). For a full walkthrough covering integrations, accounts, tenants, and `setupCorsair`, see [Provisioning](/concepts/provisioning).
