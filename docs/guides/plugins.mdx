...
description: "Browse Corsair plugins as npm packages. Each one adds typed API calls, optional webhooks, and a local database layer for that provider."
keywords: ["corsair plugins", "plugin catalog", "slack", "github", "gmail"]
---
