---
title: "Corsair Plugins — Slack, Gmail, GitHub, Linear & More"
sidebarTitle: Plugins
description: "Browse all available Corsair integrations. Each plugin gives your AI agent typed API access, webhook handling, and data sync."
keywords: ["Corsair plugins", "AI agent Slack integration", "AI agent Gmail", "GitHub integration", "Linear integration", "AI integrations catalog"]
"og:title": "All Corsair Plugins"
"og:description": "Slack, Gmail, GitHub, HubSpot, Stripe, Linear — see the full integration catalog."
---
