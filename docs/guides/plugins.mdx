---
title: Plugins
description: "Corsair plugin catalog. Each package adds typed API calls, optional webhooks, and a local database layer."
keywords: ["corsair plugins", "slack", "github", "gmail"]
---
