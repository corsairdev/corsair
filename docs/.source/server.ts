...
import * as __fd_glob_9 from "../content/docs/type-safety.mdx?collection=docs"
...
export const docs = await create.doc("docs", "content/docs", {"adapters.mdx": __fd_glob_0, "cli.mdx": __fd_glob_1, "core-concepts.mdx": __fd_glob_2, "examples.mdx": __fd_glob_3, "index.mdx": __fd_glob_4, "installation.mdx": __fd_glob_5, "overview.mdx": __fd_glob_6, "plugins.mdx": __fd_glob_7, "quickstart.mdx": __fd_glob_8, "type-safety.mdx": __fd_glob_9, });
