...
<Info>
Note that webhooks are not guaranteed by most senders. If your project requires completely fresh data, add polling for that integration using an [api call](/concepts/api).
</Info>
...
See [Hooks](/concepts/hooks) for the full hooks documentation.
