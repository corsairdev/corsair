...
export const corsairAccounts = pgTable('corsair_accounts', {
    ...
    index('corsair_accounts_tenant_integration_idx').on(table.tenantId, table.integrationId),
]);
...
export const corsairEntities = pgTable('corsair_entities', {
    ...
    index('corsair_entities_account_type_entity_idx').on(table.accountId, table.entityType, table.entityId),
]);
