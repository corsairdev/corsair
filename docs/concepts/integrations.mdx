...
Adding more integrations doesn't add more tables. Corsair always uses the same five tables, no matter how many integrations you have.
...
plugins: [
    ...
    github({ ... }),
    gmail({ ... }),
    // 100 more integrations — still just 5 tables
]
```
