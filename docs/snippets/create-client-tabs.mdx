...
Full hook list, including `useTenants`, `usePlugin`, and `useOAuthCallback`, on the [React Hooks](/adapters/react) reference.
...
Works from any JS runtime, such as Svelte, Vue, a worker, or a CLI. See the [Vanilla Client](/adapters/client) reference.
