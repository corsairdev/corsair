Onboard a user to an integration by creating a connect link and redirecting. Corsair Hub hosts the consent screen, runs the OAuth handshake, and delivers the encrypted tokens back to your route.
