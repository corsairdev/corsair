...
Create the following files in `/docs/plugins/{plugin-name}/`:
...
- `/docs/plugins/slack/main.mdx`
- `/docs/plugins/slack/api-endpoints.mdx`
- `/docs/plugins/slack/webhooks.mdx`
- `/docs/plugins/slack/database.mdx`
- `/docs/plugins/slack/error-handlers.mdx`
