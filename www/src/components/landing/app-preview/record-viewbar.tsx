	...
	return (
		...
		>
			<div className="flex min-w-0 flex-1 items-center gap-1 overflow-hidden px-1">
				<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="1.6">
				...
				<span className="text-[13px] font-medium text-[#666]">All Companies</span>
				<span className="h-0.5 w-0.5 rounded-full bg-[#d1d1d1]" />
				<span className="text-[13px] font-medium text-[#ccc]">9</span>
				<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#ccc" strokeWidth="1.6">
