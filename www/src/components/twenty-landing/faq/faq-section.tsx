...
function ChevronIcon() {
	return (
		<svg
			...
			viewBox="0 0 12 12"
			fill="none"
			className="shrink-0 text-[#1c1c1c66] transition-transform duration-200 group-open:rotate-180"
			aria-hidden
		>
			<path
	...
	return (
		...
		>
			<div className="mx-auto max-w-[1440px] px-4 md:px-10">
				<h2
					id="faq-heading"
					className="mb-14 text-center font-[family-name:var(--twenty-font-mono)] text-xs font-medium uppercase tracking-[0.02em] text-[#1c1c1c99] md:mb-20"
				>
					FAQ
				</h2>

				<div className="relative mx-auto max-w-[800px] rounded-sm border border-[#1c1c1c1a] bg-white">
