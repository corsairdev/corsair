...
export const WORKSPACE_DIR =
	process.env.WORKSPACE_DIR || path.join(PROJECT_ROOT, '.workspace');
export const WORKSPACE_DEFAULTS_DIR =
	process.env.WORKSPACE_DEFAULTS_DIR ||
	path.join(PROJECT_ROOT, 'workspace-defaults');
...
export const PUBLIC_URL =
	process.env.PUBLIC_URL || `http://localhost:${CONTROL_PORT}`;
